...
function serialize_mock_ProjectRequest(arg) {
  if (!(arg instanceof projects_projects_pb.ProjectRequest)) {
...
function deserialize_mock_ProjectRequest(buffer_arg) {
  return projects_projects_pb.ProjectRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mock_Projects(arg) {
  if (!(arg instanceof projects_projects_pb.Projects)) {
...
function deserialize_mock_Projects(buffer_arg) {
  return projects_projects_pb.Projects.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var APIService = exports.APIService = {
  inspectProject: {
    ...
    requestType: projects_projects_pb.ProjectRequest,
  ...
  listProject: {
    ...
    responseType: projects_projects_pb.Projects,
