...
proto.pps.PFSInput.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    trigger: (f = msg.getTrigger()) && client_pfs_pfs_pb.Trigger.toObject(includeInstance, f)
  };
...
proto.pps.PFSInput.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new client_pfs_pfs_pb.Trigger;
      reader.readMessage(value,client_pfs_pfs_pb.Trigger.deserializeBinaryFromReader);
...
proto.pps.PFSInput.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      client_pfs_pfs_pb.Trigger.serializeBinaryToWriter
    );
  }
};
...
proto.pps.PFSInput.prototype.getTrigger = function() {
  return /** @type{?proto.pfs.Trigger} */ (
    jspb.Message.getWrapperField(this, client_pfs_pfs_pb.Trigger, 10));
};
...
/**
 * @param {number} value
 * @return {!proto.pps.HashtreeSpec} returns this
 */
 ...
 * @return {!proto.pps.JobInfos} returns this
*/
...
proto.pps.PipelineInfo.prototype.clearHashtreeSpec = function() {
  return this.setHashtreeSpec(undefined);
};
...
proto.pps.ListDatumRequest.prototype.getInput = function() {
  return /** @type{?proto.pps.Input} */ (
    jspb.Message.getWrapperField(this, proto.pps.Input, 4));
};
 ...
 * @return {!proto.pps.ListDatumResponse} returns this
*/
 ...
 * @return {!proto.pps.ListDatumStreamResponse} returns this
*/
...
proto.pps.ListDatumStreamResponse.prototype.clearDatumInfo = function() {
  return this.setDatumInfo(undefined);
};
...
proto.pps.DeletePipelineRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    splitTransaction: jspb.Message.getBooleanFieldWithDefault(msg, 7, false)
  };
...
/**
 * optional bool split_transaction = 7;
 * @return {boolean}
 */
proto.pps.DeletePipelineRequest.prototype.getSplitTransaction = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 7, false));
};
 ...
 * @return {!proto.pps.DeletePipelineRequest} returns this
 */
proto.pps.DeletePipelineRequest.prototype.setSplitTransaction = function(value) {
  return jspb.Message.setProto3BooleanField(this, 7, value);
};
