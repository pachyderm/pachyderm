...
rm -rf $OUT_DIR
mkdir -p ${OUT_DIR}/license ${OUT_DIR}/enterprise ${OUT_DIR}/task ${OUT_DIR}/pfs ${OUT_DIR}/pps ${OUT_DIR}/auth ${OUT_DIR}/projects ${OUT_DIR}/gogoproto ${OUT_DIR}/admin ${OUT_DIR}/version/versionpb
