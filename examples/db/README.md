...
3. Replace the placeholders in the `mongodb.yaml` file with the encoded versions
...
3. You can then see the output changing over time. You can watch it change with
