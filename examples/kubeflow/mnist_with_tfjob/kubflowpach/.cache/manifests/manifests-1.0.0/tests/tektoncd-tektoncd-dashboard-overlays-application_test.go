...
func writeTektoncdDashboardOverlaysApplication(th *KustTestHarness) {
	th.writeF("/manifests/tektoncd/tektoncd-dashboard/overlays/application/application.yaml", `
...
spec:
  ...
  addOwnerRef: true
`)
	th.writeF("/manifests/tektoncd/tektoncd-dashboard/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
...
- path: spec/template/metadata/labels/app.kubernetes.io\/instance
  kind: Deployment
`)
	th.writeF("/manifests/tektoncd/tektoncd-dashboard/overlays/application/params.env", `
generateName=
`)
	th.writeK("/manifests/tektoncd/tektoncd-dashboard/overlays/application", `
...
commonLabels:
  ...
  app.kubernetes.io/instance: tektoncd-dashboard-v1.0.0
...
func TestTektoncdDashboardOverlaysApplication(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/tektoncd/tektoncd-dashboard/overlays/application")
	writeTektoncdDashboardOverlaysApplication(th)
	...
	targetPath := "../tektoncd/tektoncd-dashboard/overlays/application"
	fsys := fs.MakeRealFS()
