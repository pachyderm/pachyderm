...
func writeBootstrapOverlaysApplication(th *KustTestHarness) {
	th.writeF("/manifests/admission-webhook/bootstrap/overlays/application/application.yaml", `
...
`)
	th.writeK("/manifests/admission-webhook/bootstrap/overlays/application", `
...
func TestBootstrapOverlaysApplication(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/admission-webhook/bootstrap/overlays/application")
	writeBootstrapOverlaysApplication(th)
	...
	targetPath := "../admission-webhook/bootstrap/overlays/application"
	fsys := fs.MakeRealFS()
