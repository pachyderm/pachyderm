...
The `pipeline` we're creating can be found at [scraper.pipeline.json](scraper.pipeline.json). The
...
- Add a bunch more urls and crank up the “level” in the pipeline. You’ll have to delete the old
