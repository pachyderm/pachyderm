...
<select class="mdl-selectfield__select" onchange="let pathParts = window.location.pathname.split('/'); pathParts[0] = this.value; window.location.pathname = pathParts.join('/')">
