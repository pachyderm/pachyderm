...
ready to process any data committed to their input repos. If you need to sping
down these worker pods when they are not in use, you can utilize the
`scale_down_threshold` field in the pipeline spec.
