...
[Word Count](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/word_count){target=_blank}
...
[Lazy Shuffle pipeline](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/shuffle){target=_blank}
...
[GATK - Variant Calling](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/gatk){target=_blank}
...
[Inner and Outer joins 101 - A simplified retail use case](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/joins){target=_blank}
### Group Input
...
[Group 101 - An Introductory example](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/group){target=_blank}
### Spouts
...
- [Spout101](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/spouts/spout101){target=_blank}
...
[Skip Failed Datums in Your Pipeline](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/err_cmd){target=_blank}
...
[R, Python, or Julia - Iris flower classification](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/ml/iris){target=_blank}
...
[Neon - Sentiment Analysis](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/ml/neon){target=_blank}
...
[TensorFlow - pix2pix](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/ml/tensorflow){target=_blank}
...
[Hyperparameter Tuning](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/ml/hyperparameter){target=_blank}
...
[Spark Example](https://github.com/pachyderm/pachyderm/tree/{{ config.pach_branch }}/examples/spark/pi){target=_blank}
...
- Pachyderm - Seldon integration: Version Controlled Models¶
    ...
    expose the model's artifacts through Pachyderm's [S3 gateway](https://docs.pachyderm.com/latest/reference/s3gateway-api/){target=_blank}, and serve this model in production using Seldon-core. https://github.com/SeldonIO/seldon-core/blob/master/examples/pachyderm-simple/index.ipynb
