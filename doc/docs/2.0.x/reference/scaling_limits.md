...
If your Enterprise License has expired and you have more than 16 pipelines, all existing pipelines **continue to work**. Additionally, in the case of a restore or an upgrade, pachd logs will mention the successful startup above the "update pipeline message". However, **you will not be able to create additional pipelines**.
