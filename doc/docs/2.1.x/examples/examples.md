...
[Open CV](https://docs.pachyderm.com/2.1.x/getting-started/beginner-tutorial/){target=_blank}
...
[Word Count](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/word_count){target=_blank}
...
[Periodic Ingress from MongoDB](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/db){target=_blank}
...
[Lazy Shuffle pipeline](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/shuffle){target=_blank}
...
[GATK - Variant Calling](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/gatk){target=_blank}
...
[Inner and Outer joins 101 - A simplified retail use case](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/joins){target=_blank}
### Group Input
...
[Group 101 - An Introductory example](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/group){target=_blank}
### Spouts
...
- [Spout101](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/spouts/spout101){target=_blank}

- More extensive - Pachyderm's integration of spouts with RabbitMQ: https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/spouts/go-rabbitmq-spout 
...
[Use Transactions with Hyperparameter Tuning](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/transactions){target=_blank}
...
[Skip Failed Datums in Your Pipeline](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/err_cmd){target=_blank}
...
[R, Python, or Julia - Iris flower classification](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/ml/iris){target=_blank}
...
[Neon - Sentiment Analysis](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/ml/neon){target=_blank}
...
[TensorFlow - pix2pix](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/ml/tensorflow){target=_blank}
...
[Hyperparameter Tuning](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/ml/hyperparameter){target=_blank}
...
[Spark Example](https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/spark/pi){target=_blank}
...
- Pachyderm - Seldon integration: Version Controlled Models¶
    ...
    expose the model's artifacts through Pachyderm's [S3 gateway](https://docs.pachyderm.com/2.1.x/reference/s3gateway-api/){target=_blank}, and serve this model in production using Seldon-core. https://github.com/SeldonIO/seldon-core/blob/master/examples/pachyderm-simple/index.ipynb
    ...
    https://github.com/SeldonIO/seldon-core/blob/master/examples/pachyderm-cd4ml/index.ipynb
        ...
        !!! Highlights 
            ...
            - **Automation** -  A new deployment in production is triggered when new model artifacts are exposed to Pachyderm's [S3 getaway](https://docs.pachyderm.com/2.1.x/reference/s3gateway-api/){target=_blank}.
...
Please take a look; there is a little more to it, including a fault tolerance mechanism: https://github.com/pachyderm/pachyderm/tree/2.1.x/examples/spouts/go-rabbitmq-spout 
