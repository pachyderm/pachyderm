...
- Pachyderm - Seldon integration: Version Controlled Models¶
    ...
    expose the model's artifacts through Pachyderm's [S3 gateway](https://docs.pachyderm.com/2.1.x/reference/s3gateway_api/){target=_blank}, and serve this model in production using Seldon-core. https://github.com/SeldonIO/seldon-core/blob/master/examples/pachyderm-simple/index.ipynb
    ...
    https://github.com/SeldonIO/seldon-core/blob/master/examples/pachyderm-cd4ml/index.ipynb
        ...
        !!! Highlights 
            ...
            - **Automation** -  A new deployment in production is triggered when new model artifacts are exposed to Pachyderm's [S3 getaway](https://docs.pachyderm.com/2.1.x/reference/s3gateway_api/){target=_blank}.
