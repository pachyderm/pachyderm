...
Follow the deployment instructions in our [Local Installation](../../../getting_started/local_installation/#deploy-pachyderm-latest-community-edition-option-deploy-pachyderm-with-console) page.
You are all set!
