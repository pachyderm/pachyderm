...
!!! Warning
      You must add a secret to your values.yaml file or supply the generated values back via `--set` on the command line during the upgrade. Check the [troubleshooting section](#troubleshoot-point-release-upgrades) at the end of this page for details on how to retrieve those generated values.
