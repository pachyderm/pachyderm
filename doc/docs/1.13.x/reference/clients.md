...
For more info, check out the [godocs](https://pkg.go.dev/github.com/pachyderm/pachyderm/src/client).
...
The Pachyderm [godocs](https://pkg.go.dev/github.com/pachyderm/pachyderm/src/client) reference
