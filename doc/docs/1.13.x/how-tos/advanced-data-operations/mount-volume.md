...
We will use the [OpenCV example](../../../getting-started/beginner_tutorial/).
...
example, it is `/data`.
      ...
      **Example:**
      ...
      [OpenCV example](https://docs.pachyderm.com/latest/getting-started/beginner_tutorial/#create-a-pipeline),
