...
!!! Note
     If you are using [Pachyderm authorization features](../../enterprise/auth/authentication/index.md), only authorized users will be able to delete a given pipeline. In particular, they will have to be `repoOwner` of the output repo of the pipeline (i.e., have created the pipeline) or `clusterAdmin`. 
