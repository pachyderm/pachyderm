...
!!! Warning "Experimental"
    The JupyterLab Mount Extension is an [experimental feature](https://docs.pachyderm.com/latest/reference/supported-releases/#experimental){target=_blank}. We hope you'll try it out (and work with us to improve it! [Get in touch](https://docs.pachyderm.com/latest/getting-started/#getting-started]), but it's not ready for self-service usage in production, as it may make sudden, breaking changes
