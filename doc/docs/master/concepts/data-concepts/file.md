...
!!! Warning
     It is important to note that, in Pachyderm 2.x, **directories are implied from the paths of the files**. Directories are not stored and will not exist **unless they contain files**. 
