    ...
    "Statement": [
        {
            ...
            "Resource": [
                ...
                "arn:aws:secretsmanager:us-east-2:023466359146:secret:<your secret name>*"
            ]
        }
    ]
}
...
Choose the ones that apply to your use case. At a minimum, you will need `postgresql-password` your `root-token`, and `pachd-oauth-client-secret`.
