...
!!! Note "Check Also"
    - Read our [infrastructure recommendations](../ingress/). Specifically, you will find instructions on how to set up an ingress controller, a load balancer, or connect an Identity Provider for access control. 
