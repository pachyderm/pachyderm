...
All existing pipelines **continue to work** after the upgrade. pachd logs will mention the successful startup above the "update pipeline message". However, you will not be able to create additional pipelines.
