...
1. Run the corresponding steps for your operating system:
   ...
   * For all other Linux flavors:
     ...
     ```bash
     $ curl -o /tmp/pachctl.tar.gz -L https://github.com/pachyderm/pachyderm/releases/download/v1.10.0-rc1/pachctl_1.10.0-rc1_linux_amd64.tar.gz && tar -xvf /tmp/pachctl.tar.gz -C /tmp && sudo cp /tmp/pachctl_1.10.0-rc1_linux_amd64/pachctl /usr/local/bin
     ```
