...
Pachyderm can run on any platform that supports Kubernete
...
<div class="row">
  ...
  <div class="column-2">
    <div class="card-square mdl-card mdl-shadow--2dp">
      <div class="mdl-card__title mdl-card--expand">
        <h4 class="mdl-card__title-text">Deploy in the Cloud &nbsp;&nbsp;&nbsp;<i class="fa fa-cogs"></i></h4>
      </div>
      <div class="mdl-card__supporting-text">
        Deploy Pachyderm in one of the supported
        cloud platform.
      </div>
      <div class="mdl-card__actions mdl-card--border">
        <ul>
    ...
    <div class="card-square mdl-card mdl-shadow--2dp">
      ...
      <div class="mdl-card__actions mdl-card--border">
        <ul>
           ...
           Deploying On-Premises With Non-Cloud Object Stores
           </a>
           </li>
