...
const (
	...
	Permission_CLUSTER_ENTERPRISE_REVOKE_USER_TOKENS_ALL_CLUSTERS Permission = 148
...
var Permission_name = map[int32]string{
	...
	148: "CLUSTER_ENTERPRISE_REVOKE_USER_TOKENS_ALL_CLUSTERS",
...
var Permission_value = map[string]int32{
	...
	"CLUSTER_ENTERPRISE_REVOKE_USER_TOKENS_ALL_CLUSTERS": 148,
...
//// OIDC API
type OIDCLoginType int32

const (
	OIDCLoginType_STANDARD    OIDCLoginType = 0
	OIDCLoginType_PRIVILEDGED OIDCLoginType = 1
)

var OIDCLoginType_name = map[int32]string{
	0: "STANDARD",
	1: "PRIVILEDGED",
}

var OIDCLoginType_value = map[string]int32{
	"STANDARD":    0,
	"PRIVILEDGED": 1,
}

func (x OIDCLoginType) String() string {
	return proto.EnumName(OIDCLoginType_name, int32(x))
}

func (OIDCLoginType) EnumDescriptor() ([]byte, []int) {
...
type AuthenticateResponse struct {
	...
	// present this token along with your regular request)
	PachToken string `protobuf:"bytes,1,opt,name=pach_token,json=pachToken,proto3" json:"pach_token,omitempty"`
	// id_token is the token returned from the OAuth2 Flow exchange.
	// It is short lived, and can also be used to authenticate the user
	IdToken              string   `protobuf:"bytes,2,opt,name=id_token,json=idToken,proto3" json:"id_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *AuthenticateResponse) GetIdToken() string {
	if m != nil {
		return m.IdToken
	}
	return ""
...
type SessionInfo struct {
	...
	// raw_id_token is the ID token returned by the OAuth2 Flow when exchanged with the user's auth_code
	RawIdToken           string   `protobuf:"bytes,4,opt,name=raw_id_token,json=rawIdToken,proto3" json:"raw_id_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SessionInfo) GetRawIdToken() string {
	if m != nil {
		return m.RawIdToken
	}
	return ""
...
type GetOIDCLoginRequest struct {
	LoginType            OIDCLoginType `protobuf:"varint,1,opt,name=login_type,json=loginType,proto3,enum=auth.OIDCLoginType" json:"login_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *GetOIDCLoginRequest) GetLoginType() OIDCLoginType {
	if m != nil {
		return m.LoginType
	}
	return OIDCLoginType_STANDARD
}
...
func init() {
	...
	proto.RegisterEnum("auth.OIDCLoginType", OIDCLoginType_name, OIDCLoginType_value)
...
var fileDescriptor_712ec48c1eaf43a2 = []byte{
	...
	,
}
...
func (m *SessionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RawIdToken) > 0 {
		i -= len(m.RawIdToken)
		copy(dAtA[i:], m.RawIdToken)
		i = encodeVarintAuth(dAtA, i, uint64(len(m.RawIdToken)))
		i--
		dAtA[i] = 0x22
	}
	if m.ConversionErr {
...
func (m *GetOIDCLoginRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LoginType != 0 {
		i = encodeVarintAuth(dAtA, i, uint64(m.LoginType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *GetOIDCLoginRequest) Size() (n int) {
	...
	_ = l
	if m.LoginType != 0 {
		n += 1 + sovAuth(uint64(m.LoginType))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *SessionInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawIdToken", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RawIdToken = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAuth(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LoginType |= OIDCLoginType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
