...
pachctl create pipeline --jsonnet src/testing/cmds/go-test-results/egress/pipeline.jsonnet --arg version=0.0.3 --arg pghost=postgres --arg pguser=pachyderm --project ci-metrics
