...
func (m *UserLogQuery) validate(all bool) error {
	...
	case *UserLogQuery_PipelineDatum:
		if v == nil {
			err := UserLogQueryValidationError{
				field:  "UserType",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetPipelineDatum()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, UserLogQueryValidationError{
						field:  "PipelineDatum",
		...
		} else if v, ok := interface{}(m.GetPipelineDatum()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return UserLogQueryValidationError{
					field:  "PipelineDatum",
					reason: "embedded message failed validation",
...
// Validate checks the field values on PipelineDatumLogQuery with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on PipelineDatumLogQuery with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PipelineDatumLogQueryMultiError, or nil if none found.
func (m *PipelineDatumLogQuery) ValidateAll() error {
	return m.validate(true)
}

func (m *PipelineDatumLogQuery) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, PipelineDatumLogQueryValidationError{
					field:  "Pipeline",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return PipelineDatumLogQueryValidationError{
				field:  "Pipeline",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return PipelineDatumLogQueryMultiError(errors)
	}

	return nil
}

// PipelineDatumLogQueryMultiError is an error wrapping multiple validation
// errors returned by PipelineDatumLogQuery.ValidateAll() if the designated
// constraints aren't met.
type PipelineDatumLogQueryMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PipelineDatumLogQueryMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PipelineDatumLogQueryMultiError) AllErrors() []error { return m }

// PipelineDatumLogQueryValidationError is the validation error returned by
// PipelineDatumLogQuery.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e PipelineDatumLogQueryValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PipelineDatumLogQueryValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PipelineDatumLogQueryValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PipelineDatumLogQueryValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PipelineDatumLogQueryValidationError) ErrorName() string {
	return "PipelineDatumLogQueryValidationError"
}

// Error satisfies the builtin error interface
func (e PipelineDatumLogQueryValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPipelineDatumLogQuery.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PipelineDatumLogQueryValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PipelineDatumLogQueryValidationError{}
