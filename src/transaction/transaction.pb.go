...
type TransactionRequest struct {
	...
	SquashCommitSets     *pfs.SquashCommitSetsRequest `protobuf:"bytes,11,opt,name=squash_commit_sets,json=squashCommitSets,proto3" json:"squash_commit_sets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (m *TransactionRequest) GetSquashCommitSets() *pfs.SquashCommitSetsRequest {
	if m != nil {
		return m.SquashCommitSets
	}
	return nil
}
...
var fileDescriptor_284c03442be38d9f = []byte{
	...
	,
}
...
func (m *TransactionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SquashCommitSets != nil {
		{
			size, err := m.SquashCommitSets.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TransactionRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SquashCommitSets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SquashCommitSets == nil {
				m.SquashCommitSets = &pfs.SquashCommitSetsRequest{}
			}
			if err := m.SquashCommitSets.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
