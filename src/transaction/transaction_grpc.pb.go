...
func (UnimplementedAPIServer) DeleteTransaction(context.Context, *DeleteTransactionRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) DeleteAll(context.Context, *DeleteAllRequest) (*empty.Empty, error) {
