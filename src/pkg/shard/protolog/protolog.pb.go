...
/*
Package shardprotolog is a generated protocol buffer package.

It is generated from these files:
	pkg/shard/protolog/protolog.proto
...
type FailedToAssignRoles struct {
	ServerStates map[string]*shardproto.ServerState `protobuf:"bytes,1,rep,name=server_states" json:"server_states,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *FailedToAssignRoles) GetServerStates() map[string]*shardproto.ServerState {
	if m != nil {
...
type SetServerState struct {
	ServerState *shardproto.ServerState `protobuf:"bytes,1,opt,name=serverState" json:"serverState,omitempty"`
}
...
func (m *SetServerState) GetServerState() *shardproto.ServerState {
	if m != nil {
...
type SetFrontendState struct {
	FrontendState *shardproto.FrontendState `protobuf:"bytes,1,opt,name=frontendState" json:"frontendState,omitempty"`
}
...
func (m *SetFrontendState) GetFrontendState() *shardproto.FrontendState {
	if m != nil {
...
type AddServerRole struct {
	ServerRole *shardproto.ServerRole `protobuf:"bytes,1,opt,name=serverRole" json:"serverRole,omitempty"`
	Error      string                 `protobuf:"bytes,2,opt,name=error" json:"error,omitempty"`
}
...
func (m *AddServerRole) GetServerRole() *shardproto.ServerRole {
	if m != nil {
		return m.ServerRole
	}
	return nil
...
func (m *RemoveServerRole) GetServerRole() *shardproto.ServerRole {
	if m != nil {
		return m.ServerRole
	}
	return nil
...
type SetServerRole struct {
	ServerRole *shardproto.ServerRole `protobuf:"bytes,2,opt,name=serverRole" json:"serverRole,omitempty"`
}
...
func (m *SetServerRole) GetServerRole() *shardproto.ServerRole {
	if m != nil {
		return m.ServerRole
	}
	return nil
...
func (m *DeleteServerRole) GetServerRole() *shardproto.ServerRole {
	if m != nil {
		return m.ServerRole
	}
	return nil
...
type SetAddresses struct {
	Addresses *shardproto.Addresses `protobuf:"bytes,1,opt,name=addresses" json:"addresses,omitempty"`
}
...
func (m *SetAddresses) GetAddresses() *shardproto.Addresses {
	if m != nil {
		return m.Addresses
	}
	return nil
