...
// source: pkg/grpcversion.proto
// DO NOT EDIT!

/*
Package grpcversion is a generated protocol buffer package.

It is generated from these files:
	pkg/grpcversion.proto
...
func (c *apiClient) GetVersion(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*GetVersionResponse, error) {
	...
	err := grpc.Invoke(ctx, "/grpcversion.Api/GetVersion", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
