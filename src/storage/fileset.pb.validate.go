...
// Validate checks the field values on CompactFilesetRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CompactFilesetRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CompactFilesetRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CompactFilesetRequestMultiError, or nil if none found.
func (m *CompactFilesetRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CompactFilesetRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CompactFilesetRequestMultiError(errors)
	}

	return nil
}

// CompactFilesetRequestMultiError is an error wrapping multiple validation
// errors returned by CompactFilesetRequest.ValidateAll() if the designated
// constraints aren't met.
type CompactFilesetRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CompactFilesetRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CompactFilesetRequestMultiError) AllErrors() []error { return m }

// CompactFilesetRequestValidationError is the validation error returned by
// CompactFilesetRequest.Validate if the designated constraints aren't met.
type CompactFilesetRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CompactFilesetRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CompactFilesetRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CompactFilesetRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CompactFilesetRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CompactFilesetRequestValidationError) ErrorName() string {
	return "CompactFilesetRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CompactFilesetRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCompactFilesetRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CompactFilesetRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CompactFilesetRequestValidationError{}

// Validate checks the field values on CompactFilesetResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CompactFilesetResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CompactFilesetResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CompactFilesetResponseMultiError, or nil if none found.
func (m *CompactFilesetResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CompactFilesetResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CompactFilesetResponseMultiError(errors)
	}

	return nil
}

// CompactFilesetResponseMultiError is an error wrapping multiple validation
// errors returned by CompactFilesetResponse.ValidateAll() if the designated
// constraints aren't met.
type CompactFilesetResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CompactFilesetResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CompactFilesetResponseMultiError) AllErrors() []error { return m }

// CompactFilesetResponseValidationError is the validation error returned by
// CompactFilesetResponse.Validate if the designated constraints aren't met.
type CompactFilesetResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CompactFilesetResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CompactFilesetResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CompactFilesetResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CompactFilesetResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CompactFilesetResponseValidationError) ErrorName() string {
	return "CompactFilesetResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CompactFilesetResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCompactFilesetResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CompactFilesetResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CompactFilesetResponseValidationError{}
