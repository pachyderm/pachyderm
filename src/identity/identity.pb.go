...
type User struct {
	...
	LastAuthenticated    *types.Timestamp `protobuf:"bytes,2,opt,name=last_authenticated,json=lastAuthenticated,proto3" json:"last_authenticated,omitempty"`
...
func (m *User) GetLastAuthenticated() *types.Timestamp {
	if m != nil {
...
var fileDescriptor_2433c1f46177a3e0 = []byte{
	...
	,
}
...
func (m *User) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastAuthenticated != nil {
		{
			size, err := m.LastAuthenticated.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *User) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.LastAuthenticated == nil {
				m.LastAuthenticated = &types.Timestamp{}
			}
			if err := m.LastAuthenticated.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
