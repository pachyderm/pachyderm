...
// These values are passed to the linker at build time.
// DO NOT set the value of the variables here. For some reason, if
// they are set here, the go linker will not overwrite them.
var (
	// AdditionalVersion is the string provided at release time.
	AdditionalVersion string
	// DefaultDashVersion is the default dashboard version to use for deployments.
	DefaultDashVersion string
)
