...
func (*ClusterInfo) Descriptor() ([]byte, []int) { return fileDescriptorVersion, []int{1} }
...
func init() {
	...
	proto.RegisterType((*ClusterInfo)(nil), "versionpb.ClusterInfo")
}
...
type APIClient interface {
	...
	GetClusterInfo(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*ClusterInfo, error)
}
...
func (c *aPIClient) GetClusterInfo(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*ClusterInfo, error) {
	out := new(ClusterInfo)
	err := grpc.Invoke(ctx, "/versionpb.API/GetClusterInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	GetClusterInfo(context.Context, *google_protobuf.Empty) (*ClusterInfo, error)
}
...
func _API_GetClusterInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(google_protobuf.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).GetClusterInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/versionpb.API/GetClusterInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).GetClusterInfo(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _API_GetClusterInfo_Handler,
		},
	},
...
var fileDescriptorVersion = []byte{
	...
	,
}
