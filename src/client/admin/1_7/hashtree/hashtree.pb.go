...
package hashtree // import "github.com/pachyderm/pachyderm/src/client/admin/1_7/hashtree"
...
func (*FileNodeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_hashtree_e7c0f57990257dbd, []int{0}
}
...
func (*DirectoryNodeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_hashtree_e7c0f57990257dbd, []int{1}
}
...
func (*NodeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_hashtree_e7c0f57990257dbd, []int{2}
}
...
func (*HashTreeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_hashtree_e7c0f57990257dbd, []int{3}
}
...
func init() {
	proto.RegisterFile("client/admin/1_7/hashtree/hashtree.proto", fileDescriptor_hashtree_e7c0f57990257dbd)
}

var fileDescriptor_hashtree_e7c0f57990257dbd = []byte{
