...
package health // import "github.com/pachyderm/pachyderm/src/client/health"
...
func init() { proto.RegisterFile("client/health/health.proto", fileDescriptor_health_c1988ed7eb8e52f9) }

var fileDescriptor_health_c1988ed7eb8e52f9 = []byte{
