...
type Config struct {
	...
	V3                   *ConfigV3 `protobuf:"bytes,4,opt,name=v3,proto3" json:"v3,omitempty"`
...
// ConfigV2 specifies v2 of the pachyderm config (June 2019 - September 2019)
...
// ConfigV3 specifies v3 of the pachyderm config (September 2019 - present)
...
func (m *ConfigV3) Reset()         { *m = ConfigV3{} }
func (m *ConfigV3) String() string { return proto.CompactTextString(m) }
func (*ConfigV3) ProtoMessage()    {}
func (*ConfigV3) Descriptor() ([]byte, []int) {
	return fileDescriptor_60f651abce1dcdf3, []int{3}
}
func (m *ConfigV3) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConfigV3) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfigV3.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfigV3) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfigV3.Merge(m, src)
}
func (m *ConfigV3) XXX_Size() int {
	return m.Size()
}
func (m *ConfigV3) XXX_DiscardUnknown() {
	xxx_messageInfo_ConfigV3.DiscardUnknown(m)
}

var xxx_messageInfo_ConfigV3 proto.InternalMessageInfo

func (m *ConfigV3) GetMetrics() bool {
	if m != nil {
		return m.Metrics
	}
	return false
...
func (*Context) Descriptor() ([]byte, []int) {
	return fileDescriptor_60f651abce1dcdf3, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*ConfigV3)(nil), "config.ConfigV3")
...
var fileDescriptor_60f651abce1dcdf3 = []byte{
	...
	,
}
...
func (m *Config) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.V3 != nil {
		{
			size, err := m.V3.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ConfigV3) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfigV3) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConfigV3) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConfigV3) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfigV3: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfigV3: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
