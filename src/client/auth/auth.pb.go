...
// ActivateRequest activates authentication in the cluster and generates a
// root token which can be used to configure authentiation providers.
type ActivateRequest struct {
	// If specified, root_token_hash is used as the root auth token. This is used
	// in integration testing to ensure we can always authenticate with a known
	// credential. Otherwise the root token is generated randomly.
	RootTokenHash        string   `protobuf:"bytes,1,opt,name=root_token_hash,json=rootTokenHash,proto3" json:"root_token_hash,omitempty"`
...
type ActivateResponse struct {
	// pach_token is the root auth token which has admin irrevocably on the cluster.
	// This token should be stored securely for the life of the cluster.
...
var fileDescriptor_15ace9a5d0179ff3 = []byte{
	...
	,
}
