...
func (m *ModifyGroupMembersRequest) Reset()         { *m = ModifyGroupMembersRequest{} }
func (m *ModifyGroupMembersRequest) String() string { return proto.CompactTextString(m) }
func (*ModifyGroupMembersRequest) ProtoMessage()    {}
func (*ModifyGroupMembersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_15ace9a5d0179ff3, []int{48}
}
func (m *ModifyGroupMembersRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ModifyGroupMembersRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ModifyGroupMembersRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ModifyGroupMembersRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModifyGroupMembersRequest.Merge(m, src)
}
func (m *ModifyGroupMembersRequest) XXX_Size() int {
	return m.Size()
}
func (m *ModifyGroupMembersRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ModifyGroupMembersRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ModifyGroupMembersRequest proto.InternalMessageInfo

func (m *ModifyGroupMembersRequest) GetGroup() string {
	if m != nil {
		return m.Group
	}
	return ""
...
func (m *ModifyGroupMembersRequest) GetAdd() []string {
	if m != nil {
		return m.Add
	}
	return nil
...
func (m *ModifyGroupMembersRequest) GetRemove() []string {
	if m != nil {
		return m.Remove
	}
	return nil
...
type ModifyGroupMembersResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ModifyGroupMembersResponse) Reset()         { *m = ModifyGroupMembersResponse{} }
func (m *ModifyGroupMembersResponse) String() string { return proto.CompactTextString(m) }
func (*ModifyGroupMembersResponse) ProtoMessage()    {}
func (*ModifyGroupMembersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_15ace9a5d0179ff3, []int{49}
}
func (m *ModifyGroupMembersResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ModifyGroupMembersResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ModifyGroupMembersResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ModifyGroupMembersResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModifyGroupMembersResponse.Merge(m, src)
}
func (m *ModifyGroupMembersResponse) XXX_Size() int {
	return m.Size()
}
func (m *ModifyGroupMembersResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ModifyGroupMembersResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ModifyGroupMembersResponse proto.InternalMessageInfo
...
func (m *ListGroupsResponse) GetGroups() []string {
	if m != nil {
		return m.Groups
	}
	return nil
...
// GroupMembership is an internal structure used to efficiently query group membership
type GroupMembership struct {
	// members stores the set of immediate child nodes, which are both groups and users
	Members map[string]bool `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// parent_groups stores the set of immediate parent nodes, which are always groups
	ParentGroups map[string]bool `protobuf:"bytes,2,rep,name=parent_groups,json=parentGroups,proto3" json:"parent_groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// transitive_child_groups stores the set of groups which are children of this
	// group (transitive closure), mapped to the number of distinct routes from this
	// group to the child group
	TransitiveChildGroups map[string]int64 `protobuf:"bytes,3,rep,name=transitive_child_groups,json=transitiveChildGroups,proto3" json:"transitive_child_groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral  struct{}         `json:"-"`
	XXX_unrecognized      []byte           `json:"-"`
	XXX_sizecache         int32            `json:"-"`
}
...
func (m *GroupMembership) GetMembers() map[string]bool {
	if m != nil {
		return m.Members
	}
	return nil
...
func (m *GroupMembership) GetParentGroups() map[string]bool {
	if m != nil {
...
func (m *GroupMembership) GetTransitiveChildGroups() map[string]int64 {
	if m != nil {
		return m.TransitiveChildGroups
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*ModifyGroupMembersRequest)(nil), "auth.ModifyGroupMembersRequest")
	proto.RegisterType((*ModifyGroupMembersResponse)(nil), "auth.ModifyGroupMembersResponse")
	...
	proto.RegisterType((*ListGroupsRequest)(nil), "auth.ListGroupsRequest")
	proto.RegisterType((*ListGroupsResponse)(nil), "auth.ListGroupsResponse")
	...
	proto.RegisterType((*GroupMembership)(nil), "auth.GroupMembership")
	proto.RegisterMapType((map[string]bool)(nil), "auth.GroupMembership.MembersEntry")
	proto.RegisterMapType((map[string]bool)(nil), "auth.GroupMembership.ParentGroupsEntry")
	proto.RegisterMapType((map[string]int64)(nil), "auth.GroupMembership.TransitiveChildGroupsEntry")
}
...
var fileDescriptor_15ace9a5d0179ff3 = []byte{
	...
	,
}
...
type APIClient interface {
	...
	ModifyGroupMembers(ctx context.Context, in *ModifyGroupMembersRequest, opts ...grpc.CallOption) (*ModifyGroupMembersResponse, error)
...
func (c *aPIClient) ModifyGroupMembers(ctx context.Context, in *ModifyGroupMembersRequest, opts ...grpc.CallOption) (*ModifyGroupMembersResponse, error) {
	out := new(ModifyGroupMembersResponse)
	err := c.cc.Invoke(ctx, "/auth.API/ModifyGroupMembers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListGroups(ctx context.Context, in *ListGroupsRequest, opts ...grpc.CallOption) (*ListGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.API/ListGroups", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	ModifyGroupMembers(context.Context, *ModifyGroupMembersRequest) (*ModifyGroupMembersResponse, error)
...
func (*UnimplementedAPIServer) ModifyGroupMembers(ctx context.Context, req *ModifyGroupMembersRequest) (*ModifyGroupMembersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ModifyGroupMembers not implemented")
}
func (*UnimplementedAPIServer) GetGroups(ctx context.Context, req *GetGroupsRequest) (*GetGroupsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetGroups not implemented")
}
func (*UnimplementedAPIServer) ListGroups(ctx context.Context, req *ListGroupsRequest) (*ListGroupsResponse, error) {
...
func _API_ModifyGroupMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ModifyGroupMembersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ModifyGroupMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.API/ModifyGroupMembers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ModifyGroupMembers(ctx, req.(*ModifyGroupMembersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _API_ListGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.API/ListGroups",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ModifyGroupMembers",
			Handler:    _API_ModifyGroupMembers_Handler,
		},
		{
...
func (m *ModifyGroupMembersRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ModifyGroupMembersRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyGroupMembersRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ModifyGroupMembersResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ModifyGroupMembersResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyGroupMembersResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ListGroupsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ListGroupsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GroupMembership) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TransitiveChildGroups) > 0 {
		for k := range m.TransitiveChildGroups {
			v := m.TransitiveChildGroups[k]
			baseI := i
			i = encodeVarintAuth(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
	...
	if len(m.ParentGroups) > 0 {
		for k := range m.ParentGroups {
			v := m.ParentGroups[k]
			baseI := i
			i--
			if v {
...
func (m *ModifyGroupMembersRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModifyGroupMembersResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GroupMembership) Size() (n int) {
	...
	if len(m.TransitiveChildGroups) > 0 {
		for k, v := range m.TransitiveChildGroups {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovAuth(uint64(len(k))) + 1 + sovAuth(uint64(v))
			n += mapEntrySize + 1 + sovAuth(uint64(mapEntrySize))
...
func (m *ModifyGroupMembersRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ModifyGroupMembersRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ModifyGroupMembersRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ModifyGroupMembersResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ModifyGroupMembersResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ModifyGroupMembersResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GroupMembership) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParentGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ParentGroups == nil {
				m.ParentGroups = make(map[string]bool)
			}
			var mapkey string
			var mapvalue bool
			for iNdEx < postIndex {
			...
			m.ParentGroups[mapkey] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransitiveChildGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TransitiveChildGroups == nil {
				m.TransitiveChildGroups = make(map[string]int64)
			}
			var mapkey string
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.TransitiveChildGroups[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAuth(dAtA[iNdEx:])
