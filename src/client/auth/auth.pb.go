...
type AdminGrant_Scope int32

const (
	// SUPER gives access to all APIs and owner on everything in PFS (previous just called admin)
	AdminGrant_SUPER AdminGrant_Scope = 0
	// FS gives Owner on all repos in PFS but not access to manage other aspects of the cluster
	AdminGrant_FS AdminGrant_Scope = 1
)

var AdminGrant_Scope_name = map[int32]string{
	0: "SUPER",
	1: "FS",
}

var AdminGrant_Scope_value = map[string]int32{
	"SUPER": 0,
	"FS":    1,
}

func (x AdminGrant_Scope) String() string {
	return proto.EnumName(AdminGrant_Scope_name, int32(x))
}

func (AdminGrant_Scope) EnumDescriptor() ([]byte, []int) {
...
// AdminGrant reflects any cluster-wide (admin) permissions a principal has.
// Principals can have multiple admin scopes.
type AdminGrant struct {
	Scopes               []AdminGrant_Scope `protobuf:"varint,1,rep,packed,name=scopes,proto3,enum=auth.AdminGrant_Scope" json:"scopes,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *AdminGrant) Reset()         { *m = AdminGrant{} }
func (m *AdminGrant) String() string { return proto.CompactTextString(m) }
func (*AdminGrant) ProtoMessage()    {}
func (*AdminGrant) Descriptor() ([]byte, []int) {
	return fileDescriptor_15ace9a5d0179ff3, []int{10}
}
func (m *AdminGrant) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AdminGrant) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AdminGrant.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AdminGrant) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdminGrant.Merge(m, src)
}
func (m *AdminGrant) XXX_Size() int {
	return m.Size()
}
func (m *AdminGrant) XXX_DiscardUnknown() {
	xxx_messageInfo_AdminGrant.DiscardUnknown(m)
}

var xxx_messageInfo_AdminGrant proto.InternalMessageInfo

func (m *AdminGrant) GetScopes() []AdminGrant_Scope {
	if m != nil {
		return m.Scopes
	}
	return nil
...
type GetAdminsResponse struct {
	// admins contains a mapping of principals to admin grants
	Admins               map[string]*AdminGrant `protobuf:"bytes,1,rep,name=admins,proto3" json:"admins,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *GetAdminsResponse) GetAdmins() map[string]*AdminGrant {
	if m != nil {
		return m.Admins
	}
	return nil
...
// Set admin grants for the specified admin.
type ModifyAdminsRequest struct {
	Subject              string      `protobuf:"bytes,1,opt,name=subject,proto3" json:"subject,omitempty"`
	Grant                *AdminGrant `protobuf:"bytes,2,opt,name=grant,proto3" json:"grant,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *ModifyAdminsRequest) GetSubject() string {
	if m != nil {
		return m.Subject
	}
	return ""
...
func (m *ModifyAdminsRequest) GetGrant() *AdminGrant {
	if m != nil {
		return m.Grant
	}
	return nil
...
type WhoAmIResponse struct {
	...
	AdminGrant           *AdminGrant `protobuf:"bytes,4,opt,name=admin_grant,json=adminGrant,proto3" json:"admin_grant,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *WhoAmIResponse) GetAdminGrant() *AdminGrant {
	if m != nil {
		return m.AdminGrant
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("auth.AdminGrant_Scope", AdminGrant_Scope_name, AdminGrant_Scope_value)
	...
	proto.RegisterType((*AdminGrant)(nil), "auth.AdminGrant")
	...
	proto.RegisterMapType((map[string]*AdminGrant)(nil), "auth.GetAdminsResponse.AdminsEntry")
...
var fileDescriptor_15ace9a5d0179ff3 = []byte{
	...
	,
}
...
func (m *AdminGrant) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AdminGrant) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AdminGrant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *WhoAmIResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AdminGrant != nil {
		{
			size, err := m.AdminGrant.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AdminGrant) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AdminGrant: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AdminGrant: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
				var v AdminGrant_Scope
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowAuth
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= AdminGrant_Scope(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.Scopes) == 0 {
					m.Scopes = make([]AdminGrant_Scope, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v AdminGrant_Scope
					for shift := uint(0); ; shift += 7 {
...
func (m *GetAdminsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Admins == nil {
				m.Admins = make(map[string]*AdminGrant)
			}
			var mapkey string
			var mapvalue *AdminGrant
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *WhoAmIResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdminGrant", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AdminGrant == nil {
				m.AdminGrant = &AdminGrant{}
			}
			if err := m.AdminGrant.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
