...
type AuthConfig_SAMLServiceOptions struct {
	...
	// sessions. If unset, user sessions last 24 hours (a short default, as
	// SAML assertions may contain group memberships that need to be refreshed)
...
type GetAuthenticationCodeRequest struct {
	// If the caller is an admin, GetAuthenticationCode() can return a code for
	// any user (useful for testing).
	// If the caller is not an admin, GetAuthenticationCode() will return an
...
func (m *GetAuthenticationCodeRequest) GetSubject() string {
	if m != nil {
		return m.Subject
	}
	return ""
...
func (*GetAuthenticationCodeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorAuth, []int{49}
}
...
var fileDescriptorAuth = []byte{
	...
	,
}
