...
type AuthenticateRequest struct {
	...
	// state information related to an OIDC login flow.
...
// ACLEntry is a memer of the {Set,Get}ACL{Request,Response} messages
...
// Flows are identified with a 'state' token generated by 'GetOIDCLogin'. The
// 'oidc-auth-flows' etcd collection maps an OIDC state token (key, 30-character
// string) to collection under and passed via 'Authenticate' and
// /authorization-code/callback. Instances of 'sessionInfo' are stothe key value
// in 'stateInfoMap' under which a given instance of 'sessionInfo' is stored) so
// that that /callback can pass the
type SessionInfo struct {
	// nonce is used by Authenticate() to validate session continuity with the IdP
	// when exchanging an authorization code for a user's user info.
	Nonce string `protobuf:"bytes,1,opt,name=nonce,proto3" json:"nonce,omitempty"`
	// id_token contains a user's OIDC ID token, which can be used to get their
	// user info.
...
func (m *SessionInfo) GetIDToken() string {
	if m != nil {
		return m.IDToken
	}
	return ""
...
var fileDescriptor_15ace9a5d0179ff3 = []byte{
	...
	,
}
