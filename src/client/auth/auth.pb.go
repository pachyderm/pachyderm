...
type GetAdminsResponse struct {
	// admins contains the list of Github user admins
...
type GetAuthTokenRequest struct {
	// User is actually a subject, and the returned token (if any) will allow
	// the caller to access resources as this subject
...
type GetAuthTokenResponse struct {
	// A new auth token for the user in 'GetAuthTokenRequest.User' token
...
var fileDescriptorAuth = []byte{
	...
	,
}
