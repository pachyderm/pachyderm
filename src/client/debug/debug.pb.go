...
func (m *ClusterIDResponse) Reset()         { *m = ClusterIDResponse{} }
func (m *ClusterIDResponse) String() string { return proto.CompactTextString(m) }
...
func (m *ClusterIDResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ClusterIDResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ClusterIDResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ClusterIDResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClusterIDResponse.Merge(m, src)
}
func (m *ClusterIDResponse) XXX_Size() int {
	return m.Size()
}
func (m *ClusterIDResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ClusterIDResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ClusterIDResponse proto.InternalMessageInfo

func (m *ClusterIDResponse) GetClusterID() string {
	if m != nil {
		return m.ClusterID
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ClusterIDResponse)(nil), "debug.ClusterIDResponse")
}
...
var fileDescriptor_6d15a320d0127c22 = []byte{
	...
	,
}
...
type DebugClient interface {
	...
	ClusterID(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*ClusterIDResponse, error)
}
...
func (c *debugClient) ClusterID(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*ClusterIDResponse, error) {
	out := new(ClusterIDResponse)
	err := c.cc.Invoke(ctx, "/debug.Debug/ClusterID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DebugServer interface {
	...
	ClusterID(context.Context, *types.Empty) (*ClusterIDResponse, error)
}
...
func (*UnimplementedDebugServer) ClusterID(ctx context.Context, req *types.Empty) (*ClusterIDResponse, error) {
...
func _Debug_ClusterID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).ClusterID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/debug.Debug/ClusterID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).ClusterID(ctx, req.(*types.Empty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Debug_ClusterID_Handler,
		},
	},
...
func (m *ClusterIDResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ClusterIDResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ClusterIDResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ClusterID) > 0 {
		...
		i = encodeVarintDebug(dAtA, i, uint64(len(m.ClusterID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ClusterIDResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClusterIDResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterIDResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterIDResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
