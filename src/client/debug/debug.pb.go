...
func init() {
	...
	proto.RegisterType((*PcapRequest)(nil), "debug.PcapRequest")
}
...
var fileDescriptor_6d15a320d0127c22 = []byte{
	...
	,
}
...
type DebugClient interface {
	...
	Pcap(ctx context.Context, in *PcapRequest, opts ...grpc.CallOption) (Debug_PcapClient, error)
}
...
func (c *debugClient) Pcap(ctx context.Context, in *PcapRequest, opts ...grpc.CallOption) (Debug_PcapClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Debug_serviceDesc.Streams[3], "/debug.Debug/Pcap", opts...)
	if err != nil {
		return nil, err
	}
	x := &debugPcapClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Debug_PcapClient interface {
	Recv() (*types.BytesValue, error)
	grpc.ClientStream
}

type debugPcapClient struct {
	grpc.ClientStream
}

func (x *debugPcapClient) Recv() (*types.BytesValue, error) {
	m := new(types.BytesValue)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type DebugServer interface {
	...
	Pcap(*PcapRequest, Debug_PcapServer) error
}
...
func (*UnimplementedDebugServer) Pcap(req *PcapRequest, srv Debug_PcapServer) error {
...
func _Debug_Pcap_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PcapRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DebugServer).Pcap(m, &debugPcapServer{stream})
}

type Debug_PcapServer interface {
	Send(*types.BytesValue) error
	grpc.ServerStream
}

type debugPcapServer struct {
	grpc.ServerStream
}

func (x *debugPcapServer) Send(m *types.BytesValue) error {
	return x.ServerStream.SendMsg(m)
}
...
func (m *PcapRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PcapRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PcapRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PcapRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PcapRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PcapRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
