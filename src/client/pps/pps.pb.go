...
type ParallelismSpec struct {
	...
	// maximum is the maximum number of workers this pipeline will run
	// concurrently. A value of 0 means no maximum and should be used with care.
	Maximum int64 `protobuf:"varint,4,opt,name=maximum,proto3" json:"maximum,omitempty"`
	// One worker will be spun up for every datums_per_worker datums to be
	// processed in a job, up to the value of maximum.
	DatumsPerWorker int64 `protobuf:"varint,5,opt,name=datums_per_worker,json=datumsPerWorker,proto3" json:"datums_per_worker,omitempty"`
	// One worker will be spun up for every bytes_per_worker total data to be
	// processed in a job, up to the value of maximum. Values can be specified
	// using standard SI units so a value of 1G would give you one worker for
	// every gigabyte of data.
	BytesPerWorker       string   `protobuf:"bytes,6,opt,name=bytes_per_worker,json=bytesPerWorker,proto3" json:"bytes_per_worker,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ParallelismSpec) GetMaximum() int64 {
	if m != nil {
		return m.Maximum
	}
	return 0
...
func (m *ParallelismSpec) GetDatumsPerWorker() int64 {
	if m != nil {
		return m.DatumsPerWorker
	}
	return 0
}

func (m *ParallelismSpec) GetBytesPerWorker() string {
	if m != nil {
		return m.BytesPerWorker
	}
	return ""
}
...
type ScalePipelineRequest struct {
	Pipeline             *Pipeline `protobuf:"bytes,1,opt,name=pipeline,proto3" json:"pipeline,omitempty"`
...
func (m *ScalePipelineRequest) Reset()         { *m = ScalePipelineRequest{} }
func (m *ScalePipelineRequest) String() string { return proto.CompactTextString(m) }
func (*ScalePipelineRequest) ProtoMessage()    {}
func (*ScalePipelineRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dbf57f97f56369c0, []int{57}
}
func (m *ScalePipelineRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ScalePipelineRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ScalePipelineRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ScalePipelineRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ScalePipelineRequest.Merge(m, src)
}
func (m *ScalePipelineRequest) XXX_Size() int {
	return m.Size()
}
func (m *ScalePipelineRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ScalePipelineRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ScalePipelineRequest proto.InternalMessageInfo

func (m *ScalePipelineRequest) GetPipeline() *Pipeline {
	if m != nil {
		return m.Pipeline
	}
	return nil
...
func (m *ScalePipelineRequest) GetWorkers() int64 {
	if m != nil {
		return m.Workers
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ScalePipelineRequest)(nil), "pps.ScalePipelineRequest")
...
var fileDescriptor_dbf57f97f56369c0 = []byte{
	...
	,
}
...
func (m *ParallelismSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BytesPerWorker) > 0 {
		i -= len(m.BytesPerWorker)
		copy(dAtA[i:], m.BytesPerWorker)
		i = encodeVarintPps(dAtA, i, uint64(len(m.BytesPerWorker)))
		i--
		dAtA[i] = 0x32
	}
	if m.DatumsPerWorker != 0 {
		i = encodeVarintPps(dAtA, i, uint64(m.DatumsPerWorker))
		i--
		dAtA[i] = 0x28
	}
	if m.Maximum != 0 {
		i = encodeVarintPps(dAtA, i, uint64(m.Maximum))
		i--
		dAtA[i] = 0x20
	}
	if m.Constant != 0 {
...
func (m *ScalePipelineRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ScalePipelineRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ScalePipelineRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Workers != 0 {
		i = encodeVarintPps(dAtA, i, uint64(m.Workers))
		i--
		dAtA[i] = 0x10
	}
	if m.Pipeline != nil {
...
func (m *ParallelismSpec) Size() (n int) {
	...
	if m.Maximum != 0 {
		n += 1 + sovPps(uint64(m.Maximum))
	}
	if m.DatumsPerWorker != 0 {
		n += 1 + sovPps(uint64(m.DatumsPerWorker))
	}
	l = len(m.BytesPerWorker)
	if l > 0 {
		n += 1 + l + sovPps(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ScalePipelineRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ParallelismSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DatumsPerWorker", wireType)
			}
			m.DatumsPerWorker = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DatumsPerWorker |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BytesPerWorker", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BytesPerWorker = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
...
func (m *ScalePipelineRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScalePipelineRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScalePipelineRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
