...
type Aggregation struct {
	...
	FifthPercentile       float32 `protobuf:"fixed32,4,opt,name=fifth_percentile,json=fifthPercentile,proto3" json:"fifth_percentile,omitempty"`
	NinetyFifthPercentile float32 `protobuf:"fixed32,5,opt,name=ninety_fifth_percentile,json=ninetyFifthPercentile,proto3" json:"ninety_fifth_percentile,omitempty"`
}

func (m *Aggregation) Reset()                    { *m = Aggregation{} }
func (m *Aggregation) String() string            { return proto.CompactTextString(m) }
func (*Aggregation) ProtoMessage()               {}
func (*Aggregation) Descriptor() ([]byte, []int) { return fileDescriptorPps, []int{10} }

func (m *Aggregation) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *Aggregation) GetMean() float32 {
	if m != nil {
		return m.Mean
	}
	return 0
...
func (m *Aggregation) GetStddev() float32 {
	if m != nil {
		return m.Stddev
	}
	return 0
...
func (m *Aggregation) GetFifthPercentile() float32 {
	if m != nil {
...
func (m *Aggregation) GetNinetyFifthPercentile() float32 {
	if m != nil {
...
type PipelineInfo struct {
	...
	EnableStats        bool                        `protobuf:"varint,23,opt,name=enable_stats,json=enableStats,proto3" json:"enable_stats,omitempty"`
}
...
type GetLogsRequest struct {
	...
	DatumID     string   `protobuf:"bytes,8,opt,name=datum_id,json=datumId,proto3" json:"datum_id,omitempty"`
}
...
func (*GarbageCollectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPps, []int{36} }
...
func (*GarbageCollectResponse) Descriptor() ([]byte, []int) { return fileDescriptorPps, []int{37} }
...
func init() {
	...
	proto.RegisterType((*Aggregation)(nil), "pps.Aggregation")
...
func (m *ParallelismSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Strategy != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Strategy))
	}
	if m.Constant != 0 {
		dAtA[i] = 0x10
		i++
...
func (m *Aggregation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mean != 0 {
		dAtA[i] = 0x15
		i++
		i = encodeFixed32Pps(dAtA, i, uint32(math.Float32bits(float32(m.Mean))))
	}
	if m.Stddev != 0 {
		dAtA[i] = 0x1d
		i++
		i = encodeFixed32Pps(dAtA, i, uint32(math.Float32bits(float32(m.Stddev))))
	}
	if m.FifthPercentile != 0 {
		dAtA[i] = 0x25
		i++
		i = encodeFixed32Pps(dAtA, i, uint32(math.Float32bits(float32(m.FifthPercentile))))
	}
	if m.NinetyFifthPercentile != 0 {
		dAtA[i] = 0x2d
		i++
		i = encodeFixed32Pps(dAtA, i, uint32(math.Float32bits(float32(m.NinetyFifthPercentile))))
	}
	return i, nil
}
...
func (m *JobInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Transform != nil {
		...
		n11, err := m.Transform.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.ParentJob != nil {
		...
		n13, err := m.ParentJob.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
	...
	if m.Finished != nil {
		...
		n15, err := m.Finished.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.OutputCommit != nil {
		...
		n16, err := m.OutputCommit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.ParallelismSpec != nil {
		...
		n17, err := m.ParallelismSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	...
	if m.Egress != nil {
		...
		n19, err := m.Egress.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.OutputRepo != nil {
		...
		n20, err := m.OutputRepo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
	...
	if m.ResourceSpec != nil {
		...
		n21, err := m.ResourceSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.NewBranch != nil {
		...
		n23, err := m.NewBranch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.StatsCommit != nil {
		...
		n24, err := m.StatsCommit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *PipelineInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Pipeline != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Pipeline.Size()))
		n28, err := m.Pipeline.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if m.Transform != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Transform.Size()))
		n29, err := m.Transform.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.ScaleDownThreshold != nil {
		...
		n33, err := m.ScaleDownThreshold.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.ResourceSpec != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.ResourceSpec.Size()))
		n34, err := m.ResourceSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *CreateJobRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Pipeline != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Pipeline.Size()))
		n37, err := m.Pipeline.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	...
	if m.ParentJob != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.ParentJob.Size()))
		n42, err := m.ParentJob.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.ResourceSpec != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.ResourceSpec.Size()))
		n43, err := m.ResourceSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.Input != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Input.Size()))
		n44, err := m.Input.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.NewBranch != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.NewBranch.Size()))
		n45, err := m.NewBranch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *InspectJobRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Job != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Job.Size()))
		n46, err := m.Job.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *DeleteJobRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Job != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Job.Size()))
		n48, err := m.Job.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *StopJobRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Job != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Job.Size()))
		n49, err := m.Job.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *GetLogsRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Job != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.Job.Size()))
		n50, err := m.Job.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *CreatePipelineRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResourceSpec != nil {
		...
		i++
		i = encodeVarintPps(dAtA, i, uint64(m.ResourceSpec.Size()))
		n59, err := m.ResourceSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n59
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Strategy |= (ParallelismSpec_Strategy(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Aggregation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			v |= uint32(dAtA[iNdEx-2]) << 16
			v |= uint32(dAtA[iNdEx-1]) << 24
			m.FifthPercentile = float32(math.Float32frombits(v))
		case 5:
			if wireType != 5 {
			...
			v |= uint32(dAtA[iNdEx-2]) << 16
			v |= uint32(dAtA[iNdEx-1]) << 24
			m.NinetyFifthPercentile = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorPps = []byte{
	...
	,
}
