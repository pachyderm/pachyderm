...
type JobInfo struct {
	...
	Output          *Output                     `protobuf:"bytes,17,opt,name=output" json:"output,omitempty"`
}
...
func (*Output) Descriptor() ([]byte, []int) { return fileDescriptorPps, []int{12} }

func (m *Output) GetRepo() *pfs.Repo {
	if m != nil {
		return m.Repo
	}
	return nil
...
func (m *Output) GetBranch() string {
	if m != nil {
		return m.Branch
	}
	return ""
...
type PipelineInfo struct {
	...
	Output          *Output                     `protobuf:"bytes,16,opt,name=output" json:"output,omitempty"`
}
...
type CreateJobRequest struct {
	...
	Output  *Output  `protobuf:"bytes,11,opt,name=output" json:"output,omitempty"`
}
...
var fileDescriptorPps = []byte{
	...
	,
}
