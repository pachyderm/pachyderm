...
type WorkerStatus struct {
	...
	Data    []*Datum                    `protobuf:"bytes,2,rep,name=data" json:"data,omitempty"`
...
func (m *WorkerStatus) GetJob() *Job {
	if m != nil {
		return m.Job
	}
	return nil
...
type JobInfo struct {
	...
	WorkerStatus    map[string]*WorkerStatus    `protobuf:"bytes,24,rep,name=worker_status,json=workerStatus" json:"worker_status,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *JobInfo) GetWorkerStatus() map[string]*WorkerStatus {
	if m != nil {
...
var fileDescriptorPps = []byte{
	...
	,
}
