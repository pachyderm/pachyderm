...
type PFSInput struct {
	...
	GroupOn string `protobuf:"bytes,10,opt,name=group_on,json=groupOn,proto3" json:"group_on,omitempty"`
...
func (m *PFSInput) GetGroupOn() string {
	if m != nil {
		return m.GroupOn
	}
	return ""
...
type Input struct {
	...
	Slice                *Slice     `protobuf:"bytes,9,opt,name=slice,proto3" json:"slice,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func init() {
	...
	proto.RegisterType((*Slice)(nil), "pps.Slice")
...
var fileDescriptor_dbf57f97f56369c0 = []byte{
	...
	,
	...
	,
}
...
func (m *PFSInput) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GroupOn) > 0 {
		i -= len(m.GroupOn)
		copy(dAtA[i:], m.GroupOn)
		i = encodeVarintPps(dAtA, i, uint64(len(m.GroupOn)))
		i--
		dAtA[i] = 0x52
	}
	if m.S3 {
...
func (m *Slice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Upper != 0 {
		i = encodeVarintPps(dAtA, i, uint64(m.Upper))
		i--
		dAtA[i] = 0x10
	}
	if m.Lower != 0 {
		i = encodeVarintPps(dAtA, i, uint64(m.Lower))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Slice) Size() (n int) {
	...
	_ = l
	if m.Lower != 0 {
		n += 1 + sovPps(uint64(m.Lower))
	}
	if m.Upper != 0 {
		n += 1 + sovPps(uint64(m.Upper))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *PFSInput) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.GroupOn = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
