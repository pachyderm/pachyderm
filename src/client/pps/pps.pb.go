...
type ParallelismSpec struct {
	...
	//	*ParallelismSpec_NumWorkers
	//	*ParallelismSpec_Coefficient
	Strategy isParallelismSpec_Strategy `protobuf_oneof:"strategy"`
}
...
type isParallelismSpec_Strategy interface {
	isParallelismSpec_Strategy()
}

type ParallelismSpec_NumWorkers struct {
	NumWorkers uint64 `protobuf:"varint,1,opt,name=num_workers,json=numWorkers,oneof"`
}
type ParallelismSpec_Coefficient struct {
	Coefficient float32 `protobuf:"fixed32,2,opt,name=coefficient,oneof"`
}

func (*ParallelismSpec_NumWorkers) isParallelismSpec_Strategy()  {}
func (*ParallelismSpec_Coefficient) isParallelismSpec_Strategy() {}

func (m *ParallelismSpec) GetStrategy() isParallelismSpec_Strategy {
	if m != nil {
		return m.Strategy
	}
	return nil
...
func (m *ParallelismSpec) GetNumWorkers() uint64 {
	if x, ok := m.GetStrategy().(*ParallelismSpec_NumWorkers); ok {
		return x.NumWorkers
	}
	return 0
}

func (m *ParallelismSpec) GetCoefficient() float32 {
	if x, ok := m.GetStrategy().(*ParallelismSpec_Coefficient); ok {
...
func (*ParallelismSpec) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ParallelismSpec_OneofMarshaler, _ParallelismSpec_OneofUnmarshaler, _ParallelismSpec_OneofSizer, []interface{}{
		(*ParallelismSpec_NumWorkers)(nil),
		(*ParallelismSpec_Coefficient)(nil),
	}
}

func _ParallelismSpec_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ParallelismSpec)
	// strategy
	switch x := m.Strategy.(type) {
	case *ParallelismSpec_NumWorkers:
		b.EncodeVarint(1<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.NumWorkers))
	case *ParallelismSpec_Coefficient:
		b.EncodeVarint(2<<3 | proto.WireFixed32)
		b.EncodeFixed32(uint64(math.Float32bits(x.Coefficient)))
	case nil:
	default:
		return fmt.Errorf("ParallelismSpec.Strategy has unexpected type %T", x)
	}
	return nil
}

func _ParallelismSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ParallelismSpec)
	switch tag {
	case 1: // strategy.num_workers
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Strategy = &ParallelismSpec_NumWorkers{x}
		return true, err
	case 2: // strategy.coefficient
		if wire != proto.WireFixed32 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed32()
		m.Strategy = &ParallelismSpec_Coefficient{math.Float32frombits(uint32(x))}
		return true, err
	default:
		return false, nil
	}
...
func _ParallelismSpec_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ParallelismSpec)
	// strategy
	switch x := m.Strategy.(type) {
	case *ParallelismSpec_NumWorkers:
...
var fileDescriptor0 = []byte{
	...
	,
}
