...
// SyncDurableDialOptions is a helper returning a slice of grpc.Dial
// options such that
// - Dial is synchronous: the call doesn't return until the connection has been
//                        established and it's safe to send RPCs
...
// 															idleness.
func SyncDurableDialOptions() []grpc.DialOption {
	return append(SyncDialOptions(),
