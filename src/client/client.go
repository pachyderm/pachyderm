...
func New(options ...Option) (*APIClient, error) {
	...
	if settings.pachdAddress != nil {
		return nil, errors.Errorf("no pachd address was configured by the provided options")
	}
	c := &APIClient{
		addr:         settings.pachdAddress,
