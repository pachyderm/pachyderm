...
package deploy // import "github.com/pachyderm/pachyderm/src/client/deploy"
...
func (*DeployStorageSecretRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deploy_b4f3c5e85a4ca46a, []int{0}
}
...
func (dst *DeployStorageSecretRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeployStorageSecretRequest.Merge(dst, src)
}
...
func (*DeployStorageSecretResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deploy_b4f3c5e85a4ca46a, []int{1}
}
...
func (dst *DeployStorageSecretResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeployStorageSecretResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("client/deploy/deploy.proto", fileDescriptor_deploy_b4f3c5e85a4ca46a) }

var fileDescriptor_deploy_b4f3c5e85a4ca46a = []byte{
	...
	0xb1, 0x46, 0x89, 0xc1, 0xc9, 0xe9, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c,
	0x92, 0x63, 0x9c, 0xf1, 0x58, 0x8e, 0x21, 0xca, 0x20, 0x3d, 0xb3, 0x24, 0xa3, 0x34, 0x49, 0x2f,
	0x39, 0x3f, 0x57, 0xbf, 0x20, 0x31, 0x39, 0xa3, 0x32, 0x25, 0xb5, 0x08, 0x99, 0x55, 0x5c, 0x94,
	0xac, 0x8f, 0x12, 0x0d, 0x49, 0x6c, 0xe0, 0x08, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x97,
	0xcb, 0x25, 0xc7, 0x9e, 0x01, 0x00, 0x00,
}
