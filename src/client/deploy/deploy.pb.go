...
func (*DeployStorageSecretRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6da60e9fa5e4c68d, []int{0}
}
func (m *DeployStorageSecretRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeployStorageSecretRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeployStorageSecretRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *DeployStorageSecretRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeployStorageSecretRequest.Merge(m, src)
}
func (m *DeployStorageSecretRequest) XXX_Size() int {
	return m.Size()
}
func (m *DeployStorageSecretRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_DeployStorageSecretRequest.DiscardUnknown(m)
}

var xxx_messageInfo_DeployStorageSecretRequest proto.InternalMessageInfo
...
func (m *DeployStorageSecretRequest) GetDryRun() bool {
	if m != nil {
		return m.DryRun
	}
	return false
...
func (*DeployStorageSecretResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6da60e9fa5e4c68d, []int{1}
}
func (m *DeployStorageSecretResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeployStorageSecretResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeployStorageSecretResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *DeployStorageSecretResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeployStorageSecretResponse.Merge(m, src)
}
func (m *DeployStorageSecretResponse) XXX_Size() int {
	return m.Size()
}
func (m *DeployStorageSecretResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_DeployStorageSecretResponse.DiscardUnknown(m)
}

var xxx_messageInfo_DeployStorageSecretResponse proto.InternalMessageInfo

func init() {
	proto.RegisterType((*DeployStorageSecretRequest)(nil), "deploy.DeployStorageSecretRequest")
	proto.RegisterMapType((map[string][]byte)(nil), "deploy.DeployStorageSecretRequest.SecretsEntry")
	proto.RegisterType((*DeployStorageSecretResponse)(nil), "deploy.DeployStorageSecretResponse")
}

func init() { proto.RegisterFile("client/deploy/deploy.proto", fileDescriptor_6da60e9fa5e4c68d) }

var fileDescriptor_6da60e9fa5e4c68d = []byte{
	...
	0xf9, 0x42, 0x6c, 0x10, 0x9e, 0xd2, 0x1e, 0x46, 0x2e, 0x29, 0x17, 0x30, 0x33, 0xb8, 0x24, 0xbf,
	...
	,
}
...
func (c *aPIClient) DeployStorageSecret(ctx context.Context, in *DeployStorageSecretRequest, opts ...grpc.CallOption) (*DeployStorageSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/deploy.API/DeployStorageSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
