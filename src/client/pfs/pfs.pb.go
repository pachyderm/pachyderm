...
type BranchInfo struct {
	...
	Provenance       map[string]*Branch `protobuf:"bytes,3,rep,name=provenance" json:"provenance,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	Subvenance       map[string]*Branch `protobuf:"bytes,5,rep,name=subvenance" json:"subvenance,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	DirectProvenance map[string]*Branch `protobuf:"bytes,6,rep,name=direct_provenance,json=directProvenance" json:"direct_provenance,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *BranchInfo) GetProvenance() map[string]*Branch {
	if m != nil {
		return m.Provenance
	}
	return nil
...
func (m *BranchInfo) GetSubvenance() map[string]*Branch {
	if m != nil {
		return m.Subvenance
	}
	return nil
...
func (m *BranchInfo) GetDirectProvenance() map[string]*Branch {
	if m != nil {
...
func (m *BranchInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DirectProvenance) > 0 {
		for k, _ := range m.DirectProvenance {
			dAtA[i] = 0x32
			i++
			v := m.DirectProvenance[k]
			msgSize := 0
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovPfs(uint64(msgSize))
...
func (m *RepoInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AuthInfo != nil {
		...
		n10, err := m.AuthInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *CommitRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Lower != nil {
		...
		n12, err := m.Lower.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.Upper != nil {
		...
		n13, err := m.Upper.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *CommitInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ParentCommit != nil {
		...
		n15, err := m.ParentCommit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.Started != nil {
		...
		n16, err := m.Started.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.Finished != nil {
		...
		n17, err := m.Finished.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	...
	if m.Tree != nil {
		...
		n18, err := m.Tree.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *BlockRef) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Block != nil {
		...
		n20, err := m.Block.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *ObjectInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BlockRef != nil {
		...
		n23, err := m.BlockRef.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *BuildCommitRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Parent != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Parent.Size()))
		n28, err := m.Parent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *CreateBranchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Head != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Head.Size()))
		n37, err := m.Head.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *CopyFileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Src != nil {
		...
		n48, err := m.Src.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
	...
	if m.Dst != nil {
		...
		n49, err := m.Dst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *BranchInfo) Size() (n int) {
	...
	if len(m.DirectProvenance) > 0 {
		for k, v := range m.DirectProvenance {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *BranchInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Provenance == nil {
				m.Provenance = make(map[string]*Branch)
			}
			var mapkey string
			var mapvalue *Branch
			for iNdEx < postIndex {
		...
		case 5:
			...
			if m.Subvenance == nil {
				m.Subvenance = make(map[string]*Branch)
			}
			var mapkey string
			var mapvalue *Branch
			for iNdEx < postIndex {
		...
		case 6:
			...
			if m.DirectProvenance == nil {
				m.DirectProvenance = make(map[string]*Branch)
			}
			var mapkey string
			var mapvalue *Branch
			for iNdEx < postIndex {
			...
			m.DirectProvenance[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
...
var fileDescriptorPfs = []byte{
	...
	,
}
