...
const (
	DatumState_DATUM_FAILED  DatumState = 0
	DatumState_DATUM_SUCCESS DatumState = 1
	DatumState_DATUM_SKIPPED DatumState = 2
)
...
func (DatumState) EnumDescriptor() ([]byte, []int) { return fileDescriptorPfs, []int{1} }
...
type DatumStats struct {
	DownloadTime  uint64 `protobuf:"varint,1,opt,name=download_time,json=downloadTime,proto3" json:"download_time,omitempty"`
	ProcessTime   uint64 `protobuf:"varint,2,opt,name=process_time,json=processTime,proto3" json:"process_time,omitempty"`
	UploadTime    uint64 `protobuf:"varint,3,opt,name=upload_time,json=uploadTime,proto3" json:"upload_time,omitempty"`
...
func (*DatumStats) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{18} }

func (m *DatumStats) GetDownloadTime() uint64 {
	if m != nil {
...
func (m *DatumStats) GetProcessTime() uint64 {
	if m != nil {
...
func (m *DatumStats) GetUploadTime() uint64 {
	if m != nil {
		return m.UploadTime
	}
	return 0
...
func (m *DatumStats) GetDownloadBytes() uint64 {
	if m != nil {
...
func (m *DatumStats) GetUploadBytes() uint64 {
	if m != nil {
...
type DatumInfo struct {
	...
	State DatumState  `protobuf:"varint,2,opt,name=state,proto3,enum=pfs.DatumState" json:"state,omitempty"`
	Stats *DatumStats `protobuf:"bytes,3,opt,name=stats" json:"stats,omitempty"`
}
...
func (*DatumInfo) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{19} }

func (m *DatumInfo) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *DatumInfo) GetState() DatumState {
	...
	return DatumState_DATUM_FAILED
}

func (m *DatumInfo) GetStats() *DatumStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
func (*DatumInfos) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{20} }
...
func (*DiffFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{41} }
...
func (*DiffFileResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{42} }
...
func (*DeleteFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{43} }
...
func (*PutObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{44} }
...
func (*GetObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{45} }
...
func (*TagObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{46} }
...
func (*ListObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{47} }
...
func (*ListTagsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{48} }
...
func (*ListTagsResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{49} }
...
func (*DeleteObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{50} }
...
func (*DeleteObjectsResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{51} }
...
func (*DeleteTagsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{52} }
...
func (*DeleteTagsResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{53} }
...
func (*CheckObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{54} }
...
func (*CheckObjectResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{55} }
...
func (*InspectDatumRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{56} }

func (m *InspectDatumRequest) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *InspectDatumRequest) GetPipelineName() string {
	if m != nil {
...
func (*ListDatumRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{57} }

func (m *ListDatumRequest) GetJobId() string {
	if m != nil {
		return m.JobId
	}
	return ""
...
func (m *ListDatumRequest) GetPipelineName() string {
	if m != nil {
		return m.PipelineName
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*DatumStats)(nil), "pfs.DatumStats")
	proto.RegisterType((*DatumInfo)(nil), "pfs.DatumInfo")
	proto.RegisterType((*DatumInfos)(nil), "pfs.DatumInfos")
	...
	proto.RegisterType((*InspectDatumRequest)(nil), "pfs.InspectDatumRequest")
	proto.RegisterType((*ListDatumRequest)(nil), "pfs.ListDatumRequest")
	proto.RegisterType((*ObjectIndex)(nil), "pfs.ObjectIndex")
	proto.RegisterEnum("pfs.FileType", FileType_name, FileType_value)
	proto.RegisterEnum("pfs.DatumState", DatumState_name, DatumState_value)
...
func (c *aPIClient) InspectDatum(ctx context.Context, in *InspectDatumRequest, opts ...grpc.CallOption) (*DatumInfo, error) {
	out := new(DatumInfo)
	err := grpc.Invoke(ctx, "/pfs.API/InspectDatum", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListDatum(ctx context.Context, in *ListDatumRequest, opts ...grpc.CallOption) (*DatumInfos, error) {
	out := new(DatumInfos)
	err := grpc.Invoke(ctx, "/pfs.API/ListDatum", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_InspectDatum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pfs.API/InspectDatum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *DatumStats) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DownloadTime != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.DownloadTime))
	}
	if m.ProcessTime != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.ProcessTime))
	}
	if m.UploadTime != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.UploadTime))
	}
	if m.DownloadBytes != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.DownloadBytes))
	}
	if m.UploadBytes != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.UploadBytes))
	}
	return i, nil
}
...
func (m *DiffFileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NewFile != nil {
		...
		n39, err := m.NewFile.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
	...
	if m.OldFile != nil {
		...
		n40, err := m.OldFile.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *InspectDatumRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PipelineName) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintPfs(dAtA, i, uint64(len(m.PipelineName)))
...
func (m *ListDatumRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.JobId) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintPfs(dAtA, i, uint64(len(m.JobId)))
...
func (m *DatumStats) Size() (n int) {
	...
	_ = l
	if m.DownloadTime != 0 {
		n += 1 + sovPfs(uint64(m.DownloadTime))
	}
	if m.ProcessTime != 0 {
		n += 1 + sovPfs(uint64(m.ProcessTime))
	}
	if m.UploadTime != 0 {
		n += 1 + sovPfs(uint64(m.UploadTime))
	}
	if m.DownloadBytes != 0 {
		n += 1 + sovPfs(uint64(m.DownloadBytes))
	}
	if m.UploadBytes != 0 {
		n += 1 + sovPfs(uint64(m.UploadBytes))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DownloadTime |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UploadTime |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorPfs = []byte{
	...
	,
}
