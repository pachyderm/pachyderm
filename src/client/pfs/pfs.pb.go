...
type CommitInfo struct {
	...
	TotalProvenance int64 `protobuf:"varint,21,opt,name=total_provenance,json=totalProvenance,proto3" json:"total_provenance,omitempty"`
	...
	// Alias is the ID for another commit (in the same repo) that this commit is
	// an alias for.
...
func (m *CommitInfo) GetTotalProvenance() int64 {
	if m != nil {
		return m.TotalProvenance
	}
	return 0
}
...
func (m *CommitInfo) GetAlias() string {
	if m != nil {
		return m.Alias
	}
	return ""
...
// StoredCommitInfo is the data structure we store to represent a commit it's
// not part of the user facing API.
type StoredCommitInfo struct {
	ID       string           `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Started  *types.Timestamp `protobuf:"bytes,2,opt,name=started,proto3" json:"started,omitempty"`
	Finished *types.Timestamp `protobuf:"bytes,3,opt,name=finished,proto3" json:"finished,omitempty"`
	// Entries is a map from repo names to an CommitInfo for this commit in
	// that repo. Some fields in the CommitInfo are left blank because they can
	// be computed from the other entries.
	Entries map[string]*CommitInfo `protobuf:"bytes,4,rep,name=entries,proto3" json:"entries,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Provenance stores the provenance relationship between commits in Entries.
	// The commits are enumerated in lexicographic order, Bitset[n][m] is true if
	// m is provenance for n, and n is subvenance for m.
	Provenance           []*StoredCommitInfo_Bitset `protobuf:"bytes,5,rep,name=provenance,proto3" json:"provenance,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}

func (m *StoredCommitInfo) Reset()         { *m = StoredCommitInfo{} }
func (m *StoredCommitInfo) String() string { return proto.CompactTextString(m) }
func (*StoredCommitInfo) ProtoMessage()    {}
func (*StoredCommitInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_b48f014707f6595c, []int{15}
}
func (m *StoredCommitInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoredCommitInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoredCommitInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoredCommitInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoredCommitInfo.Merge(m, src)
}
func (m *StoredCommitInfo) XXX_Size() int {
	return m.Size()
}
func (m *StoredCommitInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_StoredCommitInfo.DiscardUnknown(m)
}

var xxx_messageInfo_StoredCommitInfo proto.InternalMessageInfo

func (m *StoredCommitInfo) GetID() string {
	if m != nil {
		return m.ID
	}
	return ""
...
func (m *StoredCommitInfo) GetStarted() *types.Timestamp {
	if m != nil {
		return m.Started
	}
	return nil
...
func (m *StoredCommitInfo) GetFinished() *types.Timestamp {
	if m != nil {
		return m.Finished
	}
	return nil
...
func (m *StoredCommitInfo) GetEntries() map[string]*CommitInfo {
	if m != nil {
		return m.Entries
	}
	return nil
...
func (m *StoredCommitInfo) GetProvenance() []*StoredCommitInfo_Bitset {
	if m != nil {
		return m.Provenance
	}
	return nil
...
type StoredCommitInfo_Bitset struct {
...
func (m *StoredCommitInfo_Bitset) Reset()         { *m = StoredCommitInfo_Bitset{} }
func (m *StoredCommitInfo_Bitset) String() string { return proto.CompactTextString(m) }
func (*StoredCommitInfo_Bitset) ProtoMessage()    {}
func (*StoredCommitInfo_Bitset) Descriptor() ([]byte, []int) {
	return fileDescriptor_b48f014707f6595c, []int{15, 1}
}
func (m *StoredCommitInfo_Bitset) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoredCommitInfo_Bitset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoredCommitInfo_Bitset.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoredCommitInfo_Bitset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoredCommitInfo_Bitset.Merge(m, src)
}
func (m *StoredCommitInfo_Bitset) XXX_Size() int {
	return m.Size()
}
func (m *StoredCommitInfo_Bitset) XXX_DiscardUnknown() {
	xxx_messageInfo_StoredCommitInfo_Bitset.DiscardUnknown(m)
}

var xxx_messageInfo_StoredCommitInfo_Bitset proto.InternalMessageInfo

func (m *StoredCommitInfo_Bitset) GetBits() []uint64 {
	if m != nil {
		return m.Bits
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*StoredCommitInfo)(nil), "pfs.StoredCommitInfo")
	proto.RegisterMapType((map[string]*CommitInfo)(nil), "pfs.StoredCommitInfo.EntriesEntry")
	proto.RegisterType((*StoredCommitInfo_Bitset)(nil), "pfs.StoredCommitInfo.Bitset")
...
var fileDescriptor_b48f014707f6595c = []byte{
	...
	,
}
...
func (m *CommitInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Alias) > 0 {
		i -= len(m.Alias)
		copy(dAtA[i:], m.Alias)
		i = encodeVarintPfs(dAtA, i, uint64(len(m.Alias)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
	}
	if m.TotalProvenance != 0 {
		i = encodeVarintPfs(dAtA, i, uint64(m.TotalProvenance))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
...
func (m *StoredCommitInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoredCommitInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoredCommitInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoredCommitInfo_Bitset) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoredCommitInfo_Bitset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoredCommitInfo_Bitset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Bits) > 0 {
		dAtA25 := make([]byte, len(m.Bits)*10)
		var j24 int
		...
		i = encodeVarintPfs(dAtA, i, uint64(j24))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CommitInfo) Size() (n int) {
	...
	if m.TotalProvenance != 0 {
		n += 2 + sovPfs(uint64(m.TotalProvenance))
	}
	l = len(m.Alias)
	if l > 0 {
		n += 2 + l + sovPfs(uint64(l))
...
func (m *StoredCommitInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StoredCommitInfo_Bitset) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CommitInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalProvenance", wireType)
			}
			m.TotalProvenance = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalProvenance |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *StoredCommitInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoredCommitInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoredCommitInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			if m.Entries == nil {
				m.Entries = make(map[string]*CommitInfo)
			}
			var mapkey string
			var mapvalue *CommitInfo
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 5:
			...
			m.Provenance = append(m.Provenance, &StoredCommitInfo_Bitset{})
			if err := m.Provenance[len(m.Provenance)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *StoredCommitInfo_Bitset) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Bits) == 0 {
					m.Bits = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
