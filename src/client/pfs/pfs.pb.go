...
func (CommitState) EnumDescriptor() ([]byte, []int) { return fileDescriptorPfs, []int{1} }
...
func (*Header) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{37} }
...
func (*Footer) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{38} }

func (m *Footer) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
type PutFileRequest struct {
	...
	// header indicates data indicates data that should be prepended to each
	// written file (only used if delimiter is not NONE). This allows for sensible
	// semantics when splitting e.g. .csv or .pgdump files, where reading any
	// shard (as in a pipeline) will return the header data required to interpret
	// that shard, but reading all shards (as with a glob pattern) will not repeat
	// the header but only include it once at the beginning.
	Header *Header `protobuf:"bytes,11,opt,name=header" json:"header,omitempty"`
	// footer is similar to 'header', but it indicates data indicates data that
	// should be appended written file (again, only used if delimiter is not
	// NONE). This allows for the same sensible semantics as 'header' but with
	// respect to data that should appear at the end of any shard(s).
	Footer *Footer `protobuf:"bytes,12,opt,name=footer" json:"footer,omitempty"`
}

func (m *PutFileRequest) Reset()                    { *m = PutFileRequest{} }
func (m *PutFileRequest) String() string            { return proto.CompactTextString(m) }
func (*PutFileRequest) ProtoMessage()               {}
func (*PutFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{39} }
...
func (m *PutFileRequest) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *PutFileRequest) GetFooter() *Footer {
	if m != nil {
		return m.Footer
	}
	return nil
...
func (*PutFileRecord) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{40} }
...
func (*PutFileRecords) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{41} }
...
func (*CopyFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{42} }
...
func (*InspectFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{43} }
...
func (*ListFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{44} }
...
func (*WalkFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{45} }
...
func (*GlobFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{46} }
...
func (*FileInfos) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{47} }
...
func (*DiffFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{48} }
...
func (*DiffFileResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{49} }
...
func (*DeleteFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{50} }
...
func (*PutObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{51} }
...
func (*GetObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{52} }
...
func (*GetBlocksRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{53} }
...
func (*TagObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{54} }
...
func (*ListObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{55} }
...
func (*ListTagsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{56} }
...
func (*ListTagsResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{57} }
...
func (*DeleteObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{58} }
...
func (*DeleteObjectsResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{59} }
...
func (*DeleteTagsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{60} }
...
func (*DeleteTagsResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{61} }
...
func (*CheckObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{62} }
...
func (*CheckObjectResponse) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{63} }
...
func (*Objects) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{64} }
...
func (*ObjectIndex) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{65} }
...
func init() {
	...
	proto.RegisterType((*Header)(nil), "pfs.Header")
	proto.RegisterType((*Footer)(nil), "pfs.Footer")
...
func (c *aPIClient) WalkFile(ctx context.Context, in *WalkFileRequest, opts ...grpc.CallOption) (API_WalkFileClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_API_serviceDesc.Streams[6], c.cc, "/pfs.API/WalkFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) GlobFileStream(ctx context.Context, in *GlobFileRequest, opts ...grpc.CallOption) (API_GlobFileStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_API_serviceDesc.Streams[7], c.cc, "/pfs.API/GlobFileStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) PutObjects(ctx context.Context, opts ...grpc.CallOption) (ObjectAPI_PutObjectsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[2], c.cc, "/pfs.ObjectAPI/PutObjects", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *objectAPIPutObjectsClient) CloseAndRecv() (*google_protobuf.Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(google_protobuf.Empty)
...
func (c *objectAPIClient) GetObject(ctx context.Context, in *Object, opts ...grpc.CallOption) (ObjectAPI_GetObjectClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[3], c.cc, "/pfs.ObjectAPI/GetObject", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) GetObjects(ctx context.Context, in *GetObjectsRequest, opts ...grpc.CallOption) (ObjectAPI_GetObjectsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[4], c.cc, "/pfs.ObjectAPI/GetObjects", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) GetBlocks(ctx context.Context, in *GetBlocksRequest, opts ...grpc.CallOption) (ObjectAPI_GetBlocksClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[5], c.cc, "/pfs.ObjectAPI/GetBlocks", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *objectAPIGetBlocksClient) Recv() (*google_protobuf2.BytesValue, error) {
	m := new(google_protobuf2.BytesValue)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) ListObjects(ctx context.Context, in *ListObjectsRequest, opts ...grpc.CallOption) (ObjectAPI_ListObjectsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[6], c.cc, "/pfs.ObjectAPI/ListObjects", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) GetTag(ctx context.Context, in *Tag, opts ...grpc.CallOption) (ObjectAPI_GetTagClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[7], c.cc, "/pfs.ObjectAPI/GetTag", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) ListTags(ctx context.Context, in *ListTagsRequest, opts ...grpc.CallOption) (ObjectAPI_ListTagsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[8], c.cc, "/pfs.ObjectAPI/ListTags", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *objectAPIPutObjectsServer) SendAndClose(m *google_protobuf.Empty) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *objectAPIGetBlocksServer) Send(m *google_protobuf2.BytesValue) error {
	return x.ServerStream.SendMsg(m)
}
...
func (m *ObjectInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BlockRef != nil {
		...
		n21, err := m.BlockRef.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *BuildCommitRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Tree != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Tree.Size()))
		n27, err := m.Tree.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *FinishCommitRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Tree != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Tree.Size()))
		n29, err := m.Tree.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.Datums != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Datums.Size()))
		n30, err := m.Datums.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *CreateBranchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Head != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Head.Size()))
		n35, err := m.Head.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.Branch != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Branch.Size()))
		n36, err := m.Branch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *DeleteBranchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Branch != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Branch.Size()))
		n39, err := m.Branch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *SubscribeCommitRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Repo != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Repo.Size()))
		n41, err := m.Repo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *GetFileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.File != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.File.Size()))
		n43, err := m.File.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *Footer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Footer) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *PutFileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OverwriteIndex != nil {
		...
		n45, err := m.OverwriteIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
	...
	if m.Footer != nil {
		...
		n47, err := m.Footer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *PutFileRecord) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OverwriteIndex != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.OverwriteIndex.Size()))
		n48, err := m.OverwriteIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *PutFileRecords) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Footer != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Footer.Size()))
		n50, err := m.Footer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *CopyFileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Src != nil {
		...
		n51, err := m.Src.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if m.Dst != nil {
		...
		n52, err := m.Dst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
...
func (m *DiffFileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NewFile != nil {
		...
		n57, err := m.NewFile.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
	...
	if m.OldFile != nil {
		...
		n58, err := m.OldFile.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n58
...
func (m *PutObjectRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Block != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Block.Size()))
		n60, err := m.Block.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n60
...
func (m *TagObjectRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Object != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Object.Size()))
		n61, err := m.Object.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n61
...
func (m *ListTagsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Tag != nil {
		...
		n62, err := m.Tag.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n62
...
func (m *CheckObjectRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Object != nil {
		...
		i++
		i = encodeVarintPfs(dAtA, i, uint64(m.Object.Size()))
		n64, err := m.Object.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *Footer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorPfs = []byte{
	...
	,
}
