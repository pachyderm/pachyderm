...
func (m *ListAllObjectsRequest) Reset()                    { *m = ListAllObjectsRequest{} }
func (m *ListAllObjectsRequest) String() string            { return proto.CompactTextString(m) }
func (*ListAllObjectsRequest) ProtoMessage()               {}
func (*ListAllObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorPfs, []int{42} }
...
func init() {
	...
	proto.RegisterType((*ListAllObjectsRequest)(nil), "pfs.ListAllObjectsRequest")
...
type ObjectAPIClient interface {
	...
	ListAllObjects(ctx context.Context, in *ListAllObjectsRequest, opts ...grpc.CallOption) (ObjectAPI_ListAllObjectsClient, error)
	...
	ListObjectsTaggedWithPrefix(ctx context.Context, in *Tag, opts ...grpc.CallOption) (ObjectAPI_ListObjectsTaggedWithPrefixClient, error)
...
func (c *objectAPIClient) ListAllObjects(ctx context.Context, in *ListAllObjectsRequest, opts ...grpc.CallOption) (ObjectAPI_ListAllObjectsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[3], c.cc, "/pfs.ObjectAPI/ListAllObjects", opts...)
	if err != nil {
		return nil, err
	}
	x := &objectAPIListAllObjectsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ObjectAPI_ListAllObjectsClient interface {
	Recv() (*ObjectInfo, error)
	grpc.ClientStream
}

type objectAPIListAllObjectsClient struct {
	grpc.ClientStream
}

func (x *objectAPIListAllObjectsClient) Recv() (*ObjectInfo, error) {
	m := new(ObjectInfo)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *objectAPIClient) ListObjectsTaggedWithPrefix(ctx context.Context, in *Tag, opts ...grpc.CallOption) (ObjectAPI_ListObjectsTaggedWithPrefixClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ObjectAPI_serviceDesc.Streams[5], c.cc, "/pfs.ObjectAPI/ListObjectsTaggedWithPrefix", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *objectAPIListObjectsTaggedWithPrefixClient) Recv() (*ObjectInfo, error) {
	m := new(ObjectInfo)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type ObjectAPIServer interface {
	...
	ListAllObjects(*ListAllObjectsRequest, ObjectAPI_ListAllObjectsServer) error
	GetTag(*Tag, ObjectAPI_GetTagServer) error
	InspectTag(context.Context, *Tag) (*ObjectInfo, error)
	ListObjectsTaggedWithPrefix(*Tag, ObjectAPI_ListObjectsTaggedWithPrefixServer) error
...
func _ObjectAPI_ListAllObjects_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListAllObjectsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ObjectAPIServer).ListAllObjects(m, &objectAPIListAllObjectsServer{stream})
}

type ObjectAPI_ListAllObjectsServer interface {
	Send(*ObjectInfo) error
	grpc.ServerStream
}

type objectAPIListAllObjectsServer struct {
	grpc.ServerStream
}

func (x *objectAPIListAllObjectsServer) Send(m *ObjectInfo) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *objectAPIListObjectsTaggedWithPrefixServer) Send(m *ObjectInfo) error {
	return x.ServerStream.SendMsg(m)
}
...
var _ObjectAPI_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ListAllObjects",
			Handler:       _ObjectAPI_ListAllObjects_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "GetTag",
...
var fileDescriptorPfs = []byte{
	...
	,
}
