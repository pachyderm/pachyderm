...
func TestInterceptors(t *testing.T) {
	...
	c, err := NewFromURI(ctx, listener.Addr().String(), WithAdditionalUnaryClientInterceptors(interceptor.unary()), WithAdditionalStreamClientInterceptors(interceptor.stream()))
	if err != nil {
