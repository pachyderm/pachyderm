...
func (m *mockPFSClient) ListRepo(ctx context.Context, in *pfs.ListRepoRequest, opts ...grpc.CallOption) (pfs.API_ListRepoClient, error) {
	args := m.Called(in)
	return args.Get(0).(pfs.API_ListRepoClient), args.Error(1)
}
...
func (m *mockPFSClient) ListCommitSet(ctx context.Context, in *pfs.ListCommitSetRequest, opts ...grpc.CallOption) (pfs.API_ListCommitSetClient, error) {
	args := m.Called(in)
	return args.Get(0).(pfs.API_ListCommitSetClient), args.Error(1)
}
...
func (m *mockPFSClient) ListBranch(ctx context.Context, in *pfs.ListBranchRequest, opts ...grpc.CallOption) (pfs.API_ListBranchClient, error) {
	args := m.Called(in)
	return args.Get(0).(pfs.API_ListBranchClient), args.Error(1)
}
...
func (m *mockPPSClient) ListJobSet(ctx context.Context, in *pps.ListJobSetRequest, opts ...grpc.CallOption) (pps.API_ListJobSetClient, error) {
	args := m.Called(in)
	return args.Get(0).(pps.API_ListJobSetClient), args.Error(1)
}
...
func (m *mockPPSClient) ListPipeline(ctx context.Context, in *pps.ListPipelineRequest, opts ...grpc.CallOption) (pps.API_ListPipelineClient, error) {
	args := m.Called(in)
	return args.Get(0).(pps.API_ListPipelineClient), args.Error(1)
}
