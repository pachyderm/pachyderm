...
type createDetPipelineSideEffectsFunc func(context.Context, *pps.CreateDetPipelineSideEffectsRequest) (*pps.CreateDetPipelineSideEffectsResponse, error)
...
func (api *ppsServerAPI) CreateDetPipelineSideEffects(ctx context.Context, req *pps.CreateDetPipelineSideEffectsRequest) (*pps.CreateDetPipelineSideEffectsResponse, error) {
	if api.mock.CreatePipeline.handler != nil {
		return api.mock.CreateDetPipelineSideEffects.handler(ctx, req)
	}
	return nil, errors.Errorf("unhandled pachd mock pps.CreatePipeline")
}
