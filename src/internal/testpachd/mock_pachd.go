...
type inspectClusterFunc func(context.Context, *emptypb.Empty) (*admin.ClusterInfo, error)
...
func (api *adminServerAPI) InspectCluster(ctx context.Context, req *emptypb.Empty) (*admin.ClusterInfo, error) {
