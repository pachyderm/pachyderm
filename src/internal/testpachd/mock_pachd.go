...
type searchForFileInBranchFunc func(context.Context, *pfs.SearchForFileInBranchRequest) (*pfs.SearchForFileInBranchResponse, error)
...
type mockSearchForFileInBranch struct{ handler searchForFileInBranchFunc }
...
func (mock *mockSearchForFileInBranch) Use(cb searchForFileInBranchFunc) { mock.handler = cb }
...
type mockPFSServer struct {
	...
	SearchForFileInBranch mockSearchForFileInBranch
...
func (api *pfsServerAPI) SearchForFileInBranch(ctx context.Context, req *pfs.SearchForFileInBranchRequest) (*pfs.SearchForFileInBranchResponse, error) {
	if api.mock.SearchForFileInBranch.handler != nil {
		return api.mock.SearchForFileInBranch.handler(ctx, req)
	}
	return nil, errors.Errorf("unhandled pachd mock pfs.SearchForFileInBranch")
}
