...
// HashFileSetID hashes the fileset identified by ID from the FilesetReader fr.
func HashFilesetID(ctx context.Context, fr FilesetReader, id string) ([]byte, error) {
	var h hasher
