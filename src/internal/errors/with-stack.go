...
// SPDX-FileCopyrightText: Copyright (c) 2015, Dave Cheney <dave@cheney.net> All rights reserved.
...
// Taken from https://github.com/pkg/errors/commit/614d223910a179a466c1767a985424175c39b465.
...
func (f Frame) Format(s fmt.State, verb rune) {
	...
	case 'v':
		f.Format(s, 's')       //nolint:errcheck
		io.WriteString(s, ":") //nolint:errcheck
		f.Format(s, 'd')       //nolint:errcheck
	}
}
