...
type Client interface {
	...
	AddFileSet(ctx context.Context, repo, branch, commit, ID string) error
...
func (pc *pachClient) AddFileSet(ctx context.Context, repo, branch, commit, ID string) error {
	return pc.client.WithCtx(ctx).AddFileSet(repo, branch, commit, ID)
}
