...
func (m *Repo) String() string {
	if m.Type == "user" {
		if projectName := m.Project.String(); projectName != "" {
			return projectName + "/" + m.Name
		}
		return m.Name
	}
	if projectName := m.Project.String(); projectName != "" {
		return projectName + "/" + m.Name + "." + m.Type
	}
...
func (m *Branch) String() string              { return m.Repo.String() + "@" + m.Name }
...
func (m *Commit) String() string              { return m.Repo.String() + "@" + m.ID }
...
func (m *Project) String() string              { return m.GetName() }
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
