...
// CommitInfo_V2_5_0 is the main data structure representing a commit
type CommitInfo_V2_5_0 struct {
...
func (m *CommitInfo_V2_5_0) Reset()         { *m = CommitInfo_V2_5_0{} }
func (m *CommitInfo_V2_5_0) String() string { return proto.CompactTextString(m) }
func (*CommitInfo_V2_5_0) ProtoMessage()    {}
func (*CommitInfo_V2_5_0) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{9}
}
func (m *CommitInfo_V2_5_0) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommitInfo_V2_5_0) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
...
func (m *CommitInfo_V2_5_0) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommitInfo.Merge(m, src)
}
func (m *CommitInfo_V2_5_0) XXX_Size() int {
	return m.Size()
}
func (m *CommitInfo_V2_5_0) XXX_DiscardUnknown() {
	xxx_messageInfo_CommitInfo.DiscardUnknown(m)
}

var xxx_messageInfo_CommitInfo proto.InternalMessageInfo

func (m *CommitInfo_V2_5_0) GetCommit() *pfs.Commit {
	if m != nil {
		return m.Commit
	}
	return nil
...
func (m *CommitInfo_V2_5_0) GetOrigin() *pfs.CommitOrigin {
	if m != nil {
		return m.Origin
	}
	return nil
...
func (m *CommitInfo_V2_5_0) GetDescription() string {
	if m != nil {
...
func (m *CommitInfo_V2_5_0) GetParentCommit() *pfs.Commit {
	if m != nil {
...
func (m *CommitInfo_V2_5_0) GetChildCommits() []*pfs.Commit {
	if m != nil {
...
func (m *CommitInfo_V2_5_0) GetStarted() *types.Timestamp {
	if m != nil {
		return m.Started
	}
	return nil
...
func (m *CommitInfo_V2_5_0) GetFinishing() *types.Timestamp {
	if m != nil {
		return m.Finishing
	}
	return nil
...
func (m *CommitInfo_V2_5_0) GetFinished() *types.Timestamp {
	if m != nil {
		return m.Finished
	}
	return nil
...
func (m *CommitInfo_V2_5_0) GetDirectProvenance() []*pfs.Branch {
	if m != nil {
...
func (m *CommitInfo_V2_5_0) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func (m *CommitInfo_V2_5_0) GetSizeBytesUpperBound() int64 {
	if m != nil {
...
func (m *CommitInfo_V2_5_0) GetDetails() *pfs.CommitInfo_Details {
	if m != nil {
		return m.Details
	}
	return nil
...
func (m *CommitInfo_V2_5_0) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *CommitInfo_V2_5_0) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommitInfo_V2_5_0) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CommitInfo_V2_5_0) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *CommitInfo_V2_5_0) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
