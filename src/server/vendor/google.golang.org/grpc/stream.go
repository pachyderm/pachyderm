...
func (cs *clientStream) SendMsg(m interface{}) (err error) {
	...
	if len(out) > *cs.c.maxSendMessageSize {
		panic(fmt.Sprintf(codes.ResourceExhausted, "trying to send message larger than max (%d vs. %d)", len(out), *cs.c.maxSendMessageSize))
	}
...
func (ss *serverStream) SendMsg(m interface{}) (err error) {
	...
	if len(out) > ss.maxSendMessageSize {
		panic(fmt.Sprintf(codes.ResourceExhausted, "trying to send message larger than max (%d vs. %d)", len(out), ss.maxSendMessageSize))
	}
