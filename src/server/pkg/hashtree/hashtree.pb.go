...
type Shared struct {
	...
	// The size of header + footer
	DataSize int64 `protobuf:"varint,3,opt,name=data_size,json=dataSize,proto3" json:"data_size,omitempty"`
}
...
func (m *Shared) GetDataSize() int64 {
	if m != nil {
		return m.DataSize
	}
	return 0
...
func (m *Shared) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DataSize != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintHashtree(dAtA, i, uint64(m.DataSize))
	}
	return i, nil
}
...
func (m *Shared) Size() (n int) {
	...
	if m.DataSize != 0 {
		n += 1 + sovHashtree(uint64(m.DataSize))
	}
	return n
}
...
var fileDescriptorHashtree = []byte{
	...
	,
}
