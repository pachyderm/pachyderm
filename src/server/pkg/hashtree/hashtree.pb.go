...
type DirectoryNodeProto struct {
	...
	// header, if set, references data that will be prepended to all direct
	// children of this directory with has_header_footer set to true.
	Header *pfs.BlockRef `protobuf:"bytes,4,opt,name=header" json:"header,omitempty"`
	// footer, if set, references data that will be appended to all direct
	// children of this directory with has_header_footer set to true.
	Footer *pfs.BlockRef `protobuf:"bytes,5,opt,name=footer" json:"footer,omitempty"`
}
...
func (m *DirectoryNodeProto) GetHeader() *pfs.BlockRef {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *DirectoryNodeProto) GetFooter() *pfs.BlockRef {
	if m != nil {
		return m.Footer
	}
	return nil
...
func (*Index) Descriptor() ([]byte, []int) { return fileDescriptorHashtree, []int{5} }
...
var fileDescriptorHashtree = []byte{
	...
	,
}
