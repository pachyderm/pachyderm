...
type HashTreeProto struct {
	...
	// FsDb fulfills the same need as Fs above except that instead of inlined map
	// it's a DB file that can be opened with an embeeded database engine.
	// Currently we use bolt for this.
	FsDb *pfs.Object `protobuf:"bytes,3,opt,name=fs_db,json=fsDb" json:"fs_db,omitempty"`
}
...
func (m *HashTreeProto) GetFsDb() *pfs.Object {
	if m != nil {
		return m.FsDb
	}
	return nil
...
func (m *HashTreeProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FsDb != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintHashtree(dAtA, i, uint64(m.FsDb.Size()))
		n4, err := m.FsDb.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *HashTreeProto) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FsDb", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FsDb.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorHashtree = []byte{
	...
	,
}
