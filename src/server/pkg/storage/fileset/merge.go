...
//}
//
//func (mr *MergeReader) Iterate(func(fr *FileMergeReader) error) error {
//	return mr.pq.iterate(func(ss []stream, next) {
//		// Convert generic streams to file streams.
//		var fileStreams []*fileStream
//		for _, s := range ss {
//			fileStreams = append(fileStreams, s.(*fileStream))
//		}
//		// Setup file merge reader.
...
//
//
//func newFileMergeReader() (*FileMergeReader, error) {
//
//}
//func (fmr *FileMergeReader) Read(data []byte) (int, error) {
//
//}
//
...
//}
//
//func newTagMergeReader() (*TagMergeReader, error) {
//	var tagStreams []stream
//	for _, r := range rs {
...
//
//
//func (tmr *TagMergeReader) Iterate(func(*index.Tag, io.Reader) error) error {
//
//}
//
