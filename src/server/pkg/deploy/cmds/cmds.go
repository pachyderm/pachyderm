...
var defaultDashImage = "pachyderm/dash:1.7-preview-7"
...
particular backend, run "pachctl deploy storage <backend>"`,
	...
	deploy.PersistentFlags().BoolVar(&noRBAC, "no-rbac", false, "Don't deploy RBAC roles for Pachyderm. Don't deploy RBAC roles for Pachyderm (for k8s versions prior to 1.8)")
