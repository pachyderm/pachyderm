...
type Puller struct {
	...
	errCh chan error
	// pipes is a set containing all pipes created
	pipes []string
	// cleaningUp is true if Puller is in the middle of a cleanUp process
	cleaningUp bool
}
