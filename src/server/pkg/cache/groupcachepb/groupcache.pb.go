...
var fileDescriptor_eb7cb1df297b6970 = []byte{
	...
	0x10, 0xeb, 0x95, 0x18, 0x9c, 0xfc, 0x4e, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1,
	0x23, 0x39, 0xc6, 0x28, 0x87, 0xf4, 0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0xfd,
	0x82, 0xc4, 0xe4, 0x8c, 0xca, 0x94, 0xd4, 0x22, 0x64, 0x56, 0x71, 0x51, 0xb2, 0x3e, 0xde, 0x40,
	0x03, 0x04, 0x00, 0x00, 0xff, 0xff, 0x24, 0xfe, 0xc7, 0x07, 0x54, 0x01, 0x00, 0x00,
}
...
func skipGroupcache(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupGroupcache
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupGroupcache = fmt.Errorf("proto: unexpected end of group")
)
