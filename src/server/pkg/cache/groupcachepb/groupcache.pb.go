...
package groupcachepb // import "github.com/pachyderm/pachyderm/src/server/pkg/cache/groupcachepb"
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_groupcache_ffbb544bb63afd0b, []int{0}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_groupcache_ffbb544bb63afd0b, []int{1}
}
...
func init() {
	proto.RegisterFile("server/pkg/cache/groupcachepb/groupcache.proto", fileDescriptor_groupcache_ffbb544bb63afd0b)
}

var fileDescriptor_groupcache_ffbb544bb63afd0b = []byte{
