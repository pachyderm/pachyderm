...
func NewPipelineAPIServer(pachClient *client.APIClient, etcdClient *etcd.Client, ppsEtcdPrefix string, pipelineInfo *pps.PipelineInfo, workerName string) *APIServer {
	server := &APIServer{
		pachClient:    pachClient,
		etcdClient:    etcdClient,
		ppsEtcdPrefix: ppsEtcdPrefix,
