...
type ProcessRequest struct {
	...
	// The commit that the worker should output stats information to while the
	// job is processing.
	StatsCommit *pfs.Commit `protobuf:"bytes,4,opt,name=stats_commit,json=statsCommit" json:"stats_commit,omitempty"`
}
...
func (m *ProcessRequest) GetStatsCommit() *pfs.Commit {
	if m != nil {
...
func (m *ProcessRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StatsCommit != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintWorkerService(dAtA, i, uint64(m.StatsCommit.Size()))
		n4, err := m.StatsCommit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
var fileDescriptorWorkerService = []byte{
	...
	,
}
