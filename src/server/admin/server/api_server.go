...
func (a *apiServer) Extract(request *admin.ExtractRequest, extractServer admin.API_ExtractServer) (retErr error) {
	...
	if !request.NoAuth {
		...
		if err := writeOp(&admin.Op{Op1_11: &admin.Op1_11{CheckAuthToken: &admin.CheckAuthToken{}}}); err != nil {
			return err
		}
	}
	...
	if !request.NoAuth {
		...
		if err := writeOp(&admin.Op{Op1_11: &admin.Op1_11{ActivateAuth: &auth.ActivateRequest{RootToken: ""}}}); err != nil {
			return err
		}
