...
func init() {
	...
	repoReaderRole := registerRole(&auth.Role{
		...
		Scopes:  []auth.ResourceType{auth.ResourceType_CLUSTER, auth.ResourceType_PROJECT, auth.ResourceType_REPO},
		Affects: []auth.ResourceType{auth.ResourceType_REPO},
	...
	oidcAppAdminRole := registerRole(&auth.Role{
		...
		Scopes:  []auth.ResourceType{auth.ResourceType_CLUSTER},
		Affects: []auth.ResourceType{auth.ResourceType_CLUSTER},
		Permissions: []auth.Permission{
	...
	projectViewerRole := registerRole(&auth.Role{
		...
		Scopes:  []auth.ResourceType{auth.ResourceType_CLUSTER, auth.ResourceType_PROJECT},
		Affects: []auth.ResourceType{auth.ResourceType_CLUSTER, auth.ResourceType_PROJECT},
		Permissions: []auth.Permission{
	...
	projectOwnerRole := registerRole(&auth.Role{
		...
		Scopes:  []auth.ResourceType{auth.ResourceType_CLUSTER, auth.ResourceType_PROJECT},
		Affects: []auth.ResourceType{auth.ResourceType_CLUSTER, auth.ResourceType_PROJECT, auth.ResourceType_REPO},
