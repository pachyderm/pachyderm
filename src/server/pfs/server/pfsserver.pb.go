...
type PutFileURLTask struct {
	...
	EndPath              string   `protobuf:"bytes,6,opt,name=end_path,json=endPath,proto3" json:"end_path,omitempty"`
	StartOffset          int64    `protobuf:"varint,7,opt,name=start_offset,json=startOffset,proto3" json:"start_offset,omitempty"`
	EndOffset            int64    `protobuf:"varint,8,opt,name=end_offset,json=endOffset,proto3" json:"end_offset,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *PutFileURLTask) GetStartPath() string {
	if m != nil {
		return m.StartPath
	}
	return ""
...
func (m *PutFileURLTask) GetEndPath() string {
	if m != nil {
		return m.EndPath
	}
	return ""
...
var fileDescriptor_a5a92e512e703e9c = []byte{
	...
	,
}
...
func (m *PutFileURLTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EndPath) > 0 {
		i -= len(m.EndPath)
		copy(dAtA[i:], m.EndPath)
		i = encodeVarintPfsserver(dAtA, i, uint64(len(m.EndPath)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.StartPath) > 0 {
		i -= len(m.StartPath)
		copy(dAtA[i:], m.StartPath)
		i = encodeVarintPfsserver(dAtA, i, uint64(len(m.StartPath)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Paths) > 0 {
...
func (m *PutFileURLTask) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartPath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StartPath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndPath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EndPath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
