...
# Overwrite header/footer for output generated by put-file split
# To remove the header or footer, specify an empty file
$ echo '' | pachctl put-file repo branch directory_containing_splitfiles --header=header.txt --footer=footer.txt - 
` + codeend + `
