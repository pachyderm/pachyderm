...
func PrintRepoInfo(w io.Writer, repoInfo *pfsserver.RepoInfo) {
...
func PrintCommitInfo(w io.Writer, commitInfo *pfsserver.CommitInfo) {
...
func PrintFileInfo(w io.Writer, fileInfo *pfsserver.FileInfo) {
...
func PrintBlockInfo(w io.Writer, blockInfo *pfsserver.BlockInfo) {
