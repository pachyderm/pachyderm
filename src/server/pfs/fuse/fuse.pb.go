...
func (m *FileMove) Reset()                    { *m = FileMove{} }
func (m *FileMove) String() string            { return proto.CompactTextString(m) }
func (*FileMove) ProtoMessage()               {}
func (*FileMove) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }

func (m *FileMove) GetFile() *Node {
	if m != nil {
		return m.File
	}
	return nil
...
func (*FileWrite) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*FileRemove) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func init() {
	...
	proto.RegisterType((*FileMove)(nil), "fuse.FileMove")
...
var fileDescriptor0 = []byte{
	...
	,
}
