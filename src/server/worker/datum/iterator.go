...
func NewFileSetIterator(pachClient *client.APIClient, fsID string, pathRange *pfs.PathRange) Iterator {
	return NewCommitIterator(pachClient, client.NewProjectRepo("", client.FileSetsRepoName).NewCommit(pfs.DefaultProjectName, fsID), pathRange)
}
...
func newFileSetMultiIterator(pachClient *client.APIClient, fsID string, pathRange *pfs.PathRange) Iterator {
	return &fileSetMultiIterator{
		pachClient: pachClient,
		commit:     client.NewProjectRepo("", client.FileSetsRepoName).NewCommit(pfs.DefaultProjectName, fsID),
		pathRange:  pathRange,
	}
}
