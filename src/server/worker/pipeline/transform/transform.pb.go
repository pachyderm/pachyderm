...
type HashtreeInfo struct {
	...
	// The tag can be used to fetch the object from object storage or when getting
	// the cached hashtree directly from the worker
...
type MergeData struct {
	...
	Parent    *HashtreeInfo   `protobuf:"bytes,2,opt,name=parent,proto3" json:"parent,omitempty"`
	Shard     int64           `protobuf:"varint,3,opt,name=shard,proto3" json:"shard,omitempty"`
	// Outputs
	Tree                 *pfs.Object `protobuf:"bytes,4,opt,name=tree,proto3" json:"tree,omitempty"`
...
func (m *MergeData) GetParent() *HashtreeInfo {
	if m != nil {
		return m.Parent
	}
	return nil
...
var fileDescriptor_21583a759eb7fa97 = []byte{
	...
	,
}
