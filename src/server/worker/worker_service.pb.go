...
func (*ServeRequest) Descriptor() ([]byte, []int) { return fileDescriptorWorkerService, []int{5} }

func (m *ServeRequest) GetJobID() string {
	if m != nil {
		return m.JobID
	}
	return ""
...
func (m *ServeRequest) GetData() []*Input {
	if m != nil {
		return m.Data
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ServeRequest)(nil), "worker.ServeRequest")
}
...
type WorkerClient interface {
	...
	Serve(ctx context.Context, in *ServeRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
}
...
func (c *workerClient) Serve(ctx context.Context, in *ServeRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/worker.Worker/Serve", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkerServer interface {
	...
	Serve(context.Context, *ServeRequest) (*google_protobuf.Empty, error)
}
...
func _Worker_Serve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkerServer).Serve(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/worker.Worker/Serve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServer).Serve(ctx, req.(*ServeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *ServeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ServeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ServeRequest) Size() (n int) {
	var l int
	_ = l
	if len(m.Data) > 0 {
		for _, e := range m.Data {
...
func (m *ServeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorWorkerService = []byte{
	...
	,
}
