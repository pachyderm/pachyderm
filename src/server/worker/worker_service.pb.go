...
func (m *DatumRange) Reset()                    { *m = DatumRange{} }
func (m *DatumRange) String() string            { return proto.CompactTextString(m) }
func (*DatumRange) ProtoMessage()               {}
func (*DatumRange) Descriptor() ([]byte, []int) { return fileDescriptorWorkerService, []int{5} }

func (m *DatumRange) GetLower() int64 {
	if m != nil {
		return m.Lower
	}
	return 0
...
func (m *DatumRange) GetUpper() int64 {
	if m != nil {
		return m.Upper
	}
	return 0
...
type Progress struct {
	CompleteRanges []*DatumRange `protobuf:"bytes,1,rep,name=complete_ranges,json=completeRanges" json:"complete_ranges,omitempty"`
	ActiveRanges   []*DatumRange `protobuf:"bytes,2,rep,name=active_ranges,json=activeRanges" json:"active_ranges,omitempty"`
}

func (m *Progress) Reset()                    { *m = Progress{} }
func (m *Progress) String() string            { return proto.CompactTextString(m) }
func (*Progress) ProtoMessage()               {}
func (*Progress) Descriptor() ([]byte, []int) { return fileDescriptorWorkerService, []int{6} }

func (m *Progress) GetCompleteRanges() []*DatumRange {
	if m != nil {
		return m.CompleteRanges
	}
	return nil
}

func (m *Progress) GetActiveRanges() []*DatumRange {
	if m != nil {
		return m.ActiveRanges
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*DatumRange)(nil), "worker.DatumRange")
	proto.RegisterType((*Progress)(nil), "worker.Progress")
}
...
func (m *DatumRange) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DatumRange) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Lower != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintWorkerService(dAtA, i, uint64(m.Lower))
	}
	if m.Upper != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintWorkerService(dAtA, i, uint64(m.Upper))
	}
	return i, nil
}
...
func (m *Progress) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CompleteRanges) > 0 {
		for _, msg := range m.CompleteRanges {
			dAtA[i] = 0xa
			i++
			i = encodeVarintWorkerService(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.ActiveRanges) > 0 {
		for _, msg := range m.ActiveRanges {
			dAtA[i] = 0x12
			i++
			i = encodeVarintWorkerService(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DatumRange) Size() (n int) {
	var l int
	_ = l
	if m.Lower != 0 {
		n += 1 + sovWorkerService(uint64(m.Lower))
	}
	if m.Upper != 0 {
		n += 1 + sovWorkerService(uint64(m.Upper))
	}
	return n
}
...
func (m *Progress) Size() (n int) {
	...
	_ = l
	if len(m.CompleteRanges) > 0 {
		for _, e := range m.CompleteRanges {
			l = e.Size()
			n += 1 + l + sovWorkerService(uint64(l))
		}
	}
	if len(m.ActiveRanges) > 0 {
		for _, e := range m.ActiveRanges {
			l = e.Size()
			n += 1 + l + sovWorkerService(uint64(l))
		}
	}
...
func (m *DatumRange) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DatumRange: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DatumRange: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Progress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompleteRanges", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompleteRanges = append(m.CompleteRanges, &DatumRange{})
			if err := m.CompleteRanges[len(m.CompleteRanges)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveRanges", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActiveRanges = append(m.ActiveRanges, &DatumRange{})
			if err := m.ActiveRanges[len(m.ActiveRanges)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorWorkerService = []byte{
	...
	,
}
