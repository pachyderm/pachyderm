...
each datum.`,
	...
	restartDatum := &cobra.Command{
		...
		Long:  "Restart a stuck datum during a currently running job; does not solve failed datums. Optionally, you can configure a job to skip failed datums via the err_cmd setting.",
