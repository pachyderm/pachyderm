...
type SubscribeJobInfosRequest struct {
	IncludeInitial bool                     `protobuf:"varint,1,opt,name=include_initial,json=includeInitial" json:"include_initial,omitempty"`
	Shard          *Shard                   `protobuf:"bytes,2,opt,name=shard" json:"shard,omitempty"`
	State          []pachyderm_pps.JobState `protobuf:"varint,3,rep,packed,name=state,enum=pachyderm.pps.JobState" json:"state,omitempty"`
}
...
type JobInfoChange struct {
	JobInfo *PipelineInfo `protobuf:"bytes,1,opt,name=jobInfo" json:"jobInfo,omitempty"`
	Type    ChangeType    `protobuf:"varint,2,opt,name=type,enum=pachyderm.pps.persist.ChangeType" json:"type,omitempty"`
}
...
func (m *JobInfoChange) GetJobInfo() *PipelineInfo {
	if m != nil {
		return m.JobInfo
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
