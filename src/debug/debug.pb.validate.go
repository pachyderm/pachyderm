...
// Validate checks the field values on DumpV2Request_Starlark with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *DumpV2Request_Starlark) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DumpV2Request_Starlark with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// DumpV2Request_StarlarkMultiError, or nil if none found.
func (m *DumpV2Request_Starlark) ValidateAll() error {
	return m.validate(true)
}

func (m *DumpV2Request_Starlark) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, DumpV2Request_StarlarkValidationError{
					field:  "Timeout",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return DumpV2Request_StarlarkValidationError{
				field:  "Timeout",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return DumpV2Request_StarlarkMultiError(errors)
	}

	return nil
}

// DumpV2Request_StarlarkMultiError is an error wrapping multiple validation
// errors returned by DumpV2Request_Starlark.ValidateAll() if the designated
// constraints aren't met.
type DumpV2Request_StarlarkMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DumpV2Request_StarlarkMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DumpV2Request_StarlarkMultiError) AllErrors() []error { return m }

// DumpV2Request_StarlarkValidationError is the validation error returned by
// DumpV2Request_Starlark.Validate if the designated constraints aren't met.
type DumpV2Request_StarlarkValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DumpV2Request_StarlarkValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DumpV2Request_StarlarkValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DumpV2Request_StarlarkValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DumpV2Request_StarlarkValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DumpV2Request_StarlarkValidationError) ErrorName() string {
	return "DumpV2Request_StarlarkValidationError"
}

// Error satisfies the builtin error interface
func (e DumpV2Request_StarlarkValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sDumpV2Request_Starlark.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = DumpV2Request_StarlarkValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = DumpV2Request_StarlarkValidationError{}
