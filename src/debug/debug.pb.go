...
func (x *TraceChunk) GetText() string {
	if x, ok := x.GetReply().(*TraceChunk_Text); ok {
		return x.Text
	}
	return ""
}
...
type TraceChunk_Text struct {
	Text string `protobuf:"bytes,1,opt,name=text,proto3,oneof"`
}

type TraceChunk_Bytes struct {
	Bytes *wrapperspb.BytesValue `protobuf:"bytes,2,opt,name=bytes,proto3,oneof"`
}

func (*TraceChunk_Text) isTraceChunk_Reply() {}
...
var file_debug_debug_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x60, 0x0a, 0x0a, 0x54, 0x72,
	0x61, 0x63, 0x65, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x14, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x12, 0x33,
	0x0a, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x42, 0x79, 0x74, 0x65, 0x73, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x48, 0x00, 0x52, 0x05, 0x62, 0x79,
	0x74, 0x65, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xa2, 0x05, 0x0a,
