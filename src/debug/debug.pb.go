...
type SetLogLevelRequest struct {
	Level                SetLogLevelRequest_LogLevel `protobuf:"varint,1,opt,name=level,proto3,enum=debug_v2.SetLogLevelRequest_LogLevel" json:"level,omitempty"`
	Duration             *types.Duration             `protobuf:"bytes,2,opt,name=duration,proto3" json:"duration,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
...
func (m *SetLogLevelRequest) GetLevel() SetLogLevelRequest_LogLevel {
	if m != nil {
		return m.Level
	}
...
var fileDescriptor_5ae24eab94cb53d5 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Level |= SetLogLevelRequest_LogLevel(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
