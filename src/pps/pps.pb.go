...
type Egress_Obj struct {
	Obj *pfs.ObjectStorageEgressOptions `protobuf:"bytes,2,opt,name=obj,proto3,oneof" json:"obj,omitempty"`
}
type Egress_Sql struct {
	Sql *pfs.SQLEgressOptions `protobuf:"bytes,3,opt,name=sql,proto3,oneof" json:"sql,omitempty"`
}

func (*Egress_Obj) isEgress_Target() {}
func (*Egress_Sql) isEgress_Target() {}
...
func (m *Egress) GetObj() *pfs.ObjectStorageEgressOptions {
	if x, ok := m.GetTarget().(*Egress_Obj); ok {
		return x.Obj
	}
	return nil
}

func (m *Egress) GetSql() *pfs.SQLEgressOptions {
	if x, ok := m.GetTarget().(*Egress_Sql); ok {
		return x.Sql
	}
	return nil
}
...
var fileDescriptor_beade573c128ccc7 = []byte{
	...
	,
}
...
func (m *Egress_Obj) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Egress_Obj) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Obj != nil {
		{
...
func (m *Egress_Sql) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Egress_Sql) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Sql != nil {
		{
...
func (m *Egress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &pfs.ObjectStorageEgressOptions{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Target = &Egress_Obj{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			v := &pfs.SQLEgressOptions{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Target = &Egress_Sql{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
