...
func (m *ListDatumRequest) GetFilter() *Filter {
	if m != nil {
		return m.Filter
	}
	return nil
...
// Filter is used to filter a set of results.
type Filter struct {
	// Types that are valid to be assigned to Filter:
	//	*Filter_NotFilter
	//	*Filter_AndFilter
	//	*Filter_OrFilter
	//	*Filter_DatumStateFilter
...
type Filter_NotFilter struct {
	NotFilter *NotFilter `protobuf:"bytes,1,opt,name=notFilter,proto3,oneof" json:"notFilter,omitempty"`
}
type Filter_AndFilter struct {
	AndFilter *AndFilter `protobuf:"bytes,2,opt,name=andFilter,proto3,oneof" json:"andFilter,omitempty"`
}
type Filter_OrFilter struct {
	OrFilter *OrFilter `protobuf:"bytes,3,opt,name=orFilter,proto3,oneof" json:"orFilter,omitempty"`
}
type Filter_DatumStateFilter struct {
	DatumStateFilter *DatumStateFilter `protobuf:"bytes,4,opt,name=datumStateFilter,proto3,oneof" json:"datumStateFilter,omitempty"`
}

func (*Filter_NotFilter) isFilter_Filter()        {}
func (*Filter_AndFilter) isFilter_Filter()        {}
func (*Filter_OrFilter) isFilter_Filter()         {}
func (*Filter_DatumStateFilter) isFilter_Filter() {}
...
func (m *Filter) GetNotFilter() *NotFilter {
	if x, ok := m.GetFilter().(*Filter_NotFilter); ok {
		return x.NotFilter
	}
	return nil
}

func (m *Filter) GetAndFilter() *AndFilter {
	if x, ok := m.GetFilter().(*Filter_AndFilter); ok {
		return x.AndFilter
	}
	return nil
}

func (m *Filter) GetOrFilter() *OrFilter {
	if x, ok := m.GetFilter().(*Filter_OrFilter); ok {
		return x.OrFilter
	}
	return nil
}

func (m *Filter) GetDatumStateFilter() *DatumStateFilter {
	if x, ok := m.GetFilter().(*Filter_DatumStateFilter); ok {
		return x.DatumStateFilter
	}
	return nil
}
...
func (*Filter) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Filter_OrFilter)(nil),
		(*Filter_DatumStateFilter)(nil),
	}
}

type NotFilter struct {
	Operand              *Filter  `protobuf:"bytes,1,opt,name=operand,proto3" json:"operand,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *NotFilter) GetOperand() *Filter {
	if m != nil {
		return m.Operand
	}
	return nil
...
type AndFilter struct {
	Operands             []*Filter `protobuf:"bytes,1,rep,name=operands,proto3" json:"operands,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *AndFilter) GetOperands() []*Filter {
	if m != nil {
		return m.Operands
	}
	return nil
...
func (m *OrFilter) GetOperands() []*Filter {
	if m != nil {
		return m.Operands
	}
	return nil
...
type DatumStateFilter struct {
	Value                DatumState `protobuf:"varint,1,opt,name=value,proto3,enum=pps_v2.DatumState" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}

func (m *DatumStateFilter) Reset()         { *m = DatumStateFilter{} }
func (m *DatumStateFilter) String() string { return proto.CompactTextString(m) }
func (*DatumStateFilter) ProtoMessage()    {}
func (*DatumStateFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_beade573c128ccc7, []int{69}
}
func (m *DatumStateFilter) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DatumStateFilter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DatumStateFilter.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DatumStateFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DatumStateFilter.Merge(m, src)
}
func (m *DatumStateFilter) XXX_Size() int {
	return m.Size()
}
func (m *DatumStateFilter) XXX_DiscardUnknown() {
	xxx_messageInfo_DatumStateFilter.DiscardUnknown(m)
}

var xxx_messageInfo_DatumStateFilter proto.InternalMessageInfo

func (m *DatumStateFilter) GetValue() DatumState {
	if m != nil {
		return m.Value
	}
	return DatumState_UNKNOWN
...
func init() {
	...
	proto.RegisterType((*Filter)(nil), "pps_v2.Filter")
	proto.RegisterType((*NotFilter)(nil), "pps_v2.NotFilter")
	proto.RegisterType((*AndFilter)(nil), "pps_v2.AndFilter")
	proto.RegisterType((*OrFilter)(nil), "pps_v2.OrFilter")
	proto.RegisterType((*DatumStateFilter)(nil), "pps_v2.DatumStateFilter")
}
...
var fileDescriptor_beade573c128ccc7 = []byte{
	...
	,
}
...
func (m *Filter_NotFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Filter_NotFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NotFilter != nil {
		{
			size, err := m.NotFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Filter_AndFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Filter_AndFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AndFilter != nil {
		{
...
func (m *Filter_OrFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Filter_OrFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.OrFilter != nil {
		{
...
func (m *Filter_DatumStateFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Filter_DatumStateFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DatumStateFilter != nil {
		{
			size, err := m.DatumStateFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AndFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Operands) > 0 {
		for iNdEx := len(m.Operands) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Operands[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DatumStateFilter) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DatumStateFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DatumStateFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Value != 0 {
		i = encodeVarintPps(dAtA, i, uint64(m.Value))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Filter_NotFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Filter_AndFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Filter_OrFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Filter_DatumStateFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DatumStateFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Filter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotFilter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			...
			m.Filter = &Filter_OrFilter{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DatumStateFilter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Filter = &Filter_DatumStateFilter{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
...
func (m *AndFilter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Operands = append(m.Operands, &Filter{})
...
func (m *DatumStateFilter) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DatumStateFilter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DatumStateFilter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Value |= DatumState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
