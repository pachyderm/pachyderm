...
var file_pps_pps_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x42, 0x08, 0xfa,
	0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x08, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e,
	0x65, 0x22, 0x66, 0x0a, 0x12, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0x74, 0x0a, 0x13, 0x43, 0x68, 0x65,
	...
	0x63, 0x74, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70,
	...
	0x22, 0xd1, 0x01, 0x0a, 0x19, 0x53, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x44,
	0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29,
	...
	0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x67,
	...
	0x4a, 0x73, 0x6f, 0x6e, 0x22, 0x5d, 0x0a, 0x1a, 0x53, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x0a, 0x4e, 0x4f, 0x5f, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x45, 0x10, 0x03, 0x32, 0xe7, 0x15,
...
var file_pps_pps_proto_depIdxs = []int32{
	...
	72,  // 119: pps_v2.DeleteSecretRequest.secret:type_name -> pps_v2.Secret
	72,  // 120: pps_v2.InspectSecretRequest.secret:type_name -> pps_v2.Secret
	72,  // 121: pps_v2.SecretInfo.secret:type_name -> pps_v2.Secret
	105, // 122: pps_v2.SecretInfo.creation_timestamp:type_name -> google.protobuf.Timestamp
	73,  // 123: pps_v2.SecretInfos.secret_info:type_name -> pps_v2.SecretInfo
	101, // 124: pps_v2.RenderTemplateRequest.args:type_name -> pps_v2.RenderTemplateRequest.ArgsEntry
	55,  // 125: pps_v2.RenderTemplateResponse.specs:type_name -> pps_v2.CreatePipelineRequest
	109, // 126: pps_v2.LokiRequest.since:type_name -> google.protobuf.Duration
	55,  // 127: pps_v2.ClusterDefaults.create_pipeline_request:type_name -> pps_v2.CreatePipelineRequest
	34,  // 128: pps_v2.SetClusterDefaultsResponse.affected_pipelines:type_name -> pps_v2.Pipeline
	55,  // 129: pps_v2.CreatePipelineTransaction.create_pipeline_request:type_name -> pps_v2.CreatePipelineRequest
	55,  // 130: pps_v2.ProjectDefaults.create_pipeline_request:type_name -> pps_v2.CreatePipelineRequest
	110, // 131: pps_v2.GetProjectDefaultsRequest.project:type_name -> pfs_v2.Project
	110, // 132: pps_v2.SetProjectDefaultsRequest.project:type_name -> pfs_v2.Project
	34,  // 133: pps_v2.SetProjectDefaultsResponse.affected_pipelines:type_name -> pps_v2.Pipeline
	8,   // 134: pps_v2.JobInfo.Details.transform:type_name -> pps_v2.Transform
	20,  // 135: pps_v2.JobInfo.Details.parallelism_spec:type_name -> pps_v2.ParallelismSpec
	10,  // 136: pps_v2.JobInfo.Details.egress:type_name -> pps_v2.Egress
	14,  // 137: pps_v2.JobInfo.Details.service:type_name -> pps_v2.Service
	15,  // 138: pps_v2.JobInfo.Details.spout:type_name -> pps_v2.Spout
	27,  // 139: pps_v2.JobInfo.Details.worker_status:type_name -> pps_v2.WorkerStatus
	29,  // 140: pps_v2.JobInfo.Details.resource_requests:type_name -> pps_v2.ResourceSpec
	29,  // 141: pps_v2.JobInfo.Details.resource_limits:type_name -> pps_v2.ResourceSpec
	29,  // 142: pps_v2.JobInfo.Details.sidecar_resource_limits:type_name -> pps_v2.ResourceSpec
	18,  // 143: pps_v2.JobInfo.Details.input:type_name -> pps_v2.Input
	52,  // 144: pps_v2.JobInfo.Details.datum_set_spec:type_name -> pps_v2.DatumSetSpec
	109, // 145: pps_v2.JobInfo.Details.datum_timeout:type_name -> google.protobuf.Duration
	109, // 146: pps_v2.JobInfo.Details.job_timeout:type_name -> google.protobuf.Duration
	53,  // 147: pps_v2.JobInfo.Details.scheduling_spec:type_name -> pps_v2.SchedulingSpec
	29,  // 148: pps_v2.JobInfo.Details.sidecar_resource_requests:type_name -> pps_v2.ResourceSpec
	8,   // 149: pps_v2.PipelineInfo.Details.transform:type_name -> pps_v2.Transform
	9,   // 150: pps_v2.PipelineInfo.Details.tf_job:type_name -> pps_v2.TFJob
	20,  // 151: pps_v2.PipelineInfo.Details.parallelism_spec:type_name -> pps_v2.ParallelismSpec
	10,  // 152: pps_v2.PipelineInfo.Details.egress:type_name -> pps_v2.Egress
	105, // 153: pps_v2.PipelineInfo.Details.created_at:type_name -> google.protobuf.Timestamp
	29,  // 154: pps_v2.PipelineInfo.Details.resource_requests:type_name -> pps_v2.ResourceSpec
	29,  // 155: pps_v2.PipelineInfo.Details.resource_limits:type_name -> pps_v2.ResourceSpec
	29,  // 156: pps_v2.PipelineInfo.Details.sidecar_resource_limits:type_name -> pps_v2.ResourceSpec
	18,  // 157: pps_v2.PipelineInfo.Details.input:type_name -> pps_v2.Input
	14,  // 158: pps_v2.PipelineInfo.Details.service:type_name -> pps_v2.Service
	15,  // 159: pps_v2.PipelineInfo.Details.spout:type_name -> pps_v2.Spout
	52,  // 160: pps_v2.PipelineInfo.Details.datum_set_spec:type_name -> pps_v2.DatumSetSpec
	109, // 161: pps_v2.PipelineInfo.Details.datum_timeout:type_name -> google.protobuf.Duration
	109, // 162: pps_v2.PipelineInfo.Details.job_timeout:type_name -> google.protobuf.Duration
	53,  // 163: pps_v2.PipelineInfo.Details.scheduling_spec:type_name -> pps_v2.SchedulingSpec
	13,  // 164: pps_v2.PipelineInfo.Details.metadata:type_name -> pps_v2.Metadata
	35,  // 165: pps_v2.PipelineInfo.Details.tolerations:type_name -> pps_v2.Toleration
	29,  // 166: pps_v2.PipelineInfo.Details.sidecar_resource_requests:type_name -> pps_v2.ResourceSpec
	11,  // 167: pps_v2.PipelineInfo.Details.determined:type_name -> pps_v2.Determined
	109, // 168: pps_v2.PipelineInfo.Details.maximum_expected_uptime:type_name -> google.protobuf.Duration
	105, // 169: pps_v2.PipelineInfo.Details.workers_started_at:type_name -> google.protobuf.Timestamp
	1,   // 170: pps_v2.ListDatumRequest.Filter.state:type_name -> pps_v2.DatumState
	41,  // 171: pps_v2.API.InspectJob:input_type -> pps_v2.InspectJobRequest
	39,  // 172: pps_v2.API.InspectJobSet:input_type -> pps_v2.InspectJobSetRequest
	42,  // 173: pps_v2.API.ListJob:input_type -> pps_v2.ListJobRequest
	40,  // 174: pps_v2.API.ListJobSet:input_type -> pps_v2.ListJobSetRequest
	43,  // 175: pps_v2.API.SubscribeJob:input_type -> pps_v2.SubscribeJobRequest
	44,  // 176: pps_v2.API.DeleteJob:input_type -> pps_v2.DeleteJobRequest
	45,  // 177: pps_v2.API.StopJob:input_type -> pps_v2.StopJobRequest
	50,  // 178: pps_v2.API.InspectDatum:input_type -> pps_v2.InspectDatumRequest
	51,  // 179: pps_v2.API.ListDatum:input_type -> pps_v2.ListDatumRequest
	49,  // 180: pps_v2.API.RestartDatum:input_type -> pps_v2.RestartDatumRequest
	54,  // 181: pps_v2.API.RerunPipeline:input_type -> pps_v2.RerunPipelineRequest
	55,  // 182: pps_v2.API.CreatePipeline:input_type -> pps_v2.CreatePipelineRequest
	56,  // 183: pps_v2.API.CreatePipelineV2:input_type -> pps_v2.CreatePipelineV2Request
	58,  // 184: pps_v2.API.InspectPipeline:input_type -> pps_v2.InspectPipelineRequest
	59,  // 185: pps_v2.API.ListPipeline:input_type -> pps_v2.ListPipelineRequest
	60,  // 186: pps_v2.API.DeletePipeline:input_type -> pps_v2.DeletePipelineRequest
	61,  // 187: pps_v2.API.DeletePipelines:input_type -> pps_v2.DeletePipelinesRequest
	63,  // 188: pps_v2.API.StartPipeline:input_type -> pps_v2.StartPipelineRequest
	64,  // 189: pps_v2.API.StopPipeline:input_type -> pps_v2.StopPipelineRequest
	65,  // 190: pps_v2.API.RunPipeline:input_type -> pps_v2.RunPipelineRequest
	66,  // 191: pps_v2.API.RunCron:input_type -> pps_v2.RunCronRequest
	67,  // 192: pps_v2.API.CheckStatus:input_type -> pps_v2.CheckStatusRequest
	69,  // 193: pps_v2.API.CreateSecret:input_type -> pps_v2.CreateSecretRequest
	70,  // 194: pps_v2.API.DeleteSecret:input_type -> pps_v2.DeleteSecretRequest
	113, // 195: pps_v2.API.ListSecret:input_type -> google.protobuf.Empty
	71,  // 196: pps_v2.API.InspectSecret:input_type -> pps_v2.InspectSecretRequest
	113, // 197: pps_v2.API.DeleteAll:input_type -> google.protobuf.Empty
	47,  // 198: pps_v2.API.GetLogs:input_type -> pps_v2.GetLogsRequest
	75,  // 199: pps_v2.API.ActivateAuth:input_type -> pps_v2.ActivateAuthRequest
	46,  // 200: pps_v2.API.UpdateJobState:input_type -> pps_v2.UpdateJobStateRequest
	77,  // 201: pps_v2.API.RunLoadTest:input_type -> pps_v2.RunLoadTestRequest
	113, // 202: pps_v2.API.RunLoadTestDefault:input_type -> google.protobuf.Empty
	79,  // 203: pps_v2.API.RenderTemplate:input_type -> pps_v2.RenderTemplateRequest
	114, // 204: pps_v2.API.ListTask:input_type -> taskapi.ListTaskRequest
	81,  // 205: pps_v2.API.GetKubeEvents:input_type -> pps_v2.LokiRequest
	81,  // 206: pps_v2.API.QueryLoki:input_type -> pps_v2.LokiRequest
	84,  // 207: pps_v2.API.GetClusterDefaults:input_type -> pps_v2.GetClusterDefaultsRequest
	86,  // 208: pps_v2.API.SetClusterDefaults:input_type -> pps_v2.SetClusterDefaultsRequest
	90,  // 209: pps_v2.API.GetProjectDefaults:input_type -> pps_v2.GetProjectDefaultsRequest
	32,  // 210: pps_v2.API.InspectJob:output_type -> pps_v2.JobInfo
	32,  // 211: pps_v2.API.InspectJobSet:output_type -> pps_v2.JobInfo
	32,  // 212: pps_v2.API.ListJob:output_type -> pps_v2.JobInfo
	31,  // 213: pps_v2.API.ListJobSet:output_type -> pps_v2.JobSetInfo
	32,  // 214: pps_v2.API.SubscribeJob:output_type -> pps_v2.JobInfo
	113, // 215: pps_v2.API.DeleteJob:output_type -> google.protobuf.Empty
	113, // 216: pps_v2.API.StopJob:output_type -> google.protobuf.Empty
	23,  // 217: pps_v2.API.InspectDatum:output_type -> pps_v2.DatumInfo
	23,  // 218: pps_v2.API.ListDatum:output_type -> pps_v2.DatumInfo
	113, // 219: pps_v2.API.RestartDatum:output_type -> google.protobuf.Empty
	113, // 220: pps_v2.API.RerunPipeline:output_type -> google.protobuf.Empty
	113, // 221: pps_v2.API.CreatePipeline:output_type -> google.protobuf.Empty
	57,  // 222: pps_v2.API.CreatePipelineV2:output_type -> pps_v2.CreatePipelineV2Response
	36,  // 223: pps_v2.API.InspectPipeline:output_type -> pps_v2.PipelineInfo
	36,  // 224: pps_v2.API.ListPipeline:output_type -> pps_v2.PipelineInfo
	113, // 225: pps_v2.API.DeletePipeline:output_type -> google.protobuf.Empty
	62,  // 226: pps_v2.API.DeletePipelines:output_type -> pps_v2.DeletePipelinesResponse
	113, // 227: pps_v2.API.StartPipeline:output_type -> google.protobuf.Empty
	113, // 228: pps_v2.API.StopPipeline:output_type -> google.protobuf.Empty
	113, // 229: pps_v2.API.RunPipeline:output_type -> google.protobuf.Empty
	113, // 230: pps_v2.API.RunCron:output_type -> google.protobuf.Empty
	68,  // 231: pps_v2.API.CheckStatus:output_type -> pps_v2.CheckStatusResponse
	113, // 232: pps_v2.API.CreateSecret:output_type -> google.protobuf.Empty
	113, // 233: pps_v2.API.DeleteSecret:output_type -> google.protobuf.Empty
	74,  // 234: pps_v2.API.ListSecret:output_type -> pps_v2.SecretInfos
	73,  // 235: pps_v2.API.InspectSecret:output_type -> pps_v2.SecretInfo
	113, // 236: pps_v2.API.DeleteAll:output_type -> google.protobuf.Empty
	48,  // 237: pps_v2.API.GetLogs:output_type -> pps_v2.LogMessage
	76,  // 238: pps_v2.API.ActivateAuth:output_type -> pps_v2.ActivateAuthResponse
	113, // 239: pps_v2.API.UpdateJobState:output_type -> google.protobuf.Empty
	78,  // 240: pps_v2.API.RunLoadTest:output_type -> pps_v2.RunLoadTestResponse
	78,  // 241: pps_v2.API.RunLoadTestDefault:output_type -> pps_v2.RunLoadTestResponse
	80,  // 242: pps_v2.API.RenderTemplate:output_type -> pps_v2.RenderTemplateResponse
	115, // 243: pps_v2.API.ListTask:output_type -> taskapi.TaskInfo
	82,  // 244: pps_v2.API.GetKubeEvents:output_type -> pps_v2.LokiLogMessage
	82,  // 245: pps_v2.API.QueryLoki:output_type -> pps_v2.LokiLogMessage
	85,  // 246: pps_v2.API.GetClusterDefaults:output_type -> pps_v2.GetClusterDefaultsResponse
	87,  // 247: pps_v2.API.SetClusterDefaults:output_type -> pps_v2.SetClusterDefaultsResponse
	91,  // 248: pps_v2.API.GetProjectDefaults:output_type -> pps_v2.GetProjectDefaultsResponse
