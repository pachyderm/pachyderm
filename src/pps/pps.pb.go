...
var file_pps_pps_proto_msgTypes = make([]protoimpl.MessageInfo, 102)
var file_pps_pps_proto_goTypes = []interface{}{
	...
	nil,                                // 109: pps_v2.RenderTemplateRequest.ArgsEntry
	(*pfs.ObjectStorageEgress)(nil),    // 110: pfs_v2.ObjectStorageEgress
	(*pfs.SQLDatabaseEgress)(nil),      // 111: pfs_v2.SQLDatabaseEgress
	(*pfs.Trigger)(nil),                // 112: pfs_v2.Trigger
	(*timestamppb.Timestamp)(nil),      // 113: google.protobuf.Timestamp
	(*pfs.Commit)(nil),                 // 114: pfs_v2.Commit
	(*pfs.File)(nil),                   // 115: pfs_v2.File
	(*pfs.FileInfo)(nil),               // 116: pfs_v2.FileInfo
	(*durationpb.Duration)(nil),        // 117: google.protobuf.Duration
	(*pfs.Project)(nil),                // 118: pfs_v2.Project
	(*wrapperspb.Int64Value)(nil),      // 119: google.protobuf.Int64Value
	(*pfs.CommitSet)(nil),              // 120: pfs_v2.CommitSet
...
var file_pps_pps_proto_depIdxs = []int32{
	...
	110, // 2: pps_v2.Egress.object_storage:type_name -> pfs_v2.ObjectStorageEgress
	111, // 3: pps_v2.Egress.sql_database:type_name -> pfs_v2.SQLDatabaseEgress
	...
	112, // 8: pps_v2.PFSInput.trigger:type_name -> pfs_v2.Trigger
	113, // 9: pps_v2.CronInput.start:type_name -> google.protobuf.Timestamp
	...
	114, // 16: pps_v2.JobInput.commit:type_name -> pfs_v2.Commit
	...
	115, // 21: pps_v2.DatumInfo.pfs_state:type_name -> pfs_v2.File
	116, // 22: pps_v2.DatumInfo.data:type_name -> pfs_v2.FileInfo
	117, // 23: pps_v2.ProcessStats.download_time:type_name -> google.protobuf.Duration
	117, // 24: pps_v2.ProcessStats.process_time:type_name -> google.protobuf.Duration
	117, // 25: pps_v2.ProcessStats.upload_time:type_name -> google.protobuf.Duration
	...
	113, // 32: pps_v2.DatumStatus.started:type_name -> google.protobuf.Timestamp
	...
	114, // 38: pps_v2.JobInfo.output_commit:type_name -> pfs_v2.Commit
	26,  // 39: pps_v2.JobInfo.stats:type_name -> pps_v2.ProcessStats
	0,   // 40: pps_v2.JobInfo.state:type_name -> pps_v2.JobState
	113, // 41: pps_v2.JobInfo.created:type_name -> google.protobuf.Timestamp
	113, // 42: pps_v2.JobInfo.started:type_name -> google.protobuf.Timestamp
	113, // 43: pps_v2.JobInfo.finished:type_name -> google.protobuf.Timestamp
	105, // 44: pps_v2.JobInfo.details:type_name -> pps_v2.JobInfo.Details
	2,   // 45: pps_v2.Worker.state:type_name -> pps_v2.WorkerState
	118, // 46: pps_v2.Pipeline.project:type_name -> pfs_v2.Project
	...
	119, // 49: pps_v2.Toleration.toleration_seconds:type_name -> google.protobuf.Int64Value
	35,  // 50: pps_v2.PipelineInfo.pipeline:type_name -> pps_v2.Pipeline
	114, // 51: pps_v2.PipelineInfo.spec_commit:type_name -> pfs_v2.Commit
	...
	118, // 58: pps_v2.ListJobSetRequest.projects:type_name -> pfs_v2.Project
	113, // 59: pps_v2.ListJobSetRequest.paginationMarker:type_name -> google.protobuf.Timestamp
	13,  // 60: pps_v2.InspectJobRequest.job:type_name -> pps_v2.Job
	118, // 61: pps_v2.ListJobRequest.projects:type_name -> pfs_v2.Project
	35,  // 62: pps_v2.ListJobRequest.pipeline:type_name -> pps_v2.Pipeline
	114, // 63: pps_v2.ListJobRequest.input_commit:type_name -> pfs_v2.Commit
	113, // 64: pps_v2.ListJobRequest.paginationMarker:type_name -> google.protobuf.Timestamp
	...
	117, // 74: pps_v2.GetLogsRequest.since:type_name -> google.protobuf.Duration
	22,  // 75: pps_v2.LogMessage.data:type_name -> pps_v2.InputFile
	113, // 76: pps_v2.LogMessage.ts:type_name -> google.protobuf.Timestamp
	...
	117, // 99: pps_v2.CreatePipelineRequest.datum_timeout:type_name -> google.protobuf.Duration
	117, // 100: pps_v2.CreatePipelineRequest.job_timeout:type_name -> google.protobuf.Duration
	57,  // 101: pps_v2.CreatePipelineRequest.scheduling_spec:type_name -> pps_v2.SchedulingSpec
	114, // 102: pps_v2.CreatePipelineRequest.spec_commit:type_name -> pfs_v2.Commit
	...
	117, // 107: pps_v2.CreatePipelineRequest.maximum_expected_uptime:type_name -> google.protobuf.Duration
	...
	120, // 110: pps_v2.ListPipelineRequest.commit_set:type_name -> pfs_v2.CommitSet
	118, // 111: pps_v2.ListPipelineRequest.projects:type_name -> pfs_v2.Project
	...
	118, // 115: pps_v2.DeletePipelinesRequest.projects:type_name -> pfs_v2.Project
	...
	114, // 120: pps_v2.RunPipelineRequest.provenance:type_name -> pfs_v2.Commit
	35,  // 121: pps_v2.RunCronRequest.pipeline:type_name -> pps_v2.Pipeline
	118, // 122: pps_v2.CheckStatusRequest.project:type_name -> pfs_v2.Project
	118, // 123: pps_v2.CheckStatusResponse.project:type_name -> pfs_v2.Project
	...
	113, // 128: pps_v2.SecretInfo.creation_timestamp:type_name -> google.protobuf.Timestamp
	78,  // 129: pps_v2.SecretInfos.secret_info:type_name -> pps_v2.SecretInfo
	109, // 130: pps_v2.RenderTemplateRequest.args:type_name -> pps_v2.RenderTemplateRequest.ArgsEntry
	59,  // 131: pps_v2.RenderTemplateResponse.specs:type_name -> pps_v2.CreatePipelineRequest
	117, // 132: pps_v2.LokiRequest.since:type_name -> google.protobuf.Duration
	...
	118, // 137: pps_v2.GetProjectDefaultsRequest.project:type_name -> pfs_v2.Project
	118, // 138: pps_v2.SetProjectDefaultsRequest.project:type_name -> pfs_v2.Project
	...
	118, // 142: pps_v2.PipelinesSummary.project:type_name -> pfs_v2.Project
	...
	117, // 154: pps_v2.JobInfo.Details.datum_timeout:type_name -> google.protobuf.Duration
	117, // 155: pps_v2.JobInfo.Details.job_timeout:type_name -> google.protobuf.Duration
	...
	113, // 162: pps_v2.PipelineInfo.Details.created_at:type_name -> google.protobuf.Timestamp
	...
	117, // 170: pps_v2.PipelineInfo.Details.datum_timeout:type_name -> google.protobuf.Duration
	117, // 171: pps_v2.PipelineInfo.Details.job_timeout:type_name -> google.protobuf.Duration
	...
	117, // 177: pps_v2.PipelineInfo.Details.maximum_expected_uptime:type_name -> google.protobuf.Duration
	113, // 178: pps_v2.PipelineInfo.Details.workers_started_at:type_name -> google.protobuf.Timestamp
