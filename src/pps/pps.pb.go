...
type PipelineInfo_Details struct {
	...
	// k8s_name_version determines how Kubernetes objects
	// (e.g. ReplicationControllers and Services) associated with this pipeline
	// are named.  If it is set to "v2.4" then objects will be named
	// "pipeline-$NAME-v$version"; this can conflict with other objects in
	// different projects with the same name.  If it is set to "v2.5" then
	// objects will be named "pipeline-$UNIQUENAME-v$version", where $UNIQUENAME
	// ends with RawURLBase64(SHA1("$PROJECT/$NAME")) and begins with as many
	// characters of the project and pipeline names as will fit.  It is an error
	// to create or update a pipeline with k8s_name_version set to "v2.4" when
	// another pipeline exists with "v2.4" and the same name.
	K8SNameVersion       string   `protobuf:"bytes,35,opt,name=k8s_name_version,json=k8sNameVersion,proto3" json:"k8s_name_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *PipelineInfo_Details) GetK8SNameVersion() string {
	if m != nil {
		return m.K8SNameVersion
	}
	return ""
}
...
var fileDescriptor_beade573c128ccc7 = []byte{
	...
	,
	...
	0xf3, 0x74, 0x0a, 0x4d, 0x33, 0x68, 0x0e, 0x7b, 0xde, 0xfa, 0xd0, 0x44, 0x1f, 0x43, 0x1a, 0xdb,
	0x47, 0xf5, 0xcc, 0x9d, 0xf4, 0x83, 0xd2, 0x4a, 0x63, 0x89, 0x9f, 0xc2, 0x52, 0x30, 0xc1, 0x52,
	0xd3, 0x3e, 0x6a, 0xda, 0xbe, 0x77, 0xac, 0x51, 0x32, 0xf4, 0x03, 0xc8, 0x13, 0xb6, 0x53, 0x52,
	0xcf, 0xb2, 0x1e, 0x73, 0xb2, 0x47, 0x84, 0x01, 0x9a, 0xa4, 0x41, 0x1f, 0x03, 0x62, 0x0b, 0xd2,
	...
	,
}
...
func (m *PipelineInfo_Details) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.K8SNameVersion) > 0 {
		i -= len(m.K8SNameVersion)
		copy(dAtA[i:], m.K8SNameVersion)
		i = encodeVarintPps(dAtA, i, uint64(len(m.K8SNameVersion)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x9a
...
func (m *PipelineInfo_Details) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 35:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field K8SNameVersion", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.K8SNameVersion = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
