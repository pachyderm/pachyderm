...
type TailLokiResponse struct {
	// Types that are valid to be assigned to Response:
	//
	//	*TailLokiResponse_Stream
	//	*TailLokiResponse_Warning
	Response             isTailLokiResponse_Response `protobuf_oneof:"response"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *TailLokiResponse) Reset()         { *m = TailLokiResponse{} }
func (m *TailLokiResponse) String() string { return proto.CompactTextString(m) }
func (*TailLokiResponse) ProtoMessage()    {}
func (*TailLokiResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_beade573c128ccc7, []int{70}
}
func (m *TailLokiResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TailLokiResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TailLokiResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TailLokiResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TailLokiResponse.Merge(m, src)
}
func (m *TailLokiResponse) XXX_Size() int {
	return m.Size()
}
func (m *TailLokiResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TailLokiResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TailLokiResponse proto.InternalMessageInfo

type isTailLokiResponse_Response interface {
	isTailLokiResponse_Response()
	MarshalTo([]byte) (int, error)
	Size() int
}

type TailLokiResponse_Stream struct {
	Stream *LokiStream `protobuf:"bytes,1,opt,name=stream,proto3,oneof" json:"stream,omitempty"`
}
type TailLokiResponse_Warning struct {
	Warning string `protobuf:"bytes,2,opt,name=warning,proto3,oneof" json:"warning,omitempty"`
}

func (*TailLokiResponse_Stream) isTailLokiResponse_Response()  {}
func (*TailLokiResponse_Warning) isTailLokiResponse_Response() {}

func (m *TailLokiResponse) GetResponse() isTailLokiResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (m *TailLokiResponse) GetStream() *LokiStream {
	if x, ok := m.GetResponse().(*TailLokiResponse_Stream); ok {
		return x.Stream
	}
	return nil
}

func (m *TailLokiResponse) GetWarning() string {
	if x, ok := m.GetResponse().(*TailLokiResponse_Warning); ok {
		return x.Warning
	}
	return ""
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*TailLokiResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TailLokiResponse_Stream)(nil),
		(*TailLokiResponse_Warning)(nil),
	}
}

// LokiStream is the format that Loki returns logs in.  A stream contains common/value metadata for
// the contained values.
type LokiStream struct {
	Metadata             map[string]string `protobuf:"bytes,1,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Values               []*LokiValue      `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *LokiStream) String() string { return proto.CompactTextString(m) }
func (*LokiStream) ProtoMessage()    {}
func (*LokiStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_beade573c128ccc7, []int{71}
}
func (m *LokiStream) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LokiStream) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LokiStream.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LokiStream) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LokiStream.Merge(m, src)
}
func (m *LokiStream) XXX_Size() int {
	return m.Size()
}
func (m *LokiStream) XXX_DiscardUnknown() {
	xxx_messageInfo_LokiStream.DiscardUnknown(m)
}

var xxx_messageInfo_LokiStream proto.InternalMessageInfo

func (m *LokiStream) GetMetadata() map[string]string {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *LokiStream) GetValues() []*LokiValue {
	if m != nil {
		return m.Values
	}
	return nil
...
// LokiValue is the format that Loki returns logs in.
...
func (m *LokiValue) Reset()         { *m = LokiValue{} }
func (m *LokiValue) String() string { return proto.CompactTextString(m) }
func (*LokiValue) ProtoMessage()    {}
func (*LokiValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_beade573c128ccc7, []int{72}
}
func (m *LokiValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LokiValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LokiValue.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LokiValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LokiValue.Merge(m, src)
}
func (m *LokiValue) XXX_Size() int {
	return m.Size()
}
func (m *LokiValue) XXX_DiscardUnknown() {
	xxx_messageInfo_LokiValue.DiscardUnknown(m)
}

var xxx_messageInfo_LokiValue proto.InternalMessageInfo

func (m *LokiValue) GetTime() *types.Timestamp {
	if m != nil {
		return m.Time
	}
	return nil
...
func (m *LokiValue) GetMessages() [][]byte {
	if m != nil {
		return m.Messages
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TailLokiResponse)(nil), "pps_v2.TailLokiResponse")
	proto.RegisterType((*LokiStream)(nil), "pps_v2.LokiStream")
	proto.RegisterMapType((map[string]string)(nil), "pps_v2.LokiStream.MetadataEntry")
	proto.RegisterType((*LokiValue)(nil), "pps_v2.LokiValue")
}

func init() { proto.RegisterFile("pps/pps.proto", fileDescriptor_beade573c128ccc7) }

var fileDescriptor_beade573c128ccc7 = []byte{
	// 5664 bytes of a gzipped FileDescriptorProto
	,
}
...
type APIClient interface {
	...
	// TailLoki returns an infinite stream of log messages.
	TailLoki(ctx context.Context, in *LokiRequest, opts ...grpc.CallOption) (API_TailLokiClient, error)
}
...
func (c *aPIClient) TailLoki(ctx context.Context, in *LokiRequest, opts ...grpc.CallOption) (API_TailLokiClient, error) {
	stream, err := c.cc.NewStream(ctx, &_API_serviceDesc.Streams[10], "/pps_v2.API/TailLoki", opts...)
	if err != nil {
		return nil, err
	}
	x := &aPITailLokiClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type API_TailLokiClient interface {
	Recv() (*TailLokiResponse, error)
	grpc.ClientStream
}

type aPITailLokiClient struct {
	grpc.ClientStream
}

func (x *aPITailLokiClient) Recv() (*TailLokiResponse, error) {
	m := new(TailLokiResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type APIServer interface {
	...
	// TailLoki returns an infinite stream of log messages.
	TailLoki(*LokiRequest, API_TailLokiServer) error
}
...
func (*UnimplementedAPIServer) TailLoki(req *LokiRequest, srv API_TailLokiServer) error {
	return status.Errorf(codes.Unimplemented, "method TailLoki not implemented")
}
...
func _API_TailLoki_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(LokiRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(APIServer).TailLoki(m, &aPITailLokiServer{stream})
}

type API_TailLokiServer interface {
	Send(*TailLokiResponse) error
	grpc.ServerStream
}

type aPITailLokiServer struct {
	grpc.ServerStream
}

func (x *aPITailLokiServer) Send(m *TailLokiResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func (m *TailLokiResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TailLokiResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TailLokiResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TailLokiResponse_Stream) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TailLokiResponse_Stream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Stream != nil {
		{
...
func (m *TailLokiResponse_Warning) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TailLokiResponse_Warning) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Warning)
	copy(dAtA[i:], m.Warning)
	i = encodeVarintPps(dAtA, i, uint64(len(m.Warning)))
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
func (m *LokiStream) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LokiStream) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LokiStream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LokiValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LokiValue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LokiValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Messages) > 0 {
		for iNdEx := len(m.Messages) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPps(dAtA, i, uint64(len(m.Messages[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *TailLokiResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TailLokiResponse_Stream) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TailLokiResponse_Warning) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TailLokiResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TailLokiResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TailLokiResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Response = &TailLokiResponse_Stream{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Response = &TailLokiResponse_Warning{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPps(dAtA[iNdEx:])
...
func (m *LokiStream) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LokiStream: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LokiStream: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Values = append(m.Values, &LokiValue{})
...
func (m *LokiValue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LokiValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LokiValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
