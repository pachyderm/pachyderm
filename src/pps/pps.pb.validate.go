...
func (m *PFSInput) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetDatumGen()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, PFSInputValidationError{
					field:  "DatumGen",
	...
	} else if v, ok := interface{}(m.GetDatumGen()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return PFSInputValidationError{
				field:  "DatumGen",
				reason: "embedded message failed validation",
...
// Validate checks the field values on DatumGen with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *DatumGen) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DatumGen with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in DatumGenMultiError, or nil
// if none found.
func (m *DatumGen) ValidateAll() error {
	return m.validate(true)
}

func (m *DatumGen) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return DatumGenMultiError(errors)
	}

	return nil
}

// DatumGenMultiError is an error wrapping multiple validation errors returned
// by DatumGen.ValidateAll() if the designated constraints aren't met.
type DatumGenMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DatumGenMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DatumGenMultiError) AllErrors() []error { return m }

// DatumGenValidationError is the validation error returned by
// DatumGen.Validate if the designated constraints aren't met.
type DatumGenValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DatumGenValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DatumGenValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DatumGenValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DatumGenValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DatumGenValidationError) ErrorName() string { return "DatumGenValidationError" }

// Error satisfies the builtin error interface
func (e DatumGenValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = DatumGenValidationError{}
...
// Validate checks the field values on PipelineDatumFilter with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PipelineDatumFilter) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PipelineDatumFilter with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PipelineDatumFilterMultiError, or nil if none found.
func (m *PipelineDatumFilter) ValidateAll() error {
	return m.validate(true)
}

func (m *PipelineDatumFilter) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PipelineDatumFilterMultiError(errors)
	}

	return nil
}

// PipelineDatumFilterMultiError is an error wrapping multiple validation
// errors returned by PipelineDatumFilter.ValidateAll() if the designated
// constraints aren't met.
type PipelineDatumFilterMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PipelineDatumFilterMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PipelineDatumFilterMultiError) AllErrors() []error { return m }

// PipelineDatumFilterValidationError is the validation error returned by
// PipelineDatumFilter.Validate if the designated constraints aren't met.
type PipelineDatumFilterValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PipelineDatumFilterValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PipelineDatumFilterValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PipelineDatumFilterValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PipelineDatumFilterValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PipelineDatumFilterValidationError) ErrorName() string {
	return "PipelineDatumFilterValidationError"
}

// Error satisfies the builtin error interface
func (e PipelineDatumFilterValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPipelineDatumFilter.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PipelineDatumFilterValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PipelineDatumFilterValidationError{}
