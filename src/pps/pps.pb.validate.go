...
// Validate checks the field values on GetLogsV2Request with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *GetLogsV2Request) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetLogsV2Request with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetLogsV2RequestMultiError, or nil if none found.
func (m *GetLogsV2Request) ValidateAll() error {
	return m.validate(true)
}

func (m *GetLogsV2Request) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetLogsV2RequestValidationError{
					field:  "Query",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetLogsV2RequestValidationError{
				field:  "Query",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetLogsV2RequestMultiError(errors)
	}

	return nil
}

// GetLogsV2RequestMultiError is an error wrapping multiple validation errors
// returned by GetLogsV2Request.ValidateAll() if the designated constraints
// aren't met.
type GetLogsV2RequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetLogsV2RequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetLogsV2RequestMultiError) AllErrors() []error { return m }

// GetLogsV2RequestValidationError is the validation error returned by
// GetLogsV2Request.Validate if the designated constraints aren't met.
type GetLogsV2RequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetLogsV2RequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetLogsV2RequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetLogsV2RequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetLogsV2RequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetLogsV2RequestValidationError) ErrorName() string { return "GetLogsV2RequestValidationError" }

// Error satisfies the builtin error interface
func (e GetLogsV2RequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetLogsV2Request.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetLogsV2RequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetLogsV2RequestValidationError{}

// Validate checks the field values on GetLogsV2Response with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *GetLogsV2Response) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetLogsV2Response with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetLogsV2ResponseMultiError, or nil if none found.
func (m *GetLogsV2Response) ValidateAll() error {
	return m.validate(true)
}

func (m *GetLogsV2Response) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	case *GetLogsV2Response_PagingHint:
		if v == nil {
			err := GetLogsV2ResponseValidationError{
				field:  "ResponseType",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetLogsV2ResponseValidationError{
						field:  "PagingHint",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return GetLogsV2ResponseValidationError{
					field:  "PagingHint",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetLogsV2ResponseMultiError(errors)
	}

	return nil
}

// GetLogsV2ResponseMultiError is an error wrapping multiple validation errors
// returned by GetLogsV2Response.ValidateAll() if the designated constraints
// aren't met.
type GetLogsV2ResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetLogsV2ResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetLogsV2ResponseMultiError) AllErrors() []error { return m }

// GetLogsV2ResponseValidationError is the validation error returned by
// GetLogsV2Response.Validate if the designated constraints aren't met.
type GetLogsV2ResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetLogsV2ResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetLogsV2ResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetLogsV2ResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetLogsV2ResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetLogsV2ResponseValidationError) ErrorName() string {
	return "GetLogsV2ResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetLogsV2ResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetLogsV2Response.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetLogsV2ResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetLogsV2ResponseValidationError{}
...
// Validate checks the field values on LogMessageV2 with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *LogMessageV2) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LogMessageV2 with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in LogMessageV2MultiError, or
// nil if none found.
func (m *LogMessageV2) ValidateAll() error {
	return m.validate(true)
}

func (m *LogMessageV2) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	switch v := m.LogV2Type.(type) {
	case *LogMessageV2_Verbatim:
		if v == nil {
			err := LogMessageV2ValidationError{
				field:  "LogV2Type",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, LogMessageV2ValidationError{
						field:  "Verbatim",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return LogMessageV2ValidationError{
					field:  "Verbatim",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	case *LogMessageV2_PpsLogMessage:
		if v == nil {
			err := LogMessageV2ValidationError{
				field:  "LogV2Type",
				reason: "oneof value cannot be a typed-nil",
	...
	if len(errors) > 0 {
		return LogMessageV2MultiError(errors)
	}

	return nil
}

// LogMessageV2MultiError is an error wrapping multiple validation errors
// returned by LogMessageV2.ValidateAll() if the designated constraints aren't met.
type LogMessageV2MultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LogMessageV2MultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LogMessageV2MultiError) AllErrors() []error { return m }

// LogMessageV2ValidationError is the validation error returned by
// LogMessageV2.Validate if the designated constraints aren't met.
type LogMessageV2ValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LogMessageV2ValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LogMessageV2ValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LogMessageV2ValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LogMessageV2ValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LogMessageV2ValidationError) ErrorName() string { return "LogMessageV2ValidationError" }

// Error satisfies the builtin error interface
func (e LogMessageV2ValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = LogMessageV2ValidationError{}
