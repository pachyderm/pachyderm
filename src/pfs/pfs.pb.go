...
type FileSetTransform struct {
	// Types that are valid to be assigned to Value:
	//	*FileSetTransform_FilterPathRegexp
	//	*FileSetTransform_FilterPathGlob
	//	*FileSetTransform_AddPrefix
	Value                isFileSetTransform_Value `protobuf_oneof:"value"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}

func (m *FileSetTransform) Reset()         { *m = FileSetTransform{} }
func (m *FileSetTransform) String() string { return proto.CompactTextString(m) }
func (*FileSetTransform) ProtoMessage()    {}
func (*FileSetTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{58}
}
func (m *FileSetTransform) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FileSetTransform) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FileSetTransform.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FileSetTransform) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileSetTransform.Merge(m, src)
}
func (m *FileSetTransform) XXX_Size() int {
	return m.Size()
}
func (m *FileSetTransform) XXX_DiscardUnknown() {
	xxx_messageInfo_FileSetTransform.DiscardUnknown(m)
}

var xxx_messageInfo_FileSetTransform proto.InternalMessageInfo

type isFileSetTransform_Value interface {
	isFileSetTransform_Value()
	MarshalTo([]byte) (int, error)
	Size() int
}

type FileSetTransform_FilterPathRegexp struct {
	FilterPathRegexp string `protobuf:"bytes,1,opt,name=filter_path_regexp,json=filterPathRegexp,proto3,oneof" json:"filter_path_regexp,omitempty"`
}
type FileSetTransform_FilterPathGlob struct {
	FilterPathGlob string `protobuf:"bytes,2,opt,name=filter_path_glob,json=filterPathGlob,proto3,oneof" json:"filter_path_glob,omitempty"`
}
type FileSetTransform_AddPrefix struct {
	AddPrefix string `protobuf:"bytes,3,opt,name=add_prefix,json=addPrefix,proto3,oneof" json:"add_prefix,omitempty"`
}

func (*FileSetTransform_FilterPathRegexp) isFileSetTransform_Value() {}
func (*FileSetTransform_FilterPathGlob) isFileSetTransform_Value()   {}
func (*FileSetTransform_AddPrefix) isFileSetTransform_Value()        {}

func (m *FileSetTransform) GetValue() isFileSetTransform_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *FileSetTransform) GetFilterPathRegexp() string {
	if x, ok := m.GetValue().(*FileSetTransform_FilterPathRegexp); ok {
		return x.FilterPathRegexp
	}
	return ""
}

func (m *FileSetTransform) GetFilterPathGlob() string {
	if x, ok := m.GetValue().(*FileSetTransform_FilterPathGlob); ok {
		return x.FilterPathGlob
	}
	return ""
}

func (m *FileSetTransform) GetAddPrefix() string {
	if x, ok := m.GetValue().(*FileSetTransform_AddPrefix); ok {
		return x.AddPrefix
	}
	return ""
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*FileSetTransform) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*FileSetTransform_FilterPathRegexp)(nil),
		(*FileSetTransform_FilterPathGlob)(nil),
		(*FileSetTransform_AddPrefix)(nil),
	}
}
...
type ReadFileSetRequest struct {
	...
	IncludeContents      bool                `protobuf:"varint,2,opt,name=include_contents,json=includeContents,proto3" json:"include_contents,omitempty"`
	Transforms           []*FileSetTransform `protobuf:"bytes,3,rep,name=transforms,proto3" json:"transforms,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}

func (m *ReadFileSetRequest) Reset()         { *m = ReadFileSetRequest{} }
func (m *ReadFileSetRequest) String() string { return proto.CompactTextString(m) }
...
func (m *ReadFileSetRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadFileSetRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReadFileSetRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReadFileSetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadFileSetRequest.Merge(m, src)
}
func (m *ReadFileSetRequest) XXX_Size() int {
	return m.Size()
}
func (m *ReadFileSetRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadFileSetRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ReadFileSetRequest proto.InternalMessageInfo

func (m *ReadFileSetRequest) GetFilesetId() string {
	if m != nil {
		return m.FilesetId
	}
	return ""
...
func (m *ReadFileSetRequest) GetIncludeContents() bool {
	if m != nil {
		return m.IncludeContents
	}
	return false
}

func (m *ReadFileSetRequest) GetTransforms() []*FileSetTransform {
	if m != nil {
		return m.Transforms
	}
	return nil
...
func (m *ReadFileSetResponse) Reset()         { *m = ReadFileSetResponse{} }
func (m *ReadFileSetResponse) String() string { return proto.CompactTextString(m) }
...
func (m *ReadFileSetResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadFileSetResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReadFileSetResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReadFileSetResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadFileSetResponse.Merge(m, src)
}
func (m *ReadFileSetResponse) XXX_Size() int {
	return m.Size()
}
func (m *ReadFileSetResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadFileSetResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ReadFileSetResponse proto.InternalMessageInfo

func (m *ReadFileSetResponse) GetPath() string {
	if m != nil {
		return m.Path
	}
	return ""
...
func (m *ReadFileSetResponse) GetOffset() int64 {
	if m != nil {
		return m.Offset
	}
	return 0
...
func (m *ReadFileSetResponse) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FileSetTransform)(nil), "pfs_v2.FileSetTransform")
	proto.RegisterType((*ReadFileSetRequest)(nil), "pfs_v2.ReadFileSetRequest")
	proto.RegisterType((*ReadFileSetResponse)(nil), "pfs_v2.ReadFileSetResponse")
}
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
type APIClient interface {
	...
	ReadFileSet(ctx context.Context, in *ReadFileSetRequest, opts ...grpc.CallOption) (API_ReadFileSetClient, error)
...
func (c *aPIClient) ReadFileSet(ctx context.Context, in *ReadFileSetRequest, opts ...grpc.CallOption) (API_ReadFileSetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_API_serviceDesc.Streams[15], "/pfs_v2.API/ReadFileSet", opts...)
	if err != nil {
		return nil, err
	}
	x := &aPIReadFileSetClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type API_ReadFileSetClient interface {
	Recv() (*ReadFileSetResponse, error)
	grpc.ClientStream
}

type aPIReadFileSetClient struct {
	grpc.ClientStream
}

func (x *aPIReadFileSetClient) Recv() (*ReadFileSetResponse, error) {
...
type APIServer interface {
	...
	ReadFileSet(*ReadFileSetRequest, API_ReadFileSetServer) error
	// RunLoadTest runs a load test.
...
func (*UnimplementedAPIServer) ReadFileSet(req *ReadFileSetRequest, srv API_ReadFileSetServer) error {
...
func _API_ReadFileSet_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ReadFileSetRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(APIServer).ReadFileSet(m, &aPIReadFileSetServer{stream})
}

type API_ReadFileSetServer interface {
	Send(*ReadFileSetResponse) error
	grpc.ServerStream
}

type aPIReadFileSetServer struct {
	grpc.ServerStream
}

func (x *aPIReadFileSetServer) Send(m *ReadFileSetResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _API_ReadFileSet_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "ListTask",
...
func (m *FileSetTransform) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FileSetTransform) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSetTransform) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FileSetTransform_FilterPathRegexp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSetTransform_FilterPathRegexp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.FilterPathRegexp)
	copy(dAtA[i:], m.FilterPathRegexp)
	i = encodeVarintPfs(dAtA, i, uint64(len(m.FilterPathRegexp)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
func (m *FileSetTransform_FilterPathGlob) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSetTransform_FilterPathGlob) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.FilterPathGlob)
	copy(dAtA[i:], m.FilterPathGlob)
	i = encodeVarintPfs(dAtA, i, uint64(len(m.FilterPathGlob)))
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
func (m *FileSetTransform_AddPrefix) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSetTransform_AddPrefix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.AddPrefix)
	copy(dAtA[i:], m.AddPrefix)
	i = encodeVarintPfs(dAtA, i, uint64(len(m.AddPrefix)))
	i--
	dAtA[i] = 0x1a
	return len(dAtA) - i, nil
}
func (m *ReadFileSetRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReadFileSetRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReadFileSetRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReadFileSetResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReadFileSetResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReadFileSetResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FileSetTransform) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FileSetTransform_FilterPathRegexp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.FilterPathRegexp)
	n += 1 + l + sovPfs(uint64(l))
	return n
}
func (m *FileSetTransform_FilterPathGlob) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.FilterPathGlob)
	n += 1 + l + sovPfs(uint64(l))
	return n
}
func (m *FileSetTransform_AddPrefix) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReadFileSetRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReadFileSetResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FileSetTransform) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileSetTransform: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileSetTransform: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilterPathRegexp", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Value = &FileSetTransform_FilterPathRegexp{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilterPathGlob", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Value = &FileSetTransform_FilterPathGlob{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddPrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Value = &FileSetTransform_AddPrefix{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
...
func (m *ReadFileSetRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadFileSetRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadFileSetRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncludeContents", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			...
			m.Transforms = append(m.Transforms, &FileSetTransform{})
...
func (m *ReadFileSetResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadFileSetResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadFileSetResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
