...
func (SQLDatabaseEgress_FileFormat_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{71, 0, 0}
}
...
type CommitInfo_Details struct {
	...
	CommitProvenance     []*Commit       `protobuf:"bytes,4,rep,name=commit_provenance,json=commitProvenance,proto3" json:"commit_provenance,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *CommitInfo_Details) GetCommitProvenance() []*Commit {
	if m != nil {
		return m.CommitProvenance
	}
	return nil
}
...
func (m *ListRepoRequest) GetProjects() []string {
	if m != nil {
		return m.Projects
	}
	return nil
...
type SquashCommitSetsRequest struct {
	CommitSets           []*CommitSet `protobuf:"bytes,1,rep,name=commit_sets,json=commitSets,proto3" json:"commit_sets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}

func (m *SquashCommitSetsRequest) Reset()         { *m = SquashCommitSetsRequest{} }
func (m *SquashCommitSetsRequest) String() string { return proto.CompactTextString(m) }
func (*SquashCommitSetsRequest) ProtoMessage()    {}
func (*SquashCommitSetsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{26}
}
func (m *SquashCommitSetsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SquashCommitSetsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SquashCommitSetsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SquashCommitSetsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SquashCommitSetsRequest.Merge(m, src)
}
func (m *SquashCommitSetsRequest) XXX_Size() int {
	return m.Size()
}
func (m *SquashCommitSetsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SquashCommitSetsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SquashCommitSetsRequest proto.InternalMessageInfo

func (m *SquashCommitSetsRequest) GetCommitSets() []*CommitSet {
	if m != nil {
		return m.CommitSets
	}
	return nil
...
type DropCommitSetsRequest struct {
	CommitSets           []*CommitSet `protobuf:"bytes,1,rep,name=commit_sets,json=commitSets,proto3" json:"commit_sets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
...
func (m *DropCommitSetsRequest) Reset()         { *m = DropCommitSetsRequest{} }
func (m *DropCommitSetsRequest) String() string { return proto.CompactTextString(m) }
func (*DropCommitSetsRequest) ProtoMessage()    {}
func (*DropCommitSetsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{28}
}
func (m *DropCommitSetsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DropCommitSetsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DropCommitSetsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DropCommitSetsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DropCommitSetsRequest.Merge(m, src)
}
func (m *DropCommitSetsRequest) XXX_Size() int {
	return m.Size()
}
func (m *DropCommitSetsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_DropCommitSetsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_DropCommitSetsRequest proto.InternalMessageInfo

func (m *DropCommitSetsRequest) GetCommitSets() []*CommitSet {
	if m != nil {
		return m.CommitSets
	}
	return nil
...
func (*AddFile_URLSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{39, 0}
}
...
func (*SQLDatabaseEgress_FileFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{71, 0}
}
...
func (*SQLDatabaseEgress_Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{71, 1}
}
...
func init() {
	...
	proto.RegisterType((*SquashCommitSetsRequest)(nil), "pfs_v2.SquashCommitSetsRequest")
	proto.RegisterType((*DropCommitSetRequest)(nil), "pfs_v2.DropCommitSetRequest")
	proto.RegisterType((*DropCommitSetsRequest)(nil), "pfs_v2.DropCommitSetsRequest")
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
type APIClient interface {
	...
	// SquashCommitSets squashes the commits of a list of CommitSets into their children.
	SquashCommitSets(ctx context.Context, in *SquashCommitSetsRequest, opts ...grpc.CallOption) (*types.Empty, error)
	...
	// DropCommitSets drops the commits of a list of CommitSet and all data included in the commits.
	DropCommitSets(ctx context.Context, in *DropCommitSetsRequest, opts ...grpc.CallOption) (*types.Empty, error)
...
func (c *aPIClient) SquashCommitSets(ctx context.Context, in *SquashCommitSetsRequest, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/pfs_v2.API/SquashCommitSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) DropCommitSets(ctx context.Context, in *DropCommitSetsRequest, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/pfs_v2.API/DropCommitSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	// SquashCommitSets squashes the commits of a list of CommitSets into their children.
	SquashCommitSets(context.Context, *SquashCommitSetsRequest) (*types.Empty, error)
	// DropCommitSet drops the commits of a CommitSet and all data included in the commits.
	DropCommitSet(context.Context, *DropCommitSetRequest) (*types.Empty, error)
	// DropCommitSets drops the commits of a list of CommitSet and all data included in the commits.
	DropCommitSets(context.Context, *DropCommitSetsRequest) (*types.Empty, error)
	// CreateBranch creates a new branch.
...
func (*UnimplementedAPIServer) SquashCommitSets(ctx context.Context, req *SquashCommitSetsRequest) (*types.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SquashCommitSets not implemented")
}
...
func (*UnimplementedAPIServer) DropCommitSets(ctx context.Context, req *DropCommitSetsRequest) (*types.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DropCommitSets not implemented")
}
...
func _API_SquashCommitSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SquashCommitSetsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).SquashCommitSets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pfs_v2.API/SquashCommitSets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).SquashCommitSets(ctx, req.(*SquashCommitSetsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _API_DropCommitSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DropCommitSetsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).DropCommitSets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pfs_v2.API/DropCommitSets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).DropCommitSets(ctx, req.(*DropCommitSetsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SquashCommitSets",
			Handler:    _API_SquashCommitSets_Handler,
		},
		{
		...
		{
			MethodName: "DropCommitSets",
			Handler:    _API_DropCommitSets_Handler,
		},
		{
...
func (m *CommitInfo_Details) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CommitProvenance) > 0 {
		for iNdEx := len(m.CommitProvenance) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CommitProvenance[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ListRepoRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Projects) > 0 {
		for iNdEx := len(m.Projects) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPfs(dAtA, i, uint64(len(m.Projects[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *SquashCommitSetsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SquashCommitSetsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SquashCommitSetsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.CommitSets) > 0 {
		for iNdEx := len(m.CommitSets) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CommitSets[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DropCommitSetsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DropCommitSetsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DropCommitSetsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CommitInfo_Details) Size() (n int) {
	...
	if len(m.CommitProvenance) > 0 {
		for _, e := range m.CommitProvenance {
			l = e.Size()
			n += 1 + l + sovPfs(uint64(l))
		}
	}
...
func (m *SquashCommitSetsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DropCommitSetsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CommitInfo_Details) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitProvenance", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CommitProvenance = append(m.CommitProvenance, &Commit{})
			if err := m.CommitProvenance[len(m.CommitProvenance)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SquashCommitSetsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SquashCommitSetsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SquashCommitSetsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitSets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CommitSets = append(m.CommitSets, &CommitSet{})
			if err := m.CommitSets[len(m.CommitSets)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DropCommitSetsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DropCommitSetsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DropCommitSetsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
