...
// StoredJobInfo is what is stored in the database for a Job
...
func (m *StoredJobInfo) GetBranches() []*BranchInfo {
	if m != nil {
		return m.Branches
	}
	return nil
...
// JobInfo is what is returned to users when inspecting or listing Jobs
type JobInfo struct {
	Job                  *Job                 `protobuf:"bytes,1,opt,name=job,proto3" json:"job,omitempty"`
	Commits              []*JobInfo_JobCommit `protobuf:"bytes,2,rep,name=commits,proto3" json:"commits,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *JobInfo) GetCommits() []*JobInfo_JobCommit {
	if m != nil {
		return m.Commits
	}
	return nil
...
type JobInfo_JobCommit struct {
	Provenance           []*Branch   `protobuf:"bytes,1,rep,name=provenance,proto3" json:"provenance,omitempty"`
...
func (m *JobInfo_JobCommit) Reset()         { *m = JobInfo_JobCommit{} }
func (m *JobInfo_JobCommit) String() string { return proto.CompactTextString(m) }
func (*JobInfo_JobCommit) ProtoMessage()    {}
func (*JobInfo_JobCommit) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{15, 0}
}
func (m *JobInfo_JobCommit) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobInfo_JobCommit) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobInfo_JobCommit.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobInfo_JobCommit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobInfo_JobCommit.Merge(m, src)
}
func (m *JobInfo_JobCommit) XXX_Size() int {
	return m.Size()
}
func (m *JobInfo_JobCommit) XXX_DiscardUnknown() {
	xxx_messageInfo_JobInfo_JobCommit.DiscardUnknown(m)
}

var xxx_messageInfo_JobInfo_JobCommit proto.InternalMessageInfo

func (m *JobInfo_JobCommit) GetProvenance() []*Branch {
	if m != nil {
		return m.Provenance
	}
	return nil
...
func (m *JobInfo_JobCommit) GetInfo() *CommitInfo {
	if m != nil {
		return m.Info
	}
	return nil
...
func (m *SquashJobRequest) Reset()         { *m = SquashJobRequest{} }
func (m *SquashJobRequest) String() string { return proto.CompactTextString(m) }
func (*SquashJobRequest) ProtoMessage()    {}
func (*SquashJobRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{28}
}
func (m *SquashJobRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SquashJobRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SquashJobRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SquashJobRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SquashJobRequest.Merge(m, src)
}
func (m *SquashJobRequest) XXX_Size() int {
	return m.Size()
}
func (m *SquashJobRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SquashJobRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SquashJobRequest proto.InternalMessageInfo

func (m *SquashJobRequest) GetJob() *Job {
	if m != nil {
		return m.Job
	}
	return nil
...
type FlushJobRequest struct {
	Job                  *Job      `protobuf:"bytes,1,opt,name=job,proto3" json:"job,omitempty"`
	ToBranches           []*Branch `protobuf:"bytes,2,rep,name=to_branches,json=toBranches,proto3" json:"to_branches,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *FlushJobRequest) GetJob() *Job {
	if m != nil {
		return m.Job
	}
	return nil
...
func (m *FlushJobRequest) GetToBranches() []*Branch {
	if m != nil {
		return m.ToBranches
	}
	return nil
...
type CreateBranchRequest struct {
	...
	NewJob               bool      `protobuf:"varint,5,opt,name=new_job,json=newJob,proto3" json:"new_job,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *CreateBranchRequest) GetNewJob() bool {
	if m != nil {
		return m.NewJob
	}
	return false
...
func init() {
	...
	proto.RegisterType((*JobInfo_JobCommit)(nil), "pfs.JobInfo.JobCommit")
	...
	proto.RegisterType((*InspectJobRequest)(nil), "pfs.InspectJobRequest")
	proto.RegisterType((*SquashJobRequest)(nil), "pfs.SquashJobRequest")
	proto.RegisterType((*FlushJobRequest)(nil), "pfs.FlushJobRequest")
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
type APIClient interface {
	...
	// InspectJob returns the info about a job.
	...
	SquashJob(ctx context.Context, in *SquashJobRequest, opts ...grpc.CallOption) (*types.Empty, error)
	// FlushJob waits for downstream commits to finish.
...
func (c *aPIClient) SubscribeCommit(ctx context.Context, in *SubscribeCommitRequest, opts ...grpc.CallOption) (API_SubscribeCommitClient, error) {
	stream, err := c.cc.NewStream(ctx, &_API_serviceDesc.Streams[1], "/pfs.API/SubscribeCommit", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *aPIClient) InspectJob(ctx context.Context, in *InspectJobRequest, opts ...grpc.CallOption) (*JobInfo, error) {
	out := new(JobInfo)
	err := c.cc.Invoke(ctx, "/pfs.API/InspectJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) SquashJob(ctx context.Context, in *SquashJobRequest, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/pfs.API/SquashJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) FlushJob(ctx context.Context, in *FlushJobRequest, opts ...grpc.CallOption) (API_FlushJobClient, error) {
	stream, err := c.cc.NewStream(ctx, &_API_serviceDesc.Streams[2], "/pfs.API/FlushJob", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *aPIFlushJobClient) Recv() (*CommitInfo, error) {
	m := new(CommitInfo)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type APIServer interface {
	...
	// SquashJob squashes the commits of a job into their children.
	SquashJob(context.Context, *SquashJobRequest) (*types.Empty, error)
	// FlushJob waits for downstream commits to finish.
...
func (*UnimplementedAPIServer) SquashJob(ctx context.Context, req *SquashJobRequest) (*types.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SquashJob not implemented")
}
...
func _API_SquashJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SquashJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).SquashJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pfs.API/SquashJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).SquashJob(ctx, req.(*SquashJobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (x *aPIFlushJobServer) Send(m *CommitInfo) error {
	return x.ServerStream.SendMsg(m)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SquashJob",
			Handler:    _API_SquashJob_Handler,
		},
		{
...
func (m *JobInfo_JobCommit) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobInfo_JobCommit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobInfo_JobCommit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SquashJobRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SquashJobRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SquashJobRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FlushJobRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ToBranches) > 0 {
		for iNdEx := len(m.ToBranches) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ToBranches[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *JobInfo_JobCommit) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SquashJobRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Commits = append(m.Commits, &JobInfo_JobCommit{})
...
func (m *JobInfo_JobCommit) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobCommit: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobCommit: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SquashJobRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SquashJobRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SquashJobRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *FlushJobRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ToBranches", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ToBranches = append(m.ToBranches, &Branch{})
			if err := m.ToBranches[len(m.ToBranches)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CreateBranchRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewJob", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
