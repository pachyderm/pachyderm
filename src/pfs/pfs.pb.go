...
type ModifyFileStatus_Status int32

const (
	ModifyFileStatus_STARTED   ModifyFileStatus_Status = 0
	ModifyFileStatus_COMPLETED ModifyFileStatus_Status = 1
	ModifyFileStatus_ERROR     ModifyFileStatus_Status = 2
)

var ModifyFileStatus_Status_name = map[int32]string{
	0: "STARTED",
	1: "COMPLETED",
	2: "ERROR",
}

var ModifyFileStatus_Status_value = map[string]int32{
	"STARTED":   0,
	"COMPLETED": 1,
	"ERROR":     2,
}

func (x ModifyFileStatus_Status) String() string {
	return proto.EnumName(ModifyFileStatus_Status_name, int32(x))
}

func (ModifyFileStatus_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{35, 0}
}
...
func (SQLDatabaseEgress_FileFormat_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{61, 0, 0}
}
...
type ModifyFileStatus struct {
	// Types that are valid to be assigned to Operation:
	//	*ModifyFileStatus_SetCommit
	//	*ModifyFileStatus_AddFile
	//	*ModifyFileStatus_DeleteFile
	//	*ModifyFileStatus_CopyFile
	Operation            isModifyFileStatus_Operation `protobuf_oneof:"operation"`
	Status               ModifyFileStatus_Status      `protobuf:"varint,5,opt,name=status,proto3,enum=pfs_v2.ModifyFileStatus_Status" json:"status,omitempty"`
...
func (m *ModifyFileStatus) Reset()         { *m = ModifyFileStatus{} }
func (m *ModifyFileStatus) String() string { return proto.CompactTextString(m) }
func (*ModifyFileStatus) ProtoMessage()    {}
func (*ModifyFileStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{35}
}
func (m *ModifyFileStatus) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ModifyFileStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ModifyFileStatus.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ModifyFileStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModifyFileStatus.Merge(m, src)
}
func (m *ModifyFileStatus) XXX_Size() int {
	return m.Size()
}
func (m *ModifyFileStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_ModifyFileStatus.DiscardUnknown(m)
}

var xxx_messageInfo_ModifyFileStatus proto.InternalMessageInfo

type isModifyFileStatus_Operation interface {
	isModifyFileStatus_Operation()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ModifyFileStatus_SetCommit struct {
	SetCommit *Commit `protobuf:"bytes,1,opt,name=set_commit,json=setCommit,proto3,oneof" json:"set_commit,omitempty"`
}
type ModifyFileStatus_AddFile struct {
	AddFile *AddFile `protobuf:"bytes,2,opt,name=add_file,json=addFile,proto3,oneof" json:"add_file,omitempty"`
}
type ModifyFileStatus_DeleteFile struct {
	DeleteFile *DeleteFile `protobuf:"bytes,3,opt,name=delete_file,json=deleteFile,proto3,oneof" json:"delete_file,omitempty"`
}
type ModifyFileStatus_CopyFile struct {
	CopyFile *CopyFile `protobuf:"bytes,4,opt,name=copy_file,json=copyFile,proto3,oneof" json:"copy_file,omitempty"`
}

func (*ModifyFileStatus_SetCommit) isModifyFileStatus_Operation()  {}
func (*ModifyFileStatus_AddFile) isModifyFileStatus_Operation()    {}
func (*ModifyFileStatus_DeleteFile) isModifyFileStatus_Operation() {}
func (*ModifyFileStatus_CopyFile) isModifyFileStatus_Operation()   {}

func (m *ModifyFileStatus) GetOperation() isModifyFileStatus_Operation {
	if m != nil {
		return m.Operation
	}
	return nil
...
func (m *ModifyFileStatus) GetSetCommit() *Commit {
	if x, ok := m.GetOperation().(*ModifyFileStatus_SetCommit); ok {
		return x.SetCommit
	}
	return nil
}

func (m *ModifyFileStatus) GetAddFile() *AddFile {
	if x, ok := m.GetOperation().(*ModifyFileStatus_AddFile); ok {
		return x.AddFile
	}
	return nil
}

func (m *ModifyFileStatus) GetDeleteFile() *DeleteFile {
	if x, ok := m.GetOperation().(*ModifyFileStatus_DeleteFile); ok {
		return x.DeleteFile
	}
	return nil
}

func (m *ModifyFileStatus) GetCopyFile() *CopyFile {
	if x, ok := m.GetOperation().(*ModifyFileStatus_CopyFile); ok {
		return x.CopyFile
	}
	return nil
}

func (m *ModifyFileStatus) GetStatus() ModifyFileStatus_Status {
	if m != nil {
		return m.Status
	}
	return ModifyFileStatus_STARTED
}

func (m *ModifyFileStatus) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ModifyFileStatus) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ModifyFileStatus_SetCommit)(nil),
		(*ModifyFileStatus_AddFile)(nil),
		(*ModifyFileStatus_DeleteFile)(nil),
		(*ModifyFileStatus_CopyFile)(nil),
	}
}
...
func (*SQLDatabaseEgress_FileFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{61, 0}
}
...
func (*SQLDatabaseEgress_Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{61, 1}
}
...
func init() {
	...
	proto.RegisterEnum("pfs_v2.ModifyFileStatus_Status", ModifyFileStatus_Status_name, ModifyFileStatus_Status_value)
	...
	proto.RegisterType((*ModifyFileStatus)(nil), "pfs_v2.ModifyFileStatus")
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
type APIClient interface {
	...
	// MonitoredModifyFile performs modifications on a set of files and returns progress updates.
	MonitoredModifyFile(ctx context.Context, opts ...grpc.CallOption) (API_MonitoredModifyFileClient, error)
...
func (c *aPIClient) MonitoredModifyFile(ctx context.Context, opts ...grpc.CallOption) (API_MonitoredModifyFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_API_serviceDesc.Streams[7], "/pfs_v2.API/MonitoredModifyFile", opts...)
	if err != nil {
		return nil, err
	}
	x := &aPIMonitoredModifyFileClient{stream}
	return x, nil
}

type API_MonitoredModifyFileClient interface {
	Send(*ModifyFileRequest) error
	Recv() (*ModifyFileStatus, error)
	grpc.ClientStream
}

type aPIMonitoredModifyFileClient struct {
	grpc.ClientStream
}

func (x *aPIMonitoredModifyFileClient) Send(m *ModifyFileRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *aPIMonitoredModifyFileClient) Recv() (*ModifyFileStatus, error) {
	m := new(ModifyFileStatus)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type APIServer interface {
	...
	// MonitoredModifyFile performs modifications on a set of files and returns progress updates.
	MonitoredModifyFile(API_MonitoredModifyFileServer) error
	// GetFile returns the contents of a single file
...
func (*UnimplementedAPIServer) MonitoredModifyFile(srv API_MonitoredModifyFileServer) error {
	return status.Errorf(codes.Unimplemented, "method MonitoredModifyFile not implemented")
}
...
func _API_MonitoredModifyFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(APIServer).MonitoredModifyFile(&aPIMonitoredModifyFileServer{stream})
}

type API_MonitoredModifyFileServer interface {
	Send(*ModifyFileStatus) error
	Recv() (*ModifyFileRequest, error)
	grpc.ServerStream
}

type aPIMonitoredModifyFileServer struct {
	grpc.ServerStream
}

func (x *aPIMonitoredModifyFileServer) Send(m *ModifyFileStatus) error {
	return x.ServerStream.SendMsg(m)
}

func (x *aPIMonitoredModifyFileServer) Recv() (*ModifyFileRequest, error) {
	m := new(ModifyFileRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "MonitoredModifyFile",
			Handler:       _API_MonitoredModifyFile_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
...
func (m *ModifyFileStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ModifyFileStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyFileStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Status != 0 {
		i = encodeVarintPfs(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x28
	}
	if m.Operation != nil {
...
func (m *ModifyFileStatus_SetCommit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyFileStatus_SetCommit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SetCommit != nil {
		{
			size, err := m.SetCommit.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ModifyFileStatus_AddFile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyFileStatus_AddFile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AddFile != nil {
		{
			size, err := m.AddFile.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ModifyFileStatus_DeleteFile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyFileStatus_DeleteFile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DeleteFile != nil {
		{
			size, err := m.DeleteFile.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ModifyFileStatus_CopyFile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyFileStatus_CopyFile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CopyFile != nil {
		{
			size, err := m.CopyFile.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ModifyFileStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModifyFileStatus_SetCommit) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModifyFileStatus_AddFile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModifyFileStatus_DeleteFile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModifyFileStatus_CopyFile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ModifyFileStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ModifyFileStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ModifyFileStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Operation = &ModifyFileStatus_SetCommit{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddFile", wireType)
			...
			m.Operation = &ModifyFileStatus_AddFile{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteFile", wireType)
			...
			m.Operation = &ModifyFileStatus_DeleteFile{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CopyFile", wireType)
			...
			m.Operation = &ModifyFileStatus_CopyFile{v}
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= ModifyFileStatus_Status(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
