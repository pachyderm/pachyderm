...
type SQLEgressOptions_FileFormat_Type int32

const (
	SQLEgressOptions_FileFormat_UNKNOWN SQLEgressOptions_FileFormat_Type = 0
	SQLEgressOptions_FileFormat_CSV     SQLEgressOptions_FileFormat_Type = 1
	SQLEgressOptions_FileFormat_JSON    SQLEgressOptions_FileFormat_Type = 2
	SQLEgressOptions_FileFormat_PARQUET SQLEgressOptions_FileFormat_Type = 3
)

var SQLEgressOptions_FileFormat_Type_name = map[int32]string{
	0: "UNKNOWN",
	1: "CSV",
	2: "JSON",
	3: "PARQUET",
...
var SQLEgressOptions_FileFormat_Type_value = map[string]int32{
	"UNKNOWN": 0,
	"CSV":     1,
	"JSON":    2,
	"PARQUET": 3,
...
func (x SQLEgressOptions_FileFormat_Type) String() string {
	return proto.EnumName(SQLEgressOptions_FileFormat_Type_name, int32(x))
}

func (SQLEgressOptions_FileFormat_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{60, 0, 0}
}
...
type ObjectStorageEgressOptions struct {
	Url                  string   `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *ObjectStorageEgressOptions) Reset()         { *m = ObjectStorageEgressOptions{} }
func (m *ObjectStorageEgressOptions) String() string { return proto.CompactTextString(m) }
func (*ObjectStorageEgressOptions) ProtoMessage()    {}
func (*ObjectStorageEgressOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{59}
}
func (m *ObjectStorageEgressOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ObjectStorageEgressOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ObjectStorageEgressOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ObjectStorageEgressOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObjectStorageEgressOptions.Merge(m, src)
}
func (m *ObjectStorageEgressOptions) XXX_Size() int {
	return m.Size()
}
func (m *ObjectStorageEgressOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_ObjectStorageEgressOptions.DiscardUnknown(m)
}

var xxx_messageInfo_ObjectStorageEgressOptions proto.InternalMessageInfo

func (m *ObjectStorageEgressOptions) GetUrl() string {
	if m != nil {
		return m.Url
	}
	return ""
...
type SQLEgressOptions struct {
	Url                  string                       `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	FileFormat           *SQLEgressOptions_FileFormat `protobuf:"bytes,2,opt,name=file_format,json=fileFormat,proto3" json:"file_format,omitempty"`
	Secret               *SQLEgressOptions_Secret     `protobuf:"bytes,3,opt,name=secret,proto3" json:"secret,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}

func (m *SQLEgressOptions) Reset()         { *m = SQLEgressOptions{} }
func (m *SQLEgressOptions) String() string { return proto.CompactTextString(m) }
func (*SQLEgressOptions) ProtoMessage()    {}
func (*SQLEgressOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{60}
}
func (m *SQLEgressOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SQLEgressOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SQLEgressOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SQLEgressOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SQLEgressOptions.Merge(m, src)
}
func (m *SQLEgressOptions) XXX_Size() int {
	return m.Size()
}
func (m *SQLEgressOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_SQLEgressOptions.DiscardUnknown(m)
}

var xxx_messageInfo_SQLEgressOptions proto.InternalMessageInfo

func (m *SQLEgressOptions) GetUrl() string {
	if m != nil {
		return m.Url
	}
	return ""
...
func (m *SQLEgressOptions) GetFileFormat() *SQLEgressOptions_FileFormat {
	if m != nil {
		return m.FileFormat
	}
	return nil
...
func (m *SQLEgressOptions) GetSecret() *SQLEgressOptions_Secret {
	if m != nil {
		return m.Secret
	}
	return nil
...
type SQLEgressOptions_FileFormat struct {
	Type                 SQLEgressOptions_FileFormat_Type     `protobuf:"varint,1,opt,name=type,proto3,enum=pfs_v2.SQLEgressOptions_FileFormat_Type" json:"type,omitempty"`
	Options              *SQLEgressOptions_FileFormat_Options `protobuf:"bytes,2,opt,name=options,proto3" json:"options,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}

func (m *SQLEgressOptions_FileFormat) Reset()         { *m = SQLEgressOptions_FileFormat{} }
func (m *SQLEgressOptions_FileFormat) String() string { return proto.CompactTextString(m) }
func (*SQLEgressOptions_FileFormat) ProtoMessage()    {}
func (*SQLEgressOptions_FileFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{60, 0}
}
func (m *SQLEgressOptions_FileFormat) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SQLEgressOptions_FileFormat) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SQLEgressOptions_FileFormat.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SQLEgressOptions_FileFormat) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SQLEgressOptions_FileFormat.Merge(m, src)
}
func (m *SQLEgressOptions_FileFormat) XXX_Size() int {
	return m.Size()
}
func (m *SQLEgressOptions_FileFormat) XXX_DiscardUnknown() {
	xxx_messageInfo_SQLEgressOptions_FileFormat.DiscardUnknown(m)
}

var xxx_messageInfo_SQLEgressOptions_FileFormat proto.InternalMessageInfo

func (m *SQLEgressOptions_FileFormat) GetType() SQLEgressOptions_FileFormat_Type {
	if m != nil {
		return m.Type
	}
	return SQLEgressOptions_FileFormat_UNKNOWN
}

func (m *SQLEgressOptions_FileFormat) GetOptions() *SQLEgressOptions_FileFormat_Options {
	if m != nil {
		return m.Options
	}
	return nil
...
type SQLEgressOptions_FileFormat_Options struct {
	JsonFieldNames       []string `protobuf:"bytes,1,rep,name=json_field_names,json=jsonFieldNames,proto3" json:"json_field_names,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SQLEgressOptions_FileFormat_Options) Reset()         { *m = SQLEgressOptions_FileFormat_Options{} }
func (m *SQLEgressOptions_FileFormat_Options) String() string { return proto.CompactTextString(m) }
func (*SQLEgressOptions_FileFormat_Options) ProtoMessage()    {}
func (*SQLEgressOptions_FileFormat_Options) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{60, 0, 0}
}
func (m *SQLEgressOptions_FileFormat_Options) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SQLEgressOptions_FileFormat_Options) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SQLEgressOptions_FileFormat_Options.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SQLEgressOptions_FileFormat_Options) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SQLEgressOptions_FileFormat_Options.Merge(m, src)
}
func (m *SQLEgressOptions_FileFormat_Options) XXX_Size() int {
	return m.Size()
}
func (m *SQLEgressOptions_FileFormat_Options) XXX_DiscardUnknown() {
	xxx_messageInfo_SQLEgressOptions_FileFormat_Options.DiscardUnknown(m)
}

var xxx_messageInfo_SQLEgressOptions_FileFormat_Options proto.InternalMessageInfo

func (m *SQLEgressOptions_FileFormat_Options) GetJsonFieldNames() []string {
	if m != nil {
		return m.JsonFieldNames
	}
	return nil
}

type SQLEgressOptions_Secret struct {
	K8SSecret            string   `protobuf:"bytes,1,opt,name=k8s_secret,json=k8sSecret,proto3" json:"k8s_secret,omitempty"`
...
func (m *SQLEgressOptions_Secret) Reset()         { *m = SQLEgressOptions_Secret{} }
func (m *SQLEgressOptions_Secret) String() string { return proto.CompactTextString(m) }
func (*SQLEgressOptions_Secret) ProtoMessage()    {}
func (*SQLEgressOptions_Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{60, 1}
}
func (m *SQLEgressOptions_Secret) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SQLEgressOptions_Secret) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SQLEgressOptions_Secret.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SQLEgressOptions_Secret) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SQLEgressOptions_Secret.Merge(m, src)
}
func (m *SQLEgressOptions_Secret) XXX_Size() int {
	return m.Size()
}
func (m *SQLEgressOptions_Secret) XXX_DiscardUnknown() {
	xxx_messageInfo_SQLEgressOptions_Secret.DiscardUnknown(m)
}

var xxx_messageInfo_SQLEgressOptions_Secret proto.InternalMessageInfo

func (m *SQLEgressOptions_Secret) GetK8SSecret() string {
	if m != nil {
		return m.K8SSecret
	}
	return ""
...
func (m *SQLEgressOptions_Secret) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *SQLEgressOptions_Secret) GetMountPath() string {
	if m != nil {
		return m.MountPath
	}
	return ""
...
func (m *SQLEgressOptions_Secret) GetEnvVar() string {
	if m != nil {
		return m.EnvVar
	}
	return ""
...
type EgressRequest_Obj struct {
	Obj *ObjectStorageEgressOptions `protobuf:"bytes,2,opt,name=obj,proto3,oneof" json:"obj,omitempty"`
}
type EgressRequest_Sql struct {
	Sql *SQLEgressOptions `protobuf:"bytes,3,opt,name=sql,proto3,oneof" json:"sql,omitempty"`
}

func (*EgressRequest_Obj) isEgressRequest_Target() {}
func (*EgressRequest_Sql) isEgressRequest_Target() {}
...
func (m *EgressRequest) GetObj() *ObjectStorageEgressOptions {
	if x, ok := m.GetTarget().(*EgressRequest_Obj); ok {
		return x.Obj
	}
	return nil
}

func (m *EgressRequest) GetSql() *SQLEgressOptions {
	if x, ok := m.GetTarget().(*EgressRequest_Sql); ok {
		return x.Sql
	}
	return nil
}
...
func (*EgressRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*EgressRequest_Obj)(nil),
		(*EgressRequest_Sql)(nil),
	}
}

type EgressResponse struct {
	// Types that are valid to be assigned to Ret:
	//	*EgressResponse_BytesWritten
	//	*EgressResponse_SqlResult
	Ret                  isEgressResponse_Ret `protobuf_oneof:"ret"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type isEgressResponse_Ret interface {
	isEgressResponse_Ret()
	MarshalTo([]byte) (int, error)
	Size() int
}

type EgressResponse_BytesWritten struct {
	BytesWritten int64 `protobuf:"varint,1,opt,name=bytes_written,json=bytesWritten,proto3,oneof" json:"bytes_written,omitempty"`
}
type EgressResponse_SqlResult struct {
	SqlResult *EgressResponse_SQLEgressResult `protobuf:"bytes,2,opt,name=sql_result,json=sqlResult,proto3,oneof" json:"sql_result,omitempty"`
}

func (*EgressResponse_BytesWritten) isEgressResponse_Ret() {}
func (*EgressResponse_SqlResult) isEgressResponse_Ret()    {}

func (m *EgressResponse) GetRet() isEgressResponse_Ret {
	if m != nil {
		return m.Ret
	}
	return nil
...
func (m *EgressResponse) GetBytesWritten() int64 {
	if x, ok := m.GetRet().(*EgressResponse_BytesWritten); ok {
		return x.BytesWritten
	}
	return 0
}

func (m *EgressResponse) GetSqlResult() *EgressResponse_SQLEgressResult {
	if x, ok := m.GetRet().(*EgressResponse_SqlResult); ok {
		return x.SqlResult
	}
	return nil
}
...
func (*EgressResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*EgressResponse_BytesWritten)(nil),
		(*EgressResponse_SqlResult)(nil),
	}
}

type EgressResponse_SQLEgressResult struct {
	SqlRowsWritten       map[string]int64 `protobuf:"bytes,1,rep,name=sql_rows_written,json=sqlRowsWritten,proto3" json:"sql_rows_written,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *EgressResponse_SQLEgressResult) Reset()         { *m = EgressResponse_SQLEgressResult{} }
func (m *EgressResponse_SQLEgressResult) String() string { return proto.CompactTextString(m) }
func (*EgressResponse_SQLEgressResult) ProtoMessage()    {}
func (*EgressResponse_SQLEgressResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{62, 0}
}
func (m *EgressResponse_SQLEgressResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EgressResponse_SQLEgressResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EgressResponse_SQLEgressResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EgressResponse_SQLEgressResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EgressResponse_SQLEgressResult.Merge(m, src)
}
func (m *EgressResponse_SQLEgressResult) XXX_Size() int {
	return m.Size()
}
func (m *EgressResponse_SQLEgressResult) XXX_DiscardUnknown() {
	xxx_messageInfo_EgressResponse_SQLEgressResult.DiscardUnknown(m)
}

var xxx_messageInfo_EgressResponse_SQLEgressResult proto.InternalMessageInfo

func (m *EgressResponse_SQLEgressResult) GetSqlRowsWritten() map[string]int64 {
	if m != nil {
		return m.SqlRowsWritten
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("pfs_v2.SQLEgressOptions_FileFormat_Type", SQLEgressOptions_FileFormat_Type_name, SQLEgressOptions_FileFormat_Type_value)
	...
	proto.RegisterType((*ObjectStorageEgressOptions)(nil), "pfs_v2.ObjectStorageEgressOptions")
	proto.RegisterType((*SQLEgressOptions)(nil), "pfs_v2.SQLEgressOptions")
	proto.RegisterType((*SQLEgressOptions_FileFormat)(nil), "pfs_v2.SQLEgressOptions.FileFormat")
	proto.RegisterType((*SQLEgressOptions_FileFormat_Options)(nil), "pfs_v2.SQLEgressOptions.FileFormat.Options")
	proto.RegisterType((*SQLEgressOptions_Secret)(nil), "pfs_v2.SQLEgressOptions.Secret")
	proto.RegisterType((*EgressRequest)(nil), "pfs_v2.EgressRequest")
	proto.RegisterType((*EgressResponse)(nil), "pfs_v2.EgressResponse")
	proto.RegisterType((*EgressResponse_SQLEgressResult)(nil), "pfs_v2.EgressResponse.SQLEgressResult")
	proto.RegisterMapType((map[string]int64)(nil), "pfs_v2.EgressResponse.SQLEgressResult.SqlRowsWrittenEntry")
}
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
func (m *ObjectStorageEgressOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ObjectStorageEgressOptions) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ObjectStorageEgressOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SQLEgressOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SQLEgressOptions) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SQLEgressOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SQLEgressOptions_FileFormat) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SQLEgressOptions_FileFormat) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SQLEgressOptions_FileFormat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SQLEgressOptions_FileFormat_Options) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SQLEgressOptions_FileFormat_Options) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SQLEgressOptions_FileFormat_Options) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.JsonFieldNames) > 0 {
		for iNdEx := len(m.JsonFieldNames) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.JsonFieldNames[iNdEx])
			copy(dAtA[i:], m.JsonFieldNames[iNdEx])
			i = encodeVarintPfs(dAtA, i, uint64(len(m.JsonFieldNames[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *SQLEgressOptions_Secret) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SQLEgressOptions_Secret) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SQLEgressOptions_Secret) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.EnvVar) > 0 {
		...
		i = encodeVarintPfs(dAtA, i, uint64(len(m.EnvVar)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.MountPath) > 0 {
		...
		i = encodeVarintPfs(dAtA, i, uint64(len(m.MountPath)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Key) > 0 {
	...
	if len(m.K8SSecret) > 0 {
		i -= len(m.K8SSecret)
		copy(dAtA[i:], m.K8SSecret)
		i = encodeVarintPfs(dAtA, i, uint64(len(m.K8SSecret)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *EgressRequest_Obj) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EgressRequest_Obj) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Obj != nil {
		{
...
func (m *EgressRequest_Sql) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EgressRequest_Sql) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Sql != nil {
		{
...
func (m *EgressResponse_BytesWritten) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EgressResponse_BytesWritten) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *EgressResponse_SqlResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EgressResponse_SqlResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SqlResult != nil {
		{
			size, err := m.SqlResult.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EgressResponse_SQLEgressResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EgressResponse_SQLEgressResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EgressResponse_SQLEgressResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.SqlRowsWritten) > 0 {
		for k := range m.SqlRowsWritten {
			v := m.SqlRowsWritten[k]
			baseI := i
...
func (m *ObjectStorageEgressOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SQLEgressOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SQLEgressOptions_FileFormat) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SQLEgressOptions_FileFormat_Options) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.JsonFieldNames) > 0 {
		for _, s := range m.JsonFieldNames {
			l = len(s)
			n += 1 + l + sovPfs(uint64(l))
		}
	}
...
func (m *SQLEgressOptions_Secret) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EgressRequest_Obj) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EgressRequest_Sql) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EgressResponse_BytesWritten) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EgressResponse_SqlResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EgressResponse_SQLEgressResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.SqlRowsWritten) > 0 {
		for k, v := range m.SqlRowsWritten {
			_ = k
			_ = v
...
func (m *ObjectStorageEgressOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ObjectStorageEgressOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ObjectStorageEgressOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SQLEgressOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SQLEgressOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SQLEgressOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.FileFormat == nil {
				m.FileFormat = &SQLEgressOptions_FileFormat{}
			}
		...
		case 3:
			...
			if m.Secret == nil {
				m.Secret = &SQLEgressOptions_Secret{}
			}
...
func (m *SQLEgressOptions_FileFormat) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= SQLEgressOptions_FileFormat_Type(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			if m.Options == nil {
				m.Options = &SQLEgressOptions_FileFormat_Options{}
			}
...
func (m *SQLEgressOptions_FileFormat_Options) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JsonFieldNames", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.JsonFieldNames = append(m.JsonFieldNames, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
...
func (m *SQLEgressOptions_Secret) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field K8SSecret", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.K8SSecret = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Key", wireType)
...
func (m *EgressRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &ObjectStorageEgressOptions{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Target = &EgressRequest_Obj{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *EgressResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Ret = &EgressResponse_BytesWritten{v}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SqlResult", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &EgressResponse_SQLEgressResult{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Ret = &EgressResponse_SqlResult{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
...
func (m *EgressResponse_SQLEgressResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SQLEgressResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SQLEgressResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SqlRowsWritten", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SqlRowsWritten == nil {
				m.SqlRowsWritten = make(map[string]int64)
			}
			var mapkey string
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.SqlRowsWritten[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
