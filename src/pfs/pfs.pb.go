...
type JobCommitInfo struct {
	Branch               *Branch   `protobuf:"bytes,1,opt,name=branch,proto3" json:"branch,omitempty"`
	Provenance           []*Branch `protobuf:"bytes,2,rep,name=provenance,proto3" json:"provenance,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *JobCommitInfo) Reset()         { *m = JobCommitInfo{} }
func (m *JobCommitInfo) String() string { return proto.CompactTextString(m) }
func (*JobCommitInfo) ProtoMessage()    {}
func (*JobCommitInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{14}
}
func (m *JobCommitInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobCommitInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobCommitInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobCommitInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobCommitInfo.Merge(m, src)
}
func (m *JobCommitInfo) XXX_Size() int {
	return m.Size()
}
func (m *JobCommitInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_JobCommitInfo.DiscardUnknown(m)
}

var xxx_messageInfo_JobCommitInfo proto.InternalMessageInfo

func (m *JobCommitInfo) GetBranch() *Branch {
	if m != nil {
		return m.Branch
	}
	return nil
...
func (m *JobCommitInfo) GetProvenance() []*Branch {
	if m != nil {
		return m.Provenance
	}
	return nil
...
type StoredJobInfo struct {
	...
	JobCommits           []*JobCommitInfo `protobuf:"bytes,3,rep,name=job_commits,json=jobCommits,proto3" json:"job_commits,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *StoredJobInfo) GetJobCommits() []*JobCommitInfo {
	if m != nil {
		return m.JobCommits
	}
	return nil
...
func (m *JobInfo) GetJobCommits() []*JobCommitInfo {
	if m != nil {
		return m.JobCommits
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*JobCommitInfo)(nil), "pfs.JobCommitInfo")
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
func (c *aPIClient) FlushJob(ctx context.Context, in *FlushJobRequest, opts ...grpc.CallOption) (API_FlushJobClient, error) {
	stream, err := c.cc.NewStream(ctx, &_API_serviceDesc.Streams[1], "/pfs.API/FlushJob", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *JobCommitInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobCommitInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobCommitInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoredJobInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.JobCommits) > 0 {
		for iNdEx := len(m.JobCommits) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.JobCommits[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *JobCommitInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobCommitInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobCommitInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobCommitInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *StoredJobInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobCommits", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.JobCommits = append(m.JobCommits, &JobCommitInfo{})
			if err := m.JobCommits[len(m.JobCommits)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
