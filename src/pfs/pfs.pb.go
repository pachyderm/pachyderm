...
type FileSetFilter struct {
	...
	//	*FileSetFilter_PathRegexp
	Value                isFileSetFilter_Value `protobuf_oneof:"value"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}

func (m *FileSetFilter) Reset()         { *m = FileSetFilter{} }
func (m *FileSetFilter) String() string { return proto.CompactTextString(m) }
func (*FileSetFilter) ProtoMessage()    {}
func (*FileSetFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a7b2476cbc6216, []int{58}
}
func (m *FileSetFilter) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FileSetFilter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FileSetFilter.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FileSetFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileSetFilter.Merge(m, src)
}
func (m *FileSetFilter) XXX_Size() int {
	return m.Size()
}
func (m *FileSetFilter) XXX_DiscardUnknown() {
	xxx_messageInfo_FileSetFilter.DiscardUnknown(m)
}

var xxx_messageInfo_FileSetFilter proto.InternalMessageInfo

type isFileSetFilter_Value interface {
	isFileSetFilter_Value()
	MarshalTo([]byte) (int, error)
	Size() int
}

type FileSetFilter_PathRegexp struct {
	PathRegexp string `protobuf:"bytes,1,opt,name=path_regexp,json=pathRegexp,proto3,oneof" json:"path_regexp,omitempty"`
}

func (*FileSetFilter_PathRegexp) isFileSetFilter_Value() {}

func (m *FileSetFilter) GetValue() isFileSetFilter_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *FileSetFilter) GetPathRegexp() string {
	if x, ok := m.GetValue().(*FileSetFilter_PathRegexp); ok {
		return x.PathRegexp
	}
	return ""
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*FileSetFilter) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*FileSetFilter_PathRegexp)(nil),
	}
}

type FileSetTransform struct {
	AddPrefix            string   `protobuf:"bytes,1,opt,name=add_prefix,json=addPrefix,proto3" json:"add_prefix,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type ReadFileSetRequest struct {
	...
	Filters              []*FileSetFilter    `protobuf:"bytes,3,rep,name=filters,proto3" json:"filters,omitempty"`
	Transforms           []*FileSetTransform `protobuf:"bytes,4,rep,name=transforms,proto3" json:"transforms,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *ReadFileSetRequest) GetFilters() []*FileSetFilter {
	if m != nil {
		return m.Filters
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FileSetFilter)(nil), "pfs_v2.FileSetFilter")
...
var fileDescriptor_21a7b2476cbc6216 = []byte{
	...
	,
}
...
func (m *FileSetFilter) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FileSetFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSetFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FileSetFilter_PathRegexp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSetFilter_PathRegexp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.PathRegexp)
	copy(dAtA[i:], m.PathRegexp)
	i = encodeVarintPfs(dAtA, i, uint64(len(m.PathRegexp)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *FileSetFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FileSetFilter_PathRegexp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FileSetFilter) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileSetFilter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileSetFilter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Value = &FileSetFilter_PathRegexp{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
...
func (m *FileSetTransform) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AddPrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPfs(dAtA[iNdEx:])
...
func (m *ReadFileSetRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Filters = append(m.Filters, &FileSetFilter{})
