...
func (x *aPIGetFileClient) Recv() (*wrappers.BytesValue, error) {
...
func (x *aPIGetFileTARClient) Recv() (*wrappers.BytesValue, error) {
	m := new(wrappers.BytesValue)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (UnimplementedAPIServer) CreateRepo(context.Context, *CreateRepoRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) DeleteRepo(context.Context, *DeleteRepoRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) FinishCommit(context.Context, *FinishCommitRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FinishCommit not implemented")
}
func (UnimplementedAPIServer) ClearCommit(context.Context, *ClearCommitRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) SquashCommitSet(context.Context, *SquashCommitSetRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SquashCommitSet not implemented")
}
func (UnimplementedAPIServer) DropCommitSet(context.Context, *DropCommitSetRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) CreateBranch(context.Context, *CreateBranchRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) DeleteBranch(context.Context, *DeleteBranchRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) AddFileSet(context.Context, *AddFileSetRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddFileSet not implemented")
}
func (UnimplementedAPIServer) RenewFileSet(context.Context, *RenewFileSetRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) PutCache(context.Context, *PutCacheRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) ClearCache(context.Context, *ClearCacheRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) CreateProject(context.Context, *CreateProjectRequest) (*empty.Empty, error) {
...
func (UnimplementedAPIServer) DeleteProject(context.Context, *DeleteProjectRequest) (*empty.Empty, error) {
...
func (x *aPIGetFileServer) Send(m *wrappers.BytesValue) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *aPIGetFileTARServer) Send(m *wrappers.BytesValue) error {
	return x.ServerStream.SendMsg(m)
}
