CREATE TABLE public.ci_jobs (
    ...
    CONSTRAINT ci_jobs_pk PRIMARY KEY (workflow_id, job_id)
);
...
CREATE TABLE public.test_results (
	...
	CONSTRAINT test_results_fk FOREIGN KEY (workflow_id, job_id) REFERENCES public.ci_jobs(workflow_id, job_id)
);
