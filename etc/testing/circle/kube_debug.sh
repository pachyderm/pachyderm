...
cmds=(
  ...
  'kubectl describe pod -l suite=pachyderm,app=pachd --namespace=test-cluster-1'
  'kubectl describe pod -l suite=pachyderm,app=pachw --namespace=test-cluster-1'
  'kubectl describe pod -l suite=pachyderm,app=etcd --namespace=test-cluster-1'
  'kubectl describe pod -l suite=pachyderm,app=pachd --namespace=test-cluster-2'
  'kubectl describe pod -l suite=pachyderm,app=pachw --namespace=test-cluster-2'
  'kubectl describe pod -l suite=pachyderm,app=etcd --namespace=test-cluster-2'
  'kubectl describe pod -l suite=pachyderm,app=pachd --namespace=test-cluster-3'
  'kubectl describe pod -l suite=pachyderm,app=pachw --namespace=test-cluster-3'
  'kubectl describe pod -l suite=pachyderm,app=etcd --namespace=test-cluster-3'
  'kubectl describe pod -l suite=pachyderm,app=pachd --namespace=test-cluster-4'
  'kubectl describe pod -l suite=pachyderm,app=pachw --namespace=test-cluster-4'
  'kubectl describe pod -l suite=pachyderm,app=etcd --namespace=test-cluster-4'
  'kubectl describe pod -l suite=pachyderm,app=pachd --namespace=test-cluster-5'
  'kubectl describe pod -l suite=pachyderm,app=pachw --namespace=test-cluster-5'
  'kubectl describe pod -l suite=pachyderm,app=etcd --namespace=test-cluster-5'
  ...
  'kubectl logs --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-1 --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-2 --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-3 --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-4 --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-5 --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-6 --tail=1500 -l suite=pachyderm,app=pachw --previous --prefix=true'
  'kubectl logs postgres-0 --namespace=test-cluster-1 --tail=1500 -l --prefix=true'
  'kubectl logs postgres-0 --namespace=test-cluster-2 --tail=1500 -l --prefix=true'
