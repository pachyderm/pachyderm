...
cmds=(
  ...
  'kubectl describe pod -l determined-system=master --namespace=test-cluster-1'
  'kubectl describe pod -l determined-system=master --namespace=test-cluster-2'
  'kubectl describe pod -l determined-system=master --namespace=test-cluster-3'
  'kubectl describe pod -l determined-system=master --namespace=test-cluster-4'
  'kubectl describe pod -l determined-system=db --namespace=test-cluster-1'
  'kubectl describe pod -l determined-system=db --namespace=test-cluster-2'
  'kubectl describe pod -l determined-system=db --namespace=test-cluster-3'
  'kubectl describe pod -l determined-system=db --namespace=test-cluster-4'
  ...
  'kubectl logs --namespace=test-cluster-1 --tail=1500 -l determined-system=master --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-2 --tail=1500 -l determined-system=master --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-3 --tail=1500 -l determined-system=master --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-4 --tail=1500 -l determined-system=master --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-1 --tail=1500 -l determined-system=master --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-2 --tail=1500 -l determined-system=master --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-3 --tail=1500 -l determined-system=master --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-4 --tail=1500 -l determined-system=master --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-1 --tail=1500 -l determined-system=db --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-2 --tail=1500 -l determined-system=db --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-3 --tail=1500 -l determined-system=db --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-4 --tail=1500 -l determined-system=db --all-containers=true --prefix=true'
  'kubectl logs --namespace=test-cluster-1 --tail=1500 -l determined-system=db --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-2 --tail=1500 -l determined-system=db --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-3 --tail=1500 -l determined-system=db --all-containers=true --previous --prefix=true'
  'kubectl logs --namespace=test-cluster-4 --tail=1500 -l determined-system=db --all-containers=true --previous --prefix=true'
