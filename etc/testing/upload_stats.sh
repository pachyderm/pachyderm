...
ENV_VARS=(CIRCLE_REPOSITORY_URL CIRCLE_STAGE CIRCLE_BRANCH CIRCLE_BUILD_NUM CIRCLE_SHA1 BIGQUERY_PROJECT BIGQUERY_DATASET BIGQUERY_TABLE TEST_RESULTS_BUCKET GOOGLE_TEST_UPLOAD_CREDS)
