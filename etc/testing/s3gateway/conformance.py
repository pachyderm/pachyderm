...
BLACKLISTED_TESTS = [
    ...
    "s3tests.functional.test_headers.test_bucket_create_bad_authorization_none",
    ...
    "s3tests.functional.test_s3.test_encryption_sse_c_invalid_md5",
    "s3tests.functional.test_s3.test_encryption_sse_c_no_md5",
    "s3tests.functional.test_s3.test_encryption_sse_c_no_key",
    "s3tests.functional.test_s3.test_encryption_key_no_sse_c",
