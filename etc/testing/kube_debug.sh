...
cmds=(
  ...
  'kubectl logs --tail=1500 storage-provisioner --namespace=kubesystem'
  'kubectl logs --tail=1500 storage-provisioner --namespace=kubesystem --previous'
  'kubectl logs --tail=500 -l k8s-app=kube-dns'
