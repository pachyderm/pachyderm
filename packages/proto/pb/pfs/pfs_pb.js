...
goog.exportSymbol('proto.pfs.AppendFile', null, global);
goog.exportSymbol('proto.pfs.AppendFile.SourceCase', null, global);
 ...
 * @constructor
 */
proto.pfs.AppendFile = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.pfs.AppendFile.oneofGroups_);
};
goog.inherits(proto.pfs.AppendFile, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pfs.AppendFile.displayName = 'proto.pfs.AppendFile';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.pfs.RepoAuthInfo.repeatedFields_ = [1];
 ...
 * @const
 */
proto.pfs.CommitInfo.repeatedFields_ = [11,16,9];
 ...
 * @const
 */
proto.pfs.AppendFile.oneofGroups_ = [[3,4,5]];

/**
 * @enum {number}
 */
proto.pfs.AppendFile.SourceCase = {
  SOURCE_NOT_SET: 0,
  RAW_FILE_SOURCE: 3,
  TAR_FILE_SOURCE: 4,
  URL_FILE_SOURCE: 5
...
/**
 * @return {proto.pfs.AppendFile.SourceCase}
 */
proto.pfs.AppendFile.prototype.getSourceCase = function() {
  return /** @type {proto.pfs.AppendFile.SourceCase} */(jspb.Message.computeOneofCase(this, proto.pfs.AppendFile.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.pfs.AppendFile.prototype.toObject = function(opt_includeInstance) {
  return proto.pfs.AppendFile.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pfs.AppendFile} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pfs.AppendFile.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pfs.AppendFile}
 */
proto.pfs.AppendFile.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pfs.AppendFile;
  return proto.pfs.AppendFile.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pfs.AppendFile} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pfs.AppendFile}
 */
proto.pfs.AppendFile.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pfs.AppendFile.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pfs.AppendFile.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pfs.AppendFile} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pfs.AppendFile.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.pfs.AppendFile.prototype.getOverwrite = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.pfs.AppendFile} returns this
 */
proto.pfs.AppendFile.prototype.setOverwrite = function(value) {
 ...
 * @return {string}
 */
proto.pfs.AppendFile.prototype.getTag = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pfs.AppendFile} returns this
 */
proto.pfs.AppendFile.prototype.setTag = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.pfs.AppendFile.prototype.getRawFileSource = function() {
 ...
 * @return {!proto.pfs.AppendFile} returns this
*/
proto.pfs.AppendFile.prototype.setRawFileSource = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.pfs.AppendFile.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pfs.AppendFile} returns this
 */
proto.pfs.AppendFile.prototype.clearRawFileSource = function() {
 ...
 * @return {boolean}
 */
proto.pfs.AppendFile.prototype.hasRawFileSource = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 */
proto.pfs.AppendFile.prototype.getTarFileSource = function() {
 ...
 * @return {!proto.pfs.AppendFile} returns this
*/
proto.pfs.AppendFile.prototype.setTarFileSource = function(value) {
  return jspb.Message.setOneofWrapperField(this, 4, proto.pfs.AppendFile.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pfs.AppendFile} returns this
 */
proto.pfs.AppendFile.prototype.clearTarFileSource = function() {
 ...
 * @return {boolean}
 */
proto.pfs.AppendFile.prototype.hasTarFileSource = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 */
proto.pfs.AppendFile.prototype.getUrlFileSource = function() {
 ...
 * @return {!proto.pfs.AppendFile} returns this
*/
proto.pfs.AppendFile.prototype.setUrlFileSource = function(value) {
  return jspb.Message.setOneofWrapperField(this, 5, proto.pfs.AppendFile.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pfs.AppendFile} returns this
 */
proto.pfs.AppendFile.prototype.clearUrlFileSource = function() {
 ...
 * @return {boolean}
 */
proto.pfs.AppendFile.prototype.hasUrlFileSource = function() {
  return jspb.Message.getField(this, 5) != null;
};
 ...
 * @const
 */
proto.pfs.ModifyFileRequest.oneofGroups_ = [[2,3]];
...
proto.pfs.ModifyFileRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    commit: (f = msg.getCommit()) && proto.pfs.Commit.toObject(includeInstance, f),
    appendFile: (f = msg.getAppendFile()) && proto.pfs.AppendFile.toObject(includeInstance, f),
...
proto.pfs.ModifyFileRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.pfs.AppendFile;
      reader.readMessage(value,proto.pfs.AppendFile.deserializeBinaryFromReader);
      msg.setAppendFile(value);
      break;
    case 3:
...
proto.pfs.ModifyFileRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getAppendFile();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.pfs.AppendFile.serializeBinaryToWriter
    );
  }
...
/**
 * optional AppendFile append_file = 2;
 * @return {?proto.pfs.AppendFile}
 */
proto.pfs.ModifyFileRequest.prototype.getAppendFile = function() {
  return /** @type{?proto.pfs.AppendFile} */ (
    jspb.Message.getWrapperField(this, proto.pfs.AppendFile, 2));
};


/**
 * @param {?proto.pfs.AppendFile|undefined} value
 * @return {!proto.pfs.ModifyFileRequest} returns this
*/
proto.pfs.ModifyFileRequest.prototype.setAppendFile = function(value) {
 ...
 * @return {!proto.pfs.ModifyFileRequest} returns this
 */
proto.pfs.ModifyFileRequest.prototype.clearAppendFile = function() {
  return this.setAppendFile(undefined);
};
 ...
 * @return {boolean}
 */
proto.pfs.ModifyFileRequest.prototype.hasAppendFile = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {string}
 */
proto.pfs.CopyFileRequest.prototype.getTag = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.pfs.CopyFileRequest} returns this
 */
proto.pfs.CopyFileRequest.prototype.setTag = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
