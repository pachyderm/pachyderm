...
goog.exportSymbol('proto.pfs_v2.FileInfo.Details', null, global);
 ...
 * @constructor
 */
proto.pfs_v2.FileInfo.Details = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pfs_v2.FileInfo.Details, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pfs_v2.FileInfo.Details.displayName = 'proto.pfs_v2.FileInfo.Details';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pfs_v2.FileInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    details: (f = msg.getDetails()) && proto.pfs_v2.FileInfo.Details.toObject(includeInstance, f)
  };
...
proto.pfs_v2.FileInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.pfs_v2.FileInfo.Details;
      reader.readMessage(value,proto.pfs_v2.FileInfo.Details.deserializeBinaryFromReader);
      msg.setDetails(value);
      break;
    default:
      reader.skipField();
...
proto.pfs_v2.FileInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.pfs_v2.FileInfo.Details.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.pfs_v2.FileInfo.Details.prototype.toObject = function(opt_includeInstance) {
  return proto.pfs_v2.FileInfo.Details.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pfs_v2.FileInfo.Details} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pfs_v2.FileInfo.Details.toObject = function(includeInstance, msg) {
  var f, obj = {
    sizeBytes: jspb.Message.getFieldWithDefault(msg, 1, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pfs_v2.FileInfo.Details}
 */
proto.pfs_v2.FileInfo.Details.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pfs_v2.FileInfo.Details;
  return proto.pfs_v2.FileInfo.Details.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pfs_v2.FileInfo.Details} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pfs_v2.FileInfo.Details}
 */
proto.pfs_v2.FileInfo.Details.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pfs_v2.FileInfo.Details.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pfs_v2.FileInfo.Details.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pfs_v2.FileInfo.Details} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pfs_v2.FileInfo.Details.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSizeBytes();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.pfs_v2.FileInfo.Details.prototype.getSizeBytes = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.pfs_v2.FileInfo.Details} returns this
 */
proto.pfs_v2.FileInfo.Details.prototype.setSizeBytes = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pfs_v2.FileInfo.Details.prototype.getHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.pfs_v2.FileInfo.Details.prototype.getHash_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.pfs_v2.FileInfo.Details.prototype.getHash_asU8 = function() {
 ...
 * @return {!proto.pfs_v2.FileInfo.Details} returns this
 */
proto.pfs_v2.FileInfo.Details.prototype.setHash = function(value) {
 ...
 * @return {?proto.pfs_v2.FileInfo.Details}
 */
proto.pfs_v2.FileInfo.prototype.getDetails = function() {
  return /** @type{?proto.pfs_v2.FileInfo.Details} */ (
    jspb.Message.getWrapperField(this, proto.pfs_v2.FileInfo.Details, 4));
};


/**
 * @param {?proto.pfs_v2.FileInfo.Details|undefined} value
 * @return {!proto.pfs_v2.FileInfo} returns this
*/
proto.pfs_v2.FileInfo.prototype.setDetails = function(value) {
  return jspb.Message.setWrapperField(this, 4, value);
};
 ...
 * @return {!proto.pfs_v2.FileInfo} returns this
 */
proto.pfs_v2.FileInfo.prototype.clearDetails = function() {
  return this.setDetails(undefined);
};
 ...
 * @return {boolean}
 */
proto.pfs_v2.FileInfo.prototype.hasDetails = function() {
  return jspb.Message.getField(this, 4) != null;
};
