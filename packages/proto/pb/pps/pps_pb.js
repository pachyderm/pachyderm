...
proto.pps_v2.JobInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    enableStats: jspb.Message.getBooleanFieldWithDefault(msg, 29, false),
...
proto.pps_v2.ChunkSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    chunksPerWorker: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
...
/**
 * optional int64 chunks_per_worker = 3;
 * @return {number}
 */
proto.pps_v2.ChunkSpec.prototype.getChunksPerWorker = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.pps_v2.ChunkSpec} returns this
 */
proto.pps_v2.ChunkSpec.prototype.setChunksPerWorker = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
