...
clean-launch:
	...
	kubectl $(KUBECTLFLAGS) delete job -l suite=pachyderm # job not part of all?
	kubectl $(KUBECTLFLAGS) delete serviceaccount -l suite=pachyderm # service account neither?
