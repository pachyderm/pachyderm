...
release-docker-images:
	...
	# TODO: Delete this before merging, only skipping validation for testing
	DOCKER_BUILDKIT=1 goreleaser release -p 1 $(GORELSNAP) $(GORELDEBUG) --skip-validation --skip-publish --rm-dist -f goreleaser/docker.yml
