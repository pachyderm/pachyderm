...
python-sdk:
	...
	find src -regex ".*\.proto" | grep -v 'internal' | grep -v 'server' | grep -v 'identity' | xargs tar cf - | docker run -i pachyderm-python-sdk-builder | tar -C python-sdk/pachyderm_sdk -xf -
