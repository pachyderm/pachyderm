...
const ConfirmConfigModal: React.FC<ConfirmConfigModalProps> = ({
  ...
  return (
    <FormModal
      ...
      confirmText="Save"
      formContext={formCtx}
      headerText={`Save ${level} Defaults`}
    ...
    >
      <div className={styles.modalContent}>
        <RadioButton id="save" value="save" name="configOption">
          <RadioButton.Label>Save {level} Defaults</RadioButton.Label>
        </RadioButton>
        ...
        <RadioButton id="regenerate" value="regenerate" name="configOption">
          <RadioButton.Label>
            Save {level} Defaults and Regenerate Pipelines
          </RadioButton.Label>
        </RadioButton>
        <CaptionTextSmall color="black" className={styles.description}>
        ...
        <RadioButton id="reprocess" value="reprocess" name="configOption">
          <RadioButton.Label>
            Save {level} Defaults, Regenerate Pipelines, and Reprocess Datums
          </RadioButton.Label>
        </RadioButton>
        <CaptionTextSmall color="black" className={styles.description}>
