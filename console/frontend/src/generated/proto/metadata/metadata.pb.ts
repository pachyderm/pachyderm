...
export type EditMetadataRequest = {
    __typename?: "EditMetadataRequest";
    edits?: Edit[];
};

export type EditMetadataResponse = {
    __typename?: "EditMetadataResponse";
};
