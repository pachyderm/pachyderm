...
class ApiStub:
    ...
    def add_cluster(
        self, add_cluster_request: "AddClusterRequest"
    ) -> "AddClusterResponse":
        return self.__rpc_add_cluster(add_cluster_request)

    def delete_cluster(
        self, delete_cluster_request: "DeleteClusterRequest"
    ) -> "DeleteClusterResponse":
        return self.__rpc_delete_cluster(delete_cluster_request)

    def list_clusters(
        self, list_clusters_request: "ListClustersRequest"
    ) -> "ListClustersResponse":
        return self.__rpc_list_clusters(list_clusters_request)

    def update_cluster(
        self, update_cluster_request: "UpdateClusterRequest"
    ) -> "UpdateClusterResponse":
        return self.__rpc_update_cluster(update_cluster_request)
    ...
    def list_user_clusters(
        self, list_user_clusters_request: "ListUserClustersRequest"
    ) -> "ListUserClustersResponse":
        return self.__rpc_list_user_clusters(list_user_clusters_request)
...
class ApiBase(ServicerBase):
    ...
    def add_cluster(
        self, request: "AddClusterRequest", context: "grpc.ServicerContext"
    ) -> "AddClusterResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def delete_cluster(
        self, request: "DeleteClusterRequest", context: "grpc.ServicerContext"
    ) -> "DeleteClusterResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def list_clusters(
        self, request: "ListClustersRequest", context: "grpc.ServicerContext"
    ) -> "ListClustersResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def update_cluster(
        self, request: "UpdateClusterRequest", context: "grpc.ServicerContext"
    ) -> "UpdateClusterResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def list_user_clusters(
        self, request: "ListUserClustersRequest", context: "grpc.ServicerContext"
    ) -> "ListUserClustersResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
