...
class ApiStub:
    ...
    def get_configuration(
        ...
        return self.__rpc_get_configuration(get_configuration_request)

    def set_configuration(
        self, set_configuration_request: "SetConfigurationRequest"
    ) -> "SetConfigurationResponse":
        return self.__rpc_set_configuration(set_configuration_request)

    def authenticate(
        self, authenticate_request: "AuthenticateRequest"
    ) -> "AuthenticateResponse":
        return self.__rpc_authenticate(authenticate_request)

    def authorize(self, authorize_request: "AuthorizeRequest") -> "AuthorizeResponse":
        return self.__rpc_authorize(authorize_request)

    def get_permissions(
        self, get_permissions_request: "GetPermissionsRequest"
    ) -> "GetPermissionsResponse":
        return self.__rpc_get_permissions(get_permissions_request)

    def get_permissions_for_principal(
        self, get_permissions_for_principal_request: "GetPermissionsForPrincipalRequest"
    ) -> "GetPermissionsResponse":
        return self.__rpc_get_permissions_for_principal(
            get_permissions_for_principal_request
        )

    def who_am_i(self, who_am_i_request: "WhoAmIRequest") -> "WhoAmIResponse":
        return self.__rpc_who_am_i(who_am_i_request)

    def get_roles_for_permission(
        self, get_roles_for_permission_request: "GetRolesForPermissionRequest"
    ) -> "GetRolesForPermissionResponse":
        return self.__rpc_get_roles_for_permission(get_roles_for_permission_request)

    def modify_role_binding(
        self, modify_role_binding_request: "ModifyRoleBindingRequest"
    ) -> "ModifyRoleBindingResponse":
        return self.__rpc_modify_role_binding(modify_role_binding_request)

    def get_role_binding(
        self, get_role_binding_request: "GetRoleBindingRequest"
    ) -> "GetRoleBindingResponse":
        return self.__rpc_get_role_binding(get_role_binding_request)

    def get_oidc_login(self) -> "GetOidcLoginResponse":
        return self.__rpc_get_oidc_login(get_oidc_login_request)

    def get_robot_token(
        self, get_robot_token_request: "GetRobotTokenRequest"
    ) -> "GetRobotTokenResponse":
        return self.__rpc_get_robot_token(get_robot_token_request)

    def revoke_auth_token(
        self, revoke_auth_token_request: "RevokeAuthTokenRequest"
    ) -> "RevokeAuthTokenResponse":
        return self.__rpc_revoke_auth_token(revoke_auth_token_request)

    def revoke_auth_tokens_for_user(
        self, revoke_auth_tokens_for_user_request: "RevokeAuthTokensForUserRequest"
    ) -> "RevokeAuthTokensForUserResponse":
        return self.__rpc_revoke_auth_tokens_for_user(
            revoke_auth_tokens_for_user_request
        )

    def set_groups_for_user(
        self, set_groups_for_user_request: "SetGroupsForUserRequest"
    ) -> "SetGroupsForUserResponse":
        return self.__rpc_set_groups_for_user(set_groups_for_user_request)

    def modify_members(
        self, modify_members_request: "ModifyMembersRequest"
    ) -> "ModifyMembersResponse":
        return self.__rpc_modify_members(modify_members_request)

    def get_groups(self, get_groups_request: "GetGroupsRequest") -> "GetGroupsResponse":
        return self.__rpc_get_groups(get_groups_request)

    def get_groups_for_principal(
        self, get_groups_for_principal_request: "GetGroupsForPrincipalRequest"
    ) -> "GetGroupsResponse":
        return self.__rpc_get_groups_for_principal(get_groups_for_principal_request)

    def get_users(self, get_users_request: "GetUsersRequest") -> "GetUsersResponse":
        return self.__rpc_get_users(get_users_request)

    def extract_auth_tokens(
        self, extract_auth_tokens_request: "ExtractAuthTokensRequest"
    ) -> "ExtractAuthTokensResponse":
        return self.__rpc_extract_auth_tokens(extract_auth_tokens_request)

    def restore_auth_token(
        self, restore_auth_token_request: "RestoreAuthTokenRequest"
    ) -> "RestoreAuthTokenResponse":
        return self.__rpc_restore_auth_token(restore_auth_token_request)

    def delete_expired_auth_tokens(
        self, delete_expired_auth_tokens_request: "DeleteExpiredAuthTokensRequest"
    ) -> "DeleteExpiredAuthTokensResponse":
        return self.__rpc_delete_expired_auth_tokens(delete_expired_auth_tokens_request)

    def rotate_root_token(
        self, rotate_root_token_request: "RotateRootTokenRequest"
    ) -> "RotateRootTokenResponse":
        return self.__rpc_rotate_root_token(rotate_root_token_request)
...
class ApiBase(ServicerBase):
    ...
    def get_configuration(
        self, request: "GetConfigurationRequest", context: "grpc.ServicerContext"
    ) -> "GetConfigurationResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def set_configuration(
        self, request: "SetConfigurationRequest", context: "grpc.ServicerContext"
    ) -> "SetConfigurationResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def authenticate(
        self, request: "AuthenticateRequest", context: "grpc.ServicerContext"
    ) -> "AuthenticateResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def authorize(
        self, request: "AuthorizeRequest", context: "grpc.ServicerContext"
    ) -> "AuthorizeResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_permissions(
        self, request: "GetPermissionsRequest", context: "grpc.ServicerContext"
    ) -> "GetPermissionsResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def who_am_i(
        self, request: "WhoAmIRequest", context: "grpc.ServicerContext"
    ) -> "WhoAmIResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_roles_for_permission(
        self, request: "GetRolesForPermissionRequest", context: "grpc.ServicerContext"
    ) -> "GetRolesForPermissionResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def modify_role_binding(
        self, request: "ModifyRoleBindingRequest", context: "grpc.ServicerContext"
    ) -> "ModifyRoleBindingResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_role_binding(
        self, request: "GetRoleBindingRequest", context: "grpc.ServicerContext"
    ) -> "GetRoleBindingResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_oidc_login(
        self, request: "GetOidcLoginRequest", context: "grpc.ServicerContext"
    ...
    def get_robot_token(
        self, request: "GetRobotTokenRequest", context: "grpc.ServicerContext"
    ) -> "GetRobotTokenResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def revoke_auth_token(
        self, request: "RevokeAuthTokenRequest", context: "grpc.ServicerContext"
    ) -> "RevokeAuthTokenResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def revoke_auth_tokens_for_user(
        self, request: "RevokeAuthTokensForUserRequest", context: "grpc.ServicerContext"
    ) -> "RevokeAuthTokensForUserResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def set_groups_for_user(
        self, request: "SetGroupsForUserRequest", context: "grpc.ServicerContext"
    ) -> "SetGroupsForUserResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def modify_members(
        self, request: "ModifyMembersRequest", context: "grpc.ServicerContext"
    ) -> "ModifyMembersResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_groups(
        self, request: "GetGroupsRequest", context: "grpc.ServicerContext"
    ) -> "GetGroupsResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_groups_for_principal(
        self, request: "GetGroupsForPrincipalRequest", context: "grpc.ServicerContext"
    ) -> "GetGroupsResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def get_users(
        self, request: "GetUsersRequest", context: "grpc.ServicerContext"
    ) -> "GetUsersResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def extract_auth_tokens(
        self, request: "ExtractAuthTokensRequest", context: "grpc.ServicerContext"
    ) -> "ExtractAuthTokensResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def restore_auth_token(
        self, request: "RestoreAuthTokenRequest", context: "grpc.ServicerContext"
    ) -> "RestoreAuthTokenResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def delete_expired_auth_tokens(
        self, request: "DeleteExpiredAuthTokensRequest", context: "grpc.ServicerContext"
    ) -> "DeleteExpiredAuthTokensResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def rotate_root_token(
        self, request: "RotateRootTokenRequest", context: "grpc.ServicerContext"
    ) -> "RotateRootTokenResponse":
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
