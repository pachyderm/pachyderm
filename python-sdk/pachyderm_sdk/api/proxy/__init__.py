...
class ApiStub:
    ...
    def listen(self, listen_request: "ListenRequest") -> Iterator["ListenResponse"]:
        for response in self.__rpc_listen(listen_request):
            yield response


class ApiBase(ServicerBase):
    def listen(
        self, request: "ListenRequest", context: "grpc.ServicerContext"
