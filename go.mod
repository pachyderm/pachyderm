...
replace github.com/dexidp/dex => github.com/pachyderm/dex v0.0.0-20220719152724-8eefbbcd5fcf
...
replace (
	...
	go.opentelemetry.io/otel/propagation => go.opentelemetry.io/otel/propagation v0.20.0
