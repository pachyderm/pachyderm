...
export const PROJECT_REPO_PATH =
  '/project/:projectId/repos/:repoId/branch/:branchId/:tabId?';
export const PROJECT_PIPELINE_PATH =
  '/project/:projectId/pipelines/:pipelineId/:tabId?';
...
export const PROJECT_PIPELINE_JOB_PATH =
  '/project/:projectId/jobs/:jobId/:pipelineId';
...
export const LINEAGE_REPO_PATH =
  '/lineage/:projectId/repos/:repoId/branch/:branchId/:tabId?';
...
export const LINEAGE_PIPELINE_JOB_PATH =
  '/lineage/:projectId/jobs/:jobId/:pipelineId';
