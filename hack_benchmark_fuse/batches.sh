...
# parallelism...
BENCH_NUMJOBS=10 BENCH_FILESIZE=10M BENCH_NRFILES=1000 ./run.sh
BENCH_NUMJOBS=10 BENCH_FILESIZE=10M BENCH_NRFILES=100 ./run.sh

# pump it...
BENCH_NUMJOBS=1 BENCH_FILESIZE=100K BENCH_NRFILES=10000 ./run.sh
